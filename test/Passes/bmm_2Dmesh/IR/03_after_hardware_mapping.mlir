              ...
              affine.for %arg7 = 0 to affine_map<()[s0, s1, s2] -> (4096 ceildiv (s1 * 8))>()[%20, %21, %22] {
                affine.for %arg8 = 0 to affine_map<()[s0, s1, s2] -> (4096 ceildiv (s2 * 2))>()[%20, %21, %22] {
                  ...
                  %35 = affine.for %arg9 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%23] iter_args(%arg10 = %34) -> (tensor<?x?x?xf16>) {
                    ...
                    %44 = loom.subview %arg0[%41, %42, %43] [%20, %21, %23] [1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<8x4096x512xf16> to memref<?x?x?xf16, strided<[2097152, 512, 1], offset: ?>>
                    ...
                    %47 = loom.subview %arg1[%41, %43, %46] [%20, %23, %22] [1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<8x512x4096xf16> to memref<?x?x?xf16, strided<[2097152, 4096, 1], offset: ?>>

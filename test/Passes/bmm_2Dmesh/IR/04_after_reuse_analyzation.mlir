              ...
              scf.for %arg7 = %c0 to %27 step %c1 {
                ...
                scf.for %arg8 = %c0 to %29 step %c1 {
                  ...
                  %41 = affine.for %arg9 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%23] iter_args(%arg10 = %36) -> (tensor<?x?x?xf16>) {
                    ...
                    %50 = loom.subview %arg0[%47, %48, %49] [%20, %21, %23] [1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<8x4096x512xf16> to memref<?x?x?xf16, strided<[2097152, 512, 1], offset: ?>>
                    ...
                    %53 = loom.subview %arg1[%47, %49, %52] [%20, %23, %22] [1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<8x512x4096xf16> to memref<?x?x?xf16, strided<[2097152, 4096, 1], offset: ?>>

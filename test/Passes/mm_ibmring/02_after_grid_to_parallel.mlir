module {
  func.func @matmul_kernel(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: memref<*xf32> {tt.divisibility = 16 : i32}, %arg2: memref<*xf32> {tt.divisibility = 16 : i32}, %arg3: index, %arg4: index, %arg5: index) {
    affine.parallel (%arg6, %arg7) = (0, 0) to (%arg3, %arg4) {
      ...
      %2 = scf.for %arg8 = %c0 to %c8 step %c1 iter_args(%arg9 = %1) -> (tensor<64x64xf32>) {
        %4 = affine.apply affine_map<(d0, d1) -> (d1 * 32768 + d0 * 64)>(%arg8, %arg6)
        ...
        %6 = affine.apply affine_map<(d0, d1) -> (d1 * 32768 + d0 * 64)>(%arg7, %arg8)
        ...
        %9 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg9, %8 : tensor<64x64xf32>, tensor<64x64xf32>) outs(%arg9 : tensor<64x64xf32>) {

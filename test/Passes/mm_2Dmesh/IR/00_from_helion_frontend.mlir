    ...
    func.func @matmul(%arg0: memref<512x512xf32>, %arg1: memref<512x512xf32>, %arg2: memref<512x512xf32>) {
      ...
      affine.parallel (%arg3, %arg4) = (0, 0) to (512 ceildiv symbol(%0), 512 ceildiv symbol(%1)) {
        ...
        %5 = affine.for %arg5 = 0 to #map()[%2] iter_args(%arg6 = %4) -> (tensor<?x?xf32>) {
          ...
          %subview_0 = memref.subview %arg0[%9, %10] [%0, %2] [1, 1] : memref<512x512xf32> to memref<?x?xf32, strided<[512, 1], offset: ?>>
          %11 = bufferization.to_tensor %subview_0 : memref<?x?xf32, strided<[512, 1], offset: ?>> to tensor<?x?xf32>
          %12 = arith.muli %arg4, %1 : index
          %subview_1 = memref.subview %arg1[%10, %12] [%2, %1] [1, 1] : memref<512x512xf32> to memref<?x?xf32, strided<[512, 1], offset: ?>>
          %13 = bufferization.to_tensor %subview_1 : memref<?x?xf32, strided<[512, 1], offset: ?>> to tensor<?x?xf32>
        ...
        %subview = memref.subview %arg2[%6, %7] [%0, %1] [1, 1] : memref<512x512xf32> to memref<?x?xf32, strided<[512, 1], offset: ?>>
        %8 = bufferization.to_buffer %5 : tensor<?x?xf32> to memref<?x?xf32, strided<[512, 1], offset: ?>>
        memref.copy %8, %subview : memref<?x?xf32, strided<[512, 1], offset: ?>> to memref<?x?xf32, strided<[512, 1], offset: ?>>
      }
      return
    }
  }

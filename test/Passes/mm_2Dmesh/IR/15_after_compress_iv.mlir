module {
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.linear_constraint(%15, %14, %12, %13) {map = affine_map<(d0, d1, d2, d3) -> (-d0 + d1 * 64 + (d2 + d3) * 32 - 2048)>}
      loom.linear_constraint(%15, %14, %12, %13) {map = affine_map<(d0, d1, d2, d3) -> (-d0 + d1 * 1024 + (d2 + d3) * 512 - 524288)>}
      loom.linear_constraint(%15, %14, %12, %13) {map = affine_map<(d0, d1, d2, d3) -> (d0 - d1 * 1024 - (d2 + d3) * 32 + 32768)>}
      loom.linear_constraint(%15, %14, %12, %13) {map = affine_map<(d0, d1, d2, d3) -> (d0 - d1 * 64 - (d2 + d3) * 512 + 32768)>}
      loom.linear_constraint(%12, %14, %13, %15) {map = affine_map<(d0, d1, d2, d3) -> (d3 - 374784)>}
    }
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.align %14 by 32
      %15 = loom.intermediate_var : index
      loom.linear_constraint(%15, %12, %13, %14) {map = affine_map<(d0, d1, d2, d3) -> (-d0 + (d1 + d2) * 32 + d3 * 64 - 2048)>}
      loom.linear_constraint(%15, %12, %13, %14) {map = affine_map<(d0, d1, d2, d3) -> (-d0 + (d1 + d2) * 512 + d3 * 1024 - 524288)>}
      loom.linear_constraint(%15, %12, %13, %14) {map = affine_map<(d0, d1, d2, d3) -> (d0 - (d1 + d2) * 512 - d3 * 64 + 32768)>}
      loom.linear_constraint(%15, %12, %13, %14) {map = affine_map<(d0, d1, d2, d3) -> (d0 - (d1 + d2) * 32 - d3 * 1024 + 32768)>}
      loom.linear_constraint(%12, %14, %13, %15) {map = affine_map<(d0, d1, d2, d3) -> (d3 - 374784)>}
    }
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.linear_constraint(%16, %14, %13) {map = affine_map<(d0, d1, d2) -> (-d0 + d1 * 32 + d2 * 32 - 1024)>}
      loom.linear_constraint(%16, %14, %13) {map = affine_map<(d0, d1, d2) -> (-d0 + d1 * 512 + d2 * 512 - 262144)>}
      loom.linear_constraint(%16, %14, %13) {map = affine_map<(d0, d1, d2) -> (d0 - d1 * 512 - d2 * 32 + 16384)>}
      loom.linear_constraint(%16, %14, %13) {map = affine_map<(d0, d1, d2) -> (d0 - d1 * 32 - d2 * 512 + 16384)>}
      loom.linear_constraint(%12, %14, %13, %16) {map = affine_map<(d0, d1, d2, d3) -> (d0 * 512 + d3 - 374784)>}
    }
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.linear_constraint(%12, %14, %13, %15) {map = affine_map<(d0, d1, d2, d3) -> (d3 - 374784)>}
      %16 = loom.intermediate_var : index
      loom.linear_constraint(%16, %13, %14) {map = affine_map<(d0, d1, d2) -> (-d0 + d1 * 32 + d2 * 32 - 1024)>}
      loom.linear_constraint(%16, %13, %14) {map = affine_map<(d0, d1, d2) -> (-d0 + d1 * 512 + d2 * 512 - 262144)>}
      loom.linear_constraint(%16, %13, %14) {map = affine_map<(d0, d1, d2) -> (d0 - d1 * 512 - d2 * 32 + 16384)>}
      loom.linear_constraint(%16, %13, %14) {map = affine_map<(d0, d1, d2) -> (d0 - d1 * 32 - d2 * 512 + 16384)>}
      loom.linear_constraint(%12, %14, %13, %16) {map = affine_map<(d0, d1, d2, d3) -> (d0 * 512 + d3 - 374784)>}
    }
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.linear_constraint(%12, %14, %13, %15) {map = affine_map<(d0, d1, d2, d3) -> (d3 - 374784)>}
      %16 = loom.intermediate_var : index
      loom.linear_constraint(%16, %14, %12) {map = affine_map<(d0, d1, d2) -> (-d0 + d1 * 32 + d2 * 32 - 1024)>}
      loom.linear_constraint(%16, %14, %12) {map = affine_map<(d0, d1, d2) -> (-d0 + d1 * 512 + d2 * 512 - 262144)>}
      loom.linear_constraint(%16, %14, %12) {map = affine_map<(d0, d1, d2) -> (d0 - d1 * 512 - d2 * 32 + 16384)>}
      loom.linear_constraint(%16, %14, %12) {map = affine_map<(d0, d1, d2) -> (d0 - d1 * 32 - d2 * 512 + 16384)>}
      loom.linear_constraint(%13, %12, %14, %16) {map = affine_map<(d0, d1, d2, d3) -> (d0 * 512 + d3 - 374784)>}
    }
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.linear_constraint(%12, %14, %13, %15) {map = affine_map<(d0, d1, d2, d3) -> (d3 - 374784)>}
      %16 = loom.intermediate_var : index
      loom.linear_constraint(%16, %12, %14) {map = affine_map<(d0, d1, d2) -> (-d0 + d1 * 32 + d2 * 32 - 1024)>}
      loom.linear_constraint(%16, %12, %14) {map = affine_map<(d0, d1, d2) -> (-d0 + d1 * 512 + d2 * 512 - 262144)>}
      loom.linear_constraint(%16, %12, %14) {map = affine_map<(d0, d1, d2) -> (d0 - d1 * 512 - d2 * 32 + 16384)>}
      loom.linear_constraint(%16, %12, %14) {map = affine_map<(d0, d1, d2) -> (d0 - d1 * 32 - d2 * 512 + 16384)>}
      loom.linear_constraint(%13, %12, %14, %16) {map = affine_map<(d0, d1, d2, d3) -> (d0 * 512 + d3 - 374784)>}
    }

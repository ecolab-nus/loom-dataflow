          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (((512 ceildiv s0) ceildiv 8) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (512 ceildiv s1)>()[%12, %13] {
              ...
              %19 = affine.for %arg7 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%14] iter_args(%arg8 = %18) -> (tensor<?x?xf32>) {
                ...
                %25 = loom.view %arg0[%23, %24] [%12, %14] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x512xf32> -> !loom.view
                ...
                %29 = loom.view %arg1[%24, %28] [%14, %13] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x512xf32> -> !loom.view
          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> ((512 ceildiv s0) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> ((512 ceildiv s1) ceildiv 8)>()[%12, %13] {
              ...
              %20 = affine.for %arg7 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%14] iter_args(%arg8 = %19) -> (tensor<?x?xf32>) {
                ...
                %26 = loom.view %arg0[%24, %25] [%12, %14] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x512xf32> -> !loom.view
                ...
                %30 = loom.view %arg1[%25, %29] [%14, %13] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x512xf32> -> !loom.view

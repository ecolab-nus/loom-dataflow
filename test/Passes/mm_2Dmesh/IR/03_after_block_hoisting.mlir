module {
          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (((128 ceildiv s0) ceildiv 8) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (256 ceildiv s1)>()[%12, %13] {
              ...
              %19 = affine.for %arg7 = 0 to affine_map<()[s0] -> (128 ceildiv s0)>()[%14] iter_args(%arg8 = %18) -> (tensor<?x?xf32>) {
                ...
                %25 = loom.view %arg0[%23, %24] [%12, %14] [1, 1] : memref<128x128xf32> -> !loom.view
                ...
                %29 = loom.view %arg1[%24, %28] [%14, %13] [1, 1] : memref<128x256xf32> -> !loom.view
              ...
              %22 = loom.view %arg2[%20, %21] [%12, %13] [1, 1] : memref<128x256xf32> -> !loom.view
  ...
  module attributes {loom.pass_name = "HoistBlockLoading"} {
    loom.constraint_space @constraints {
      ...
      loom.polynomial_constraint(%12, %13, %14) {monomials = [{coeff = 4 : i64, vars = [0, 1]}, {coeff = 4 : i64, vars = [0, 2]}, {coeff = 4 : i64, vars = [2, 1]}], upper_bound = 1499136 : i64}
      loom.polynomial_constraint(%12) {monomials = [{coeff = 64 : i64, vars = [0]}], upper_bound = 1024 : i64}
      loom.polynomial_constraint(%12, %13, %14) {monomials = [{coeff = 4 : i64, vars = [0, 1]}, {coeff = 512 : i64, vars = [0]}, {coeff = 4 : i64, vars = [2, 1]}], upper_bound = 1499136 : i64}
    }
        ...
        affine.parallel (%arg4) = (0) to (8) {
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (((128 ceildiv s0) ceildiv 8) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (256 ceildiv s1)>()[%12, %13] {
              ...
              %17 = loom.init_tensor %16(%12, %13) : !loom.buffer_token -> tensor<?x?xf32>
              %18 = linalg.fill ins(%cst : f32) outs(%17 : tensor<?x?xf32>) -> tensor<?x?xf32>
              %19 = affine.apply affine_map<()[s0] -> (128 ceildiv s0)>()[%14]
              %20 = arith.muli %15, %12 : index
              %c0 = arith.constant 0 : index
              %21 = arith.muli %c0, %14 : index
              %22 = loom.view %arg0[0, %20, %21] [%19, %12, %14] [1, 1, 1] : memref<128x128xf32> -> !loom.view
              %23 = loom.allocc(%19, %12, %14) on @L1 : !loom.buffer_token
              %24 = loom.copy_to_tensor %22, %23, interconnect : [], broadcast : [1, 1] : !loom.view, !loom.buffer_token -> tensor<?x?x?xf32>
              %25 = affine.for %arg7 = 0 to affine_map<()[s0] -> (128 ceildiv s0)>()[%14] iter_args(%arg8 = %18) -> (tensor<?x?xf32>) {
                %29 = arith.muli %15, %12 : index
                %30 = arith.muli %arg7, %14 : index
                %c1 = arith.constant 1 : index
                %dim = tensor.dim %24, %c1 : tensor<?x?x?xf32>
                %c2 = arith.constant 2 : index
                %dim_0 = tensor.dim %24, %c2 : tensor<?x?x?xf32>
                %extracted_slice = tensor.extract_slice %24[%arg7, 0, 0] [1, %dim, %dim_0] [1, 1, 1] : tensor<?x?x?xf32> to tensor<?x?xf32>
                %31 = arith.muli %arg6, %13 : index
                %32 = loom.view %arg1[%30, %31] [%14, %13] [1, 1] : memref<128x256xf32> -> !loom.view
                %33 = loom.allocc(%14, %13) on @L1 : !loom.buffer_token
                %34 = loom.copy_to_tensor %32, %33, interconnect : [], broadcast : [1, 1] : !loom.view, !loom.buffer_token -> tensor<?x?xf32>
                %35 = linalg.matmul ins(%extracted_slice, %34 : tensor<?x?xf32>, tensor<?x?xf32>) outs(%18 : tensor<?x?xf32>) -> tensor<?x?xf32>
                %36 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg8, %35 : tensor<?x?xf32>, tensor<?x?xf32>) outs(%17 : tensor<?x?xf32>) {
                ^bb0(%in: f32, %in_1: f32, %out: f32):
                  %37 = arith.addf %in, %in_1 : f32
                  linalg.yield %37 : f32
                } -> tensor<?x?xf32>
                affine.yield %36 : tensor<?x?xf32>
              }
              %26 = arith.muli %15, %12 : index
              %27 = arith.muli %arg6, %13 : index
              %28 = loom.view %arg2[%26, %27] [%12, %13] [1, 1] : memref<128x256xf32> -> !loom.view
              loom.copy_from_tensor %25, %28 : tensor<?x?xf32>, !loom.view
            }
          }
        } {loom.mapped_to = @y}
      } {loom.mapped_to = @x}
  ...
  module attributes {loom.pass_name = "HoistBlockLoading"} {
    loom.constraint_space @constraints {
      ...
      loom.polynomial_constraint(%12, %13, %14) {monomials = [{coeff = 4 : i64, vars = [0, 1]}, {coeff = 4 : i64, vars = [0, 2]}, {coeff = 4 : i64, vars = [2, 1]}], upper_bound = 1499136 : i64}
      loom.polynomial_constraint(%12) {monomials = [{coeff = 64 : i64, vars = [0]}], upper_bound = 1024 : i64}
      loom.polynomial_constraint(%12, %13, %14) {monomials = [{coeff = 4 : i64, vars = [0, 1]}, {coeff = 512 : i64, vars = [1]}, {coeff = 4 : i64, vars = [0, 2]}], upper_bound = 1499136 : i64}
    }
        ...
        affine.parallel (%arg4) = (0) to (8) {
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (((128 ceildiv s0) ceildiv 8) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (256 ceildiv s1)>()[%12, %13] {
              ...
              %19 = affine.apply affine_map<()[s0] -> (128 ceildiv s0)>()[%14]
              %c0 = arith.constant 0 : index
              %20 = arith.muli %c0, %14 : index
              %21 = arith.muli %arg6, %13 : index
              %22 = loom.view %arg1[0, %20, %21] [%19, %14, %13] [1, 1, 1] : memref<128x256xf32> -> !loom.view
              %23 = loom.allocc(%19, %14, %13) on @L1 : !loom.buffer_token
              %24 = loom.copy_to_tensor %22, %23, interconnect : [], broadcast : [1, 1] : !loom.view, !loom.buffer_token -> tensor<?x?x?xf32>
              %25 = affine.for %arg7 = 0 to affine_map<()[s0] -> (128 ceildiv s0)>()[%14] iter_args(%arg8 = %18) -> (tensor<?x?xf32>) {
                %29 = arith.muli %15, %12 : index
                %30 = arith.muli %arg7, %14 : index
                %31 = loom.view %arg0[%29, %30] [%12, %14] [1, 1] : memref<128x128xf32> -> !loom.view
                %32 = loom.allocc(%12, %14) on @L1 : !loom.buffer_token
                %33 = loom.copy_to_tensor %31, %32, interconnect : [], broadcast : [1, 1] : !loom.view, !loom.buffer_token -> tensor<?x?xf32>
                %34 = arith.muli %arg6, %13 : index
                %c1 = arith.constant 1 : index
                %dim = tensor.dim %24, %c1 : tensor<?x?x?xf32>
                %c2 = arith.constant 2 : index
                %dim_0 = tensor.dim %24, %c2 : tensor<?x?x?xf32>
                %extracted_slice = tensor.extract_slice %24[%arg7, 0, 0] [1, %dim, %dim_0] [1, 1, 1] : tensor<?x?x?xf32> to tensor<?x?xf32>
                %35 = linalg.matmul ins(%33, %extracted_slice : tensor<?x?xf32>, tensor<?x?xf32>) outs(%18 : tensor<?x?xf32>) -> tensor<?x?xf32>
                %36 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg8, %35 : tensor<?x?xf32>, tensor<?x?xf32>) outs(%17 : tensor<?x?xf32>) {
                ^bb0(%in: f32, %in_1: f32, %out: f32):
                  %37 = arith.addf %in, %in_1 : f32
                  linalg.yield %37 : f32
          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> ((128 ceildiv s0) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> ((256 ceildiv s1) ceildiv 8)>()[%12, %13] {
              ...
              %20 = affine.for %arg7 = 0 to affine_map<()[s0] -> (128 ceildiv s0)>()[%14] iter_args(%arg8 = %19) -> (tensor<?x?xf32>) {
                ...
                %26 = loom.view %arg0[%24, %25] [%12, %14] [1, 1] : memref<128x128xf32> -> !loom.view
                ...
                %30 = loom.view %arg1[%25, %29] [%14, %13] [1, 1] : memref<128x256xf32> -> !loom.view
              ...
              %23 = loom.view %arg2[%21, %22] [%12, %13] [1, 1] : memref<128x256xf32> -> !loom.view
        ...
        affine.parallel (%arg4) = (0) to (8) {
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> ((128 ceildiv s0) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> ((256 ceildiv s1) ceildiv 8)>()[%12, %13] {
              ...
              %18 = loom.init_tensor %17(%12, %13) : !loom.buffer_token -> tensor<?x?xf32>
              %19 = linalg.fill ins(%cst : f32) outs(%18 : tensor<?x?xf32>) -> tensor<?x?xf32>
              %20 = affine.apply affine_map<()[s0] -> (128 ceildiv s0)>()[%14]
              %21 = arith.muli %15, %12 : index
              %c0 = arith.constant 0 : index
              %22 = arith.muli %c0, %14 : index
              %23 = loom.view %arg0[0, %21, %22] [%20, %12, %14] [1, 1, 1] : memref<128x128xf32> -> !loom.view
              %24 = loom.allocc(%20, %12, %14) on @L1 : !loom.buffer_token
              %25 = loom.copy_to_tensor %23, %24, interconnect : [], broadcast : [1, 1] : !loom.view, !loom.buffer_token -> tensor<?x?x?xf32>
              %26 = affine.for %arg7 = 0 to affine_map<()[s0] -> (128 ceildiv s0)>()[%14] iter_args(%arg8 = %19) -> (tensor<?x?xf32>) {
                %30 = arith.muli %15, %12 : index
                %31 = arith.muli %arg7, %14 : index
                %c1 = arith.constant 1 : index
                %dim = tensor.dim %25, %c1 : tensor<?x?x?xf32>
                %c2 = arith.constant 2 : index
                %dim_0 = tensor.dim %25, %c2 : tensor<?x?x?xf32>
                %extracted_slice = tensor.extract_slice %25[%arg7, 0, 0] [1, %dim, %dim_0] [1, 1, 1] : tensor<?x?x?xf32> to tensor<?x?xf32>
                %32 = arith.muli %16, %13 : index
                %33 = loom.view %arg1[%31, %32] [%14, %13] [1, 1] : memref<128x256xf32> -> !loom.view
                %34 = loom.allocc(%14, %13) on @L1 : !loom.buffer_token
                %35 = loom.copy_to_tensor %33, %34, interconnect : [], broadcast : [1, 1] : !loom.view, !loom.buffer_token -> tensor<?x?xf32>
                %36 = linalg.matmul ins(%extracted_slice, %35 : tensor<?x?xf32>, tensor<?x?xf32>) outs(%19 : tensor<?x?xf32>) -> tensor<?x?xf32>
                %37 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg8, %36 : tensor<?x?xf32>, tensor<?x?xf32>) outs(%18 : tensor<?x?xf32>) {
                ^bb0(%in: f32, %in_1: f32, %out: f32):
                  %38 = arith.addf %in, %in_1 : f32
                  linalg.yield %38 : f32
                } -> tensor<?x?xf32>
                affine.yield %37 : tensor<?x?xf32>
              }
              %27 = arith.muli %15, %12 : index
              %28 = arith.muli %16, %13 : index
              %29 = loom.view %arg2[%27, %28] [%12, %13] [1, 1] : memref<128x256xf32> -> !loom.view
              loom.copy_from_tensor %26, %29 : tensor<?x?xf32>, !loom.view
            }
          }
        } {loom.mapped_to = @y}
      } {loom.mapped_to = @x}
        ...
        affine.parallel (%arg4) = (0) to (8) {
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> ((128 ceildiv s0) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> ((256 ceildiv s1) ceildiv 8)>()[%12, %13] {
              ...
              %21 = arith.muli %c0, %14 : index
              %22 = arith.muli %16, %13 : index
              %23 = loom.view %arg1[0, %21, %22] [%20, %14, %13] [1, 1, 1] : memref<128x256xf32> -> !loom.view
              %24 = loom.allocc(%20, %14, %13) on @L1 : !loom.buffer_token
              %25 = loom.copy_to_tensor %23, %24, interconnect : [], broadcast : [1, 1] : !loom.view, !loom.buffer_token -> tensor<?x?x?xf32>
              %26 = affine.for %arg7 = 0 to affine_map<()[s0] -> (128 ceildiv s0)>()[%14] iter_args(%arg8 = %19) -> (tensor<?x?xf32>) {
                %30 = arith.muli %15, %12 : index
                %31 = arith.muli %arg7, %14 : index
                %32 = loom.view %arg0[%30, %31] [%12, %14] [1, 1] : memref<128x128xf32> -> !loom.view
                %33 = loom.allocc(%12, %14) on @L1 : !loom.buffer_token
                %34 = loom.copy_to_tensor %32, %33, interconnect : [], broadcast : [1, 1] : !loom.view, !loom.buffer_token -> tensor<?x?xf32>
                %35 = arith.muli %16, %13 : index
                %c1 = arith.constant 1 : index
                %dim = tensor.dim %25, %c1 : tensor<?x?x?xf32>
                %c2 = arith.constant 2 : index
                %dim_0 = tensor.dim %25, %c2 : tensor<?x?x?xf32>
                %extracted_slice = tensor.extract_slice %25[%arg7, 0, 0] [1, %dim, %dim_0] [1, 1, 1] : tensor<?x?x?xf32> to tensor<?x?xf32>
                %36 = linalg.matmul ins(%34, %extracted_slice : tensor<?x?xf32>, tensor<?x?xf32>) outs(%19 : tensor<?x?xf32>) -> tensor<?x?xf32>
                %37 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg8, %36 : tensor<?x?xf32>, tensor<?x?xf32>) outs(%18 : tensor<?x?xf32>) {
                ^bb0(%in: f32, %in_1: f32, %out: f32):
                  %38 = arith.addf %in, %in_1 : f32
                  linalg.yield %38 : f32
        ...
        affine.parallel (%arg4) = (0) to (8) {
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (128 ceildiv s0)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (((256 ceildiv s1) ceildiv 8) ceildiv 8)>()[%12, %13] {
              ...
              %26 = arith.muli %arg5, %12 : index
              %27 = arith.muli %15, %13 : index
              %28 = loom.view %arg2[%26, %27] [%12, %13] [1, 1] : memref<128x256xf32> -> !loom.view
              loom.copy_from_tensor %25, %28 : tensor<?x?xf32>, !loom.view
            }
          }

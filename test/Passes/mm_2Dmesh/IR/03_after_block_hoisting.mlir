          ...
          affine.for %arg11 = 0 to affine_map<()[s0, s1] -> ((s0 ceildiv 8) ceildiv 8)>()[%arg3, %arg4] {
            affine.for %arg12 = 0 to affine_map<()[s0, s1] -> (s1)>()[%arg3, %arg4] {
              ...
              %21 = scf.for %arg13 = %c0 to %16 step %c1 iter_args(%arg14 = %18) -> (tensor<?x?xf32>) {
                ...
                %28 = loom.reinterpret_cast %arg0 to offset : [%27], sizes : [%13, %15], strides : [%c1024_0, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
                ...
                %33 = loom.reinterpret_cast %arg1 to offset : [%32], sizes : [%15, %14], strides : [%c1024, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
        ...
        affine.parallel (%arg10) = (0) to (8) {
          affine.for %arg11 = 0 to affine_map<()[s0, s1] -> ((s0 ceildiv 8) ceildiv 8)>()[%arg3, %arg4] {
            affine.for %arg12 = 0 to affine_map<()[s0, s1] -> (s1)>()[%arg3, %arg4] {
              ...
              %25 = loom.reinterpret_cast %arg0 to offset : [%24], sizes : [%16, %13, %15], strides : [%21, %c1024_0, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?x?xf32, strided<[?, ?, ?], offset: ?>>
              ...
              %27 = scf.for %arg13 = %c0 to %16 step %c1 iter_args(%arg14 = %18) -> (tensor<?x?xf32>) {
                ...
                %36 = loom.reinterpret_cast %arg1 to offset : [%35], sizes : [%15, %14], strides : [%c1024, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
        ...
        affine.parallel (%arg10) = (0) to (8) {
          affine.for %arg11 = 0 to affine_map<()[s0, s1] -> ((s0 ceildiv 8) ceildiv 8)>()[%arg3, %arg4] {
            affine.for %arg12 = 0 to affine_map<()[s0, s1] -> (s1)>()[%arg3, %arg4] {
              ...
              %25 = loom.reinterpret_cast %arg1 to offset : [%24], sizes : [%16, %15, %14], strides : [%21, %c1024, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?x?xf32, strided<[?, ?, ?], offset: ?>>
              ...
              %27 = scf.for %arg13 = %c0 to %16 step %c1 iter_args(%arg14 = %18) -> (tensor<?x?xf32>) {
                ...
                %34 = loom.reinterpret_cast %arg0 to offset : [%33], sizes : [%13, %15], strides : [%c1024_0, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
          ...
          affine.for %arg11 = 0 to affine_map<()[s0, s1] -> (s0 ceildiv 8)>()[%arg3, %arg4] {
            affine.for %arg12 = 0 to affine_map<()[s0, s1] -> (s1 ceildiv 8)>()[%arg3, %arg4] {
              ...
              %22 = scf.for %arg13 = %c0 to %17 step %c1 iter_args(%arg14 = %19) -> (tensor<?x?xf32>) {
                ...
                %29 = loom.reinterpret_cast %arg0 to offset : [%28], sizes : [%14, %16], strides : [%c1024_0, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
                ...
                %34 = loom.reinterpret_cast %arg1 to offset : [%33], sizes : [%16, %15], strides : [%c1024, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
        ...
        affine.parallel (%arg10) = (0) to (8) {
          affine.for %arg11 = 0 to affine_map<()[s0, s1] -> (s0 ceildiv 8)>()[%arg3, %arg4] {
            affine.for %arg12 = 0 to affine_map<()[s0, s1] -> (s1 ceildiv 8)>()[%arg3, %arg4] {
              ...
              %26 = loom.reinterpret_cast %arg0 to offset : [%25], sizes : [%17, %14, %16], strides : [%22, %c1024_0, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?x?xf32, strided<[?, ?, ?], offset: ?>>
              ...
              %28 = scf.for %arg13 = %c0 to %17 step %c1 iter_args(%arg14 = %19) -> (tensor<?x?xf32>) {
                ...
                %37 = loom.reinterpret_cast %arg1 to offset : [%36], sizes : [%16, %15], strides : [%c1024, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
        ...
        affine.parallel (%arg10) = (0) to (8) {
          affine.for %arg11 = 0 to affine_map<()[s0, s1] -> (s0 ceildiv 8)>()[%arg3, %arg4] {
            affine.for %arg12 = 0 to affine_map<()[s0, s1] -> (s1 ceildiv 8)>()[%arg3, %arg4] {
              ...
              %26 = loom.reinterpret_cast %arg1 to offset : [%25], sizes : [%17, %16, %15], strides : [%22, %c1024, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?x?xf32, strided<[?, ?, ?], offset: ?>>
              ...
              %28 = scf.for %arg13 = %c0 to %17 step %c1 iter_args(%arg14 = %19) -> (tensor<?x?xf32>) {
                ...
                %35 = loom.reinterpret_cast %arg0 to offset : [%34], sizes : [%14, %16], strides : [%c1024_0, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>

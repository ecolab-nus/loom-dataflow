          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (((4096 ceildiv s0) ceildiv 8) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv s1)>()[%12, %13] {
              ...
              %24 = affine.for %arg7 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%14] iter_args(%arg8 = %23) -> (tensor<?x?xf16>) {
                ...
                %30 = loom.subview %arg0[%28, %29] [%12, %14] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                ...
                %33 = loom.subview %arg1[%29, %32] [%14, %13] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> ((4096 ceildiv s0) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> ((4096 ceildiv s1) ceildiv 8)>()[%12, %13] {
              ...
              %25 = affine.for %arg7 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%14] iter_args(%arg8 = %24) -> (tensor<?x?xf16>) {
                ...
                %31 = loom.subview %arg0[%29, %30] [%12, %14] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                ...
                %34 = loom.subview %arg1[%30, %33] [%14, %13] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>

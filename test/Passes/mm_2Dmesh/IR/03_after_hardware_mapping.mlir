          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv (s0 * 64))>()[%18, %19] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv s1)>()[%18, %19] {
              ...
              %30 = affine.for %arg7 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%20] iter_args(%arg8 = %29) -> (tensor<?x?xf16>) {
                ...
                %37 = loom.subview %arg0[%35, %36] [%18, %20] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                ...
                %40 = loom.subview %arg1[%36, %39] [%20, %19] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv (s0 * 8))>()[%18, %19] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv (s1 * 8))>()[%18, %19] {
              ...
              %31 = affine.for %arg7 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%20] iter_args(%arg8 = %30) -> (tensor<?x?xf16>) {
                ...
                %38 = loom.subview %arg0[%36, %37] [%18, %20] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                ...
                %41 = loom.subview %arg1[%37, %40] [%20, %19] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>

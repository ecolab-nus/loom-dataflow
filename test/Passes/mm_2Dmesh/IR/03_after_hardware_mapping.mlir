          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv (s0 * 64))>()[%14, %15] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv s1)>()[%14, %15] {
              ...
              %26 = affine.for %arg7 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%16] iter_args(%arg8 = %25) -> (tensor<?x?xf16>) {
                ...
                %33 = loom.subview %arg0[%31, %32] [%14, %16] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                ...
                %36 = loom.subview %arg1[%32, %35] [%16, %15] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv (s0 * 8))>()[%14, %15] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv (s1 * 8))>()[%14, %15] {
              ...
              %27 = affine.for %arg7 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%16] iter_args(%arg8 = %26) -> (tensor<?x?xf16>) {
                ...
                %34 = loom.subview %arg0[%32, %33] [%14, %16] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                ...
                %37 = loom.subview %arg1[%33, %36] [%16, %15] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>

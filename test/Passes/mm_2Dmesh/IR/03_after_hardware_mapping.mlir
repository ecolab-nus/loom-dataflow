          ...
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv (s0 * 64))>()[%20, %21] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (4096 ceildiv s1)>()[%20, %21] {
              ...
              %32 = affine.for %arg7 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%22] iter_args(%arg8 = %31) -> (tensor<?x?xf16>) {
                ...
                %39 = loom.subview %arg0[%37, %38] [%20, %22] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                ...
                %42 = loom.subview %arg1[%38, %41] [%22, %21] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>

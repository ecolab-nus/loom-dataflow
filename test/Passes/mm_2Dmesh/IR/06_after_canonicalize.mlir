        ...
        affine.parallel (%arg4) = (0) to (8) {
          scf.for %arg5 = %c0 to %c16 step %c1 {
            scf.for %arg6 = %c0 to %c16 step %c1 {
              ...
              %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%31], sizes: [32, 512], strides: [256, 1] : memref<4096x256xf16> to memref<32x512xf16, strided<[256, 1], offset: ?>>
              ...
              %32 = loom.bufferize_to_tensor %27[32, 512] : memref<32x512xf16> -> tensor<32x512xf16>
              %33 = arith.muli %21, %c32 : index
              %c0_1 = arith.constant 0 : index
              %34 = affine.apply affine_map<(d0, d1) -> (d0 * 4096 + d1)>(%c0_1, %33)
              %reinterpret_cast_2 = memref.reinterpret_cast %arg1 to offset: [%34], sizes: [512, 32], strides: [4096, 1] : memref<256x4096xf16> to memref<512x32xf16, strided<[4096, 1], offset: ?>>
              loom.copy %reinterpret_cast_2, %29 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<512x32xf16, strided<[4096, 1], offset: ?>> to memref<512x32xf16>
              %35 = loom.bufferize_to_tensor %29[512, 32] : memref<512x32xf16> -> tensor<512x32xf16>
              %36 = linalg.matmul ins(%32, %35 : tensor<32x512xf16>, tensor<512x32xf16>) outs(%25 : tensor<32x32xf16>) -> tensor<32x32xf16>
        ...
        affine.parallel (%arg4) = (0) to (8) {
          scf.for %arg5 = %c0 to %c16 step %c1 {
            scf.for %arg6 = %c0 to %c16 step %c1 {
              ...
              %34 = affine.apply affine_map<(d0, d1) -> (d0 * 4096 + d1)>(%c0_1, %33)
              %reinterpret_cast_2 = memref.reinterpret_cast %arg1 to offset: [%34], sizes: [512, 32], strides: [4096, 1] : memref<256x4096xf16> to memref<512x32xf16, strided<[4096, 1], offset: ?>>
              loom.copy %reinterpret_cast_2, %29 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [8, 1] : memref<512x32xf16, strided<[4096, 1], offset: ?>> to memref<512x32xf16>
              %35 = loom.bufferize_to_tensor %29[512, 32] : memref<512x32xf16> -> tensor<512x32xf16>
              %36 = linalg.matmul ins(%32, %35 : tensor<32x512xf16>, tensor<512x32xf16>) outs(%25 : tensor<32x32xf16>) -> tensor<32x32xf16>
              loom.semaphore_give %29 : memref<512x32xf16>
              loom.semaphore_give %27 : memref<32x512xf16>
        ...
        affine.parallel (%arg4) = (0) to (8) {
          scf.for %arg5 = %c0 to %c16 step %c1 {
            scf.for %arg6 = %c0 to %c16 step %c1 {
              ...
              %34 = affine.apply affine_map<(d0, d1) -> (d0 * 4096 + d1)>(%c0_1, %33)
              %reinterpret_cast_2 = memref.reinterpret_cast %arg1 to offset: [%34], sizes: [512, 32], strides: [4096, 1] : memref<256x4096xf16> to memref<512x32xf16, strided<[4096, 1], offset: ?>>
              loom.copy %reinterpret_cast_2, %29 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 8] : memref<512x32xf16, strided<[4096, 1], offset: ?>> to memref<512x32xf16>
              %35 = loom.bufferize_to_tensor %29[512, 32] : memref<512x32xf16> -> tensor<512x32xf16>
              %36 = linalg.matmul ins(%32, %35 : tensor<32x512xf16>, tensor<512x32xf16>) outs(%25 : tensor<32x32xf16>) -> tensor<32x32xf16>
              loom.semaphore_give %29 : memref<512x32xf16>
              loom.semaphore_give %27 : memref<32x512xf16>

        ...
        affine.parallel (%arg4) = (0) to (8) {
          affine.for %arg5 = 0 to 512 {
            affine.for %arg6 = 0 to 8 {
              ...
              %24 = loom.init_tensor %23[1, 64] : memref<1x64xf16> -> tensor<1x64xf16>
              %25 = linalg.fill ins(%cst : f16) outs(%24 : tensor<1x64xf16>) -> tensor<1x64xf16>
              ...
              %30 = affine.for %arg7 = 0 to 4 iter_args(%arg8 = %25) -> (tensor<1x64xf16>) {
                ...
                %36 = loom.bufferize_to_tensor %27[1, 128] : memref<1x128xf16> -> tensor<1x128xf16>
                ...
                %39 = loom.bufferize_to_tensor %29[128, 64] : memref<128x64xf16> -> tensor<128x64xf16>

  ...
  module {
    ...
    func.func @matmul_kernel(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: memref<*xf32> {tt.divisibility = 16 : i32}, %arg2: memref<*xf32> {tt.divisibility = 16 : i32}, %arg3: index, %arg4: index, %arg5: index, %arg6: index, %arg7: index, %arg8: index) {
      affine.parallel (%arg9, %arg10) = (0, 0) to (%arg3, %arg4) {
        ...
        %3 = arith.ceildivsi %c1024_1, %2 : index
        ...
        %8 = scf.for %arg11 = %c0 to %3 step %c1 iter_args(%arg12 = %5) -> (tensor<?x?xf32>) {
          ...
          %13 = arith.muli %6, %c1024_2 : index
          %14 = arith.addi %13, %12 : index
          %15 = loom.reinterpret_cast %arg0 to offset : [%14], sizes : [%0, %2], strides : [%c1024_1, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
          ...
          %18 = arith.muli %12, %c1024_2 : index
          %19 = arith.addi %18, %7 : index
          %20 = loom.reinterpret_cast %arg1 to offset : [%19], sizes : [%2, %1], strides : [%c1024_0, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>
        ...
        %9 = arith.muli %6, %c1024_2 : index
        %10 = arith.addi %9, %7 : index
        %11 = loom.reinterpret_cast %arg2 to offset : [%10], sizes : [%0, %1], strides : [%c1024_0, %c1], reuse : [seq = false, spat = false, temp = false] : memref<*xf32> to memref<?x?xf32, strided<[?, ?], offset: ?>>

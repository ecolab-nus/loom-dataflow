module {
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.polynomial_constraint(%12, %14, %13) {monomials = [{coeff = 1 : i64, vars = [0, 1]}, {coeff = 1 : i64, vars = [1, 2]}], upper_bound = 374784 : i64}
      loom.polynomial_constraint(%12) {monomials = [{coeff = 1 : i64, vars = [0]}], upper_bound = 16 : i64}
      loom.polynomial_constraint(%12, %13, %14) {monomials = [{coeff = 64 : i64, vars = [0, 2]}, {coeff = 64 : i64, vars = [1, 2]}, {coeff = -1 : i64, vars = [0, 1, 2]}], upper_bound = 0 : i64}
    }
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.polynomial_constraint(%12, %14, %13) {monomials = [{coeff = 1 : i64, vars = [0, 1]}, {coeff = 1 : i64, vars = [1, 2]}], upper_bound = 374784 : i64}
      loom.polynomial_constraint(%12) {monomials = [{coeff = 1 : i64, vars = [0]}], upper_bound = 16 : i64}
      loom.polynomial_constraint(%12, %13, %14) {monomials = [{coeff = 960 : i64, vars = [0, 2]}, {coeff = 256 : i64, vars = [1, 2]}, {coeff = -15 : i64, vars = [0, 1, 2]}], upper_bound = 0 : i64}
    }
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.polynomial_constraint(%12, %14, %13) {monomials = [{coeff = 1 : i64, vars = [0, 1]}, {coeff = 1 : i64, vars = [1, 2]}], upper_bound = 374784 : i64}
      loom.polynomial_constraint(%12) {monomials = [{coeff = 1 : i64, vars = [0]}], upper_bound = 16 : i64}
      loom.polynomial_constraint(%12, %14, %13) {monomials = [{coeff = 1024 : i64, vars = [0]}, {coeff = 1 : i64, vars = [1, 2]}], upper_bound = 374784 : i64}
      loom.polynomial_constraint(%12, %13, %14) {monomials = [{coeff = 64 : i64, vars = [0, 2]}, {coeff = 64 : i64, vars = [1, 2]}, {coeff = -1 : i64, vars = [0, 1, 2]}], upper_bound = 0 : i64}
    }
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.polynomial_constraint(%12, %14, %13) {monomials = [{coeff = 1 : i64, vars = [0, 1]}, {coeff = 1 : i64, vars = [1, 2]}], upper_bound = 374784 : i64}
      loom.polynomial_constraint(%12) {monomials = [{coeff = 1 : i64, vars = [0]}], upper_bound = 16 : i64}
      loom.polynomial_constraint(%13, %12, %14) {monomials = [{coeff = 1024 : i64, vars = [0]}, {coeff = 1 : i64, vars = [1, 2]}], upper_bound = 374784 : i64}
      loom.polynomial_constraint(%12, %13, %14) {monomials = [{coeff = 64 : i64, vars = [0, 2]}, {coeff = 64 : i64, vars = [1, 2]}, {coeff = -1 : i64, vars = [0, 1, 2]}], upper_bound = 0 : i64}
    }
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.polynomial_constraint(%12) {monomials = [{coeff = 1 : i64, vars = [0]}], upper_bound = 16 : i64}
      loom.polynomial_constraint(%13, %12, %14) {monomials = [{coeff = 1024 : i64, vars = [0]}, {coeff = 1 : i64, vars = [1, 2]}], upper_bound = 374784 : i64}
      loom.polynomial_constraint(%12, %13, %14) {monomials = [{coeff = 256 : i64, vars = [0, 2]}, {coeff = 960 : i64, vars = [1, 2]}, {coeff = -15 : i64, vars = [0, 1, 2]}], upper_bound = 0 : i64}
    }
  ...
  module attributes {loom.pass_name = "EnumerateCopyBroadcast"} {
    loom.constraint_space @constraints {
      ...
      loom.polynomial_constraint(%12) {monomials = [{coeff = 1 : i64, vars = [0]}], upper_bound = 128 : i64}
      loom.polynomial_constraint(%13) {monomials = [{coeff = 1 : i64, vars = [0]}], upper_bound = 128 : i64}
      loom.polynomial_constraint(%12, %13, %14) {monomials = [{coeff = 256 : i64, vars = [0, 2]}, {coeff = 256 : i64, vars = [1, 2]}, {coeff = -15 : i64, vars = [0, 1, 2]}], upper_bound = 0 : i64}
    }

module attributes {loom.block_size_0 = -1 : index, loom.block_size_1 = -1 : index, loom.block_size_2 = -1 : index} {
  func.func @_matmul(%arg0: memref<4096x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x4096xf16>) {
    ...
    affine.parallel (%arg3, %arg4) = (0, 0) to (4096 ceildiv symbol(%0), 4096 ceildiv symbol(%1)) {
      ...
      %5 = loom.init_tensor %4[%0, %1] : memref<?x?xf16> -> tensor<?x?xf16>
      %6 = linalg.fill ins(%cst : f16) outs(%5 : tensor<?x?xf16>) -> tensor<?x?xf16>
      %7 = loom.alloc [%0, %2] on @L1 : memref<?x?xf16>
      %8 = loom.semaphore_take %7 : memref<?x?xf16> -> memref<?x?xf16>
      %9 = loom.alloc [%2, %1] on @L1 : memref<?x?xf16>
      %10 = loom.semaphore_take %9 : memref<?x?xf16> -> memref<?x?xf16>
      %11 = affine.for %arg5 = 0 to affine_map<()[s0] -> (512 ceildiv s0)>()[%2] iter_args(%arg6 = %6) -> (tensor<?x?xf16>) {
        ...
        loom.copy %18, %8 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x?xf16, strided<[512, 1], offset: ?>> to memref<?x?xf16>
        %19 = loom.bufferize_to_tensor %8[%0, %2] : memref<?x?xf16> -> tensor<?x?xf16>
        ...
        loom.copy %21, %10 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x?xf16, strided<[4096, 1], offset: ?>> to memref<?x?xf16>
        %22 = loom.bufferize_to_tensor %10[%2, %1] : memref<?x?xf16> -> tensor<?x?xf16>
        %23 = linalg.matmul ins(%19, %22 : tensor<?x?xf16>, tensor<?x?xf16>) outs(%arg6 : tensor<?x?xf16>) -> tensor<?x?xf16>
        loom.semaphore_give %10 : memref<?x?xf16>

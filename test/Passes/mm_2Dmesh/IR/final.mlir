module {
  ...
  module attributes {loom.pass_name = "Materialize"} {
    func.func @matmul__d1i0_d0i1__f01__h_v__BK128__BM256__BN64(%arg0: memref<4096x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x4096xf16>) {
      %c1048576 = arith.constant 1048576 : index
      %c524288 = arith.constant 524288 : index
      %c131072 = arith.constant 131072 : index
      %c4 = arith.constant 4 : index
      ...
      scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg5 = %c0 to %c2 step %c1 {
          scf.for %arg6 = %c0 to %c8 step %c1 {
            ...
            %18 = loom.alloc [256, 128] on @L1 : memref<256x128xf16>
            %19 = loom.semaphore_take %18 : memref<256x128xf16> -> memref<256x128xf16>
            %20 = loom.alloc [256, 64] on @L1 : memref<256x64xf16>
            %21 = loom.semaphore_take %20 : memref<256x64xf16> -> memref<256x64xf16>
            linalg.fill ins(%cst : f16) outs(%21 : memref<256x64xf16>)
            scf.for %arg7 = %c0 to %c4 step %c1 {
              %25 = arith.muli %arg7, %c128 : index
              %26 = arith.muli %13, %c131072 : index
              %27 = arith.addi %26, %25 : index
              %reinterpret_cast_0 = memref.reinterpret_cast %arg0 to offset: [%27], sizes: [256, 128], strides: [512, 1] : memref<4096x512xf16> to memref<256x128xf16, strided<[512, 1], offset: ?>>
              loom.copy %reinterpret_cast_0, %19 src_mem_space @DRAM dst_mem_space @L1, interconnect : [@horizontal_links], broadcast : [1, 8] : memref<256x128xf16, strided<[512, 1], offset: ?>>, memref<256x128xf16>
              %28 = arith.muli %15, %c64 : index
              ...
              loom.copy %reinterpret_cast_1, %17 src_mem_space @DRAM dst_mem_space @L1, interconnect : [@vertical_links], broadcast : [8, 1] : memref<128x64xf16, strided<[4096, 1], offset: ?>>, memref<128x64xf16>
              linalg.matmul ins(%19, %17 : memref<256x128xf16>, memref<128x64xf16>) outs(%21 : memref<256x64xf16>)
              loom.semaphore_give %17 : memref<128x64xf16>
              loom.semaphore_give %19 : memref<256x128xf16>
            }
            %22 = arith.muli %15, %c64 : index
            %23 = arith.muli %13, %c1048576 : index
            %24 = arith.addi %23, %22 : index
            %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [%24], sizes: [256, 64], strides: [4096, 1] : memref<4096x4096xf16> to memref<256x64xf16, strided<[4096, 1], offset: ?>>
            loom.copy %21, %reinterpret_cast src_mem_space @L1 dst_mem_space @DRAM, interconnect : [], broadcast : [1, 1] : memref<256x64xf16>, memref<256x64xf16, strided<[4096, 1], offset: ?>>
            loom.semaphore_give %21 : memref<256x64xf16>
          }
        }
        scf.reduce 
      } {loom.iter_types = [#loom.iter_type<spatial>, #loom.iter_type<spatial>], loom.mapped_to_dims = [@y, @x]}
  ...
  module attributes {loom.pass_name = "Materialize"} {
    func.func @matmul__d1i0_d0i1__f10__d_d__BK256__BM128__BN512(%arg0: memref<4096x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x4096xf16>) {
      %c524288 = arith.constant 524288 : index
      %c1048576 = arith.constant 1048576 : index
      %c65536 = arith.constant 65536 : index
      %c2 = arith.constant 2 : index
  ...
  module attributes {loom.pass_name = "Materialize"} {
    func.func @matmul__d0i1_d1i1__f01__a_d__BK512__BM32__BN32(%arg0: memref<4096x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x4096xf16>) {
      %c131072 = arith.constant 131072 : index
      ...
      scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg5 = %c0 to %c128 step %c1 {
          scf.for %arg6 = %c0 to %c2 step %c1 {
            ...
            %22 = arith.muli %arg5, %c16384 : index
            ...
            loom.copy %reinterpret_cast, %19 src_mem_space @DRAM dst_mem_space @L1, interconnect : [@horizontal_links, @vertical_links], broadcast : [8, 8] : memref<32x512xf16, strided<[512, 1], offset: ?>>, memref<32x512xf16>
            ...
            linalg.matmul ins(%19, %17 : memref<32x512xf16>, memref<512x32xf16>) outs(%21 : memref<32x32xf16>)
            loom.semaphore_give %17 : memref<512x32xf16>
            loom.semaphore_give %19 : memref<32x512xf16>
            %24 = arith.muli %arg5, %c131072 : index
            %25 = arith.addi %24, %23 : index
            %reinterpret_cast_1 = memref.reinterpret_cast %arg2 to offset: [%25], sizes: [32, 32], strides: [4096, 1] : memref<4096x4096xf16> to memref<32x32xf16, strided<[4096, 1], offset: ?>>
            loom.copy %21, %reinterpret_cast_1 src_mem_space @L1 dst_mem_space @DRAM, interconnect : [], broadcast : [1, 1] : memref<32x32xf16>, memref<32x32xf16, strided<[4096, 1], offset: ?>>
  ...
  module attributes {loom.pass_name = "Materialize"} {
    func.func @matmul__d0i1_d1i1__f01__h_d__BK64__BM2048__BN64(%arg0: memref<4096x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x4096xf16>) {
      ...
      scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg5 = %c0 to %c2 step %c1 {
          ...
          scf.for %arg6 = %c0 to %c8 step %c1 {
            ...
            loom.copy %reinterpret_cast_0, %17 src_mem_space @DRAM dst_mem_space @L1, interconnect : [@horizontal_links], broadcast : [1, 8] : memref<2048x64xf16, strided<[512, 1], offset: ?>>, memref<2048x64xf16>
  ...
  module attributes {loom.pass_name = "Materialize"} {
    func.func @matmul__d0i1_d1i1__f10__v_d__BK32__BM2048__BN64(%arg0: memref<4096x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x4096xf16>) {
      %c8388608 = arith.constant 8388608 : index
      %c131072 = arith.constant 131072 : index
      %c1048576 = arith.constant 1048576 : index
      %c16 = arith.constant 16 : index
  ...
  module attributes {loom.pass_name = "Materialize"} {
    func.func @matmul__d1i1_d0i1__f01__h_d__BK512__BM4096__BN64(%arg0: memref<4096x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x4096xf16>) {
      %cst = arith.constant 0.000000e+00 : f16
      %c64 = arith.constant 64 : index
      %c0 = arith.constant 0 : index
      %c8 = arith.constant 8 : index
  ...
  module attributes {loom.pass_name = "Materialize"} {
    func.func @matmul__d1i1_d0i1__f01__v_d__BK128__BM2048__BN64(%arg0: memref<4096x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x4096xf16>) {
      %c8388608 = arith.constant 8388608 : index
      %c524288 = arith.constant 524288 : index
      %c1048576 = arith.constant 1048576 : index
      %c4 = arith.constant 4 : index
      ...
      scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg5 = %c0 to %c2 step %c1 {
          ...
          scf.for %arg6 = %c0 to %c4 step %c1 {
            ...
            %25 = arith.addi %24, %23 : index
            %reinterpret_cast_0 = memref.reinterpret_cast %arg0 to offset: [%25], sizes: [2048, 128], strides: [512, 1] : memref<4096x512xf16> to memref<2048x128xf16, strided<[512, 1], offset: ?>>
            loom.copy %reinterpret_cast_0, %17 src_mem_space @DRAM dst_mem_space @L1, interconnect : [@vertical_links], broadcast : [8, 1] : memref<2048x128xf16, strided<[512, 1], offset: ?>>, memref<2048x128xf16>
            %26 = arith.muli %13, %c64 : index
            %27 = arith.muli %arg6, %c524288 : index
            %28 = arith.addi %27, %26 : index
            %reinterpret_cast_1 = memref.reinterpret_cast %arg1 to offset: [%28], sizes: [128, 64], strides: [4096, 1] : memref<512x4096xf16> to memref<128x64xf16, strided<[4096, 1], offset: ?>>
  ...
  module attributes {loom.pass_name = "Materialize"} {
    func.func @matmul__d1i1_d0i1__f10__h_d__BK64__BM2048__BN64(%arg0: memref<4096x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x4096xf16>) {
      %c8388608 = arith.constant 8388608 : index
      %c262144 = arith.constant 262144 : index
      %c1048576 = arith.constant 1048576 : index
      %c2 = arith.constant 2 : index
  ...
  module attributes {loom.pass_name = "Materialize"} {
    func.func @matmul__d1i1_d0i1__f10__v_d__BK32__BM2048__BN64(%arg0: memref<4096x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x4096xf16>) {
      %c8388608 = arith.constant 8388608 : index
      %c131072 = arith.constant 131072 : index
      %c1048576 = arith.constant 1048576 : index
      %c16 = arith.constant 16 : index

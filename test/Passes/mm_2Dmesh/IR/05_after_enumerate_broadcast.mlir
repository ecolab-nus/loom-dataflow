        ...
        affine.parallel (%arg4) = (0) to (8) {
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (((128 ceildiv s0) ceildiv 8) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (256 ceildiv s1)>()[%12, %13] {
              ...
              %20 = loom.view %arg0[%19, %c0] [%12, %c128] [1, 1] : memref<128x128xf32> -> !loom.view
              ...
              %23 = affine.for %arg7 = 0 to affine_map<()[s0] -> (128 ceildiv s0)>()[%14] iter_args(%arg8 = %18) -> (tensor<?x?xf32>) {
                ...
                %30 = loom.view %arg1[%28, %29] [%14, %13] [1, 1] : memref<128x256xf32> -> !loom.view
              ...
              %26 = loom.view %arg2[%24, %25] [%12, %13] [1, 1] : memref<128x256xf32> -> !loom.view
        ...
        affine.parallel (%arg4) = (0) to (8) {
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> (((128 ceildiv s0) ceildiv 8) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> (256 ceildiv s1)>()[%12, %13] {
              ...
              %c128 = arith.constant 128 : index
              %20 = loom.view %arg1[%c0, %19] [%c128, %13] [1, 1] : memref<128x256xf32> -> !loom.view
              ...
              %23 = affine.for %arg7 = 0 to affine_map<()[s0] -> (128 ceildiv s0)>()[%14] iter_args(%arg8 = %18) -> (tensor<?x?xf32>) {
                %27 = arith.muli %15, %12 : index
                %28 = arith.muli %arg7, %14 : index
                %29 = loom.view %arg0[%27, %28] [%12, %14] [1, 1] : memref<128x128xf32> -> !loom.view
        ...
        affine.parallel (%arg4) = (0) to (8) {
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> ((128 ceildiv s0) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> ((256 ceildiv s1) ceildiv 8)>()[%12, %13] {
              ...
              %c0 = arith.constant 0 : index
              %c128 = arith.constant 128 : index
              %21 = loom.view %arg0[%20, %c0] [%12, %c128] [1, 1] : memref<128x128xf32> -> !loom.view
              ...
              %24 = affine.for %arg7 = 0 to affine_map<()[s0] -> (128 ceildiv s0)>()[%14] iter_args(%arg8 = %19) -> (tensor<?x?xf32>) {
                ...
                %31 = loom.view %arg1[%29, %30] [%14, %13] [1, 1] : memref<128x256xf32> -> !loom.view
              ...
              %27 = loom.view %arg2[%25, %26] [%12, %13] [1, 1] : memref<128x256xf32> -> !loom.view
        ...
        affine.parallel (%arg4) = (0) to (8) {
          affine.for %arg5 = 0 to affine_map<()[s0, s1] -> ((128 ceildiv s0) ceildiv 8)>()[%12, %13] {
            affine.for %arg6 = 0 to affine_map<()[s0, s1] -> ((256 ceildiv s1) ceildiv 8)>()[%12, %13] {
              ...
              %c128 = arith.constant 128 : index
              %21 = loom.view %arg1[%c0, %20] [%c128, %13] [1, 1] : memref<128x256xf32> -> !loom.view
              ...
              %24 = affine.for %arg7 = 0 to affine_map<()[s0] -> (128 ceildiv s0)>()[%14] iter_args(%arg8 = %19) -> (tensor<?x?xf32>) {
                %28 = arith.muli %15, %12 : index
                %29 = arith.muli %arg7, %14 : index
                %30 = loom.view %arg0[%28, %29] [%12, %14] [1, 1] : memref<128x128xf32> -> !loom.view

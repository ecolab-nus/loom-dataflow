module attributes {loom.block_k = 64 : index, loom.block_m = 64 : index, loom.block_n = 64 : index} {
  func.func @matmul_kernel(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: memref<*xf32> {tt.divisibility = 16 : i32}, %arg2: memref<*xf32> {tt.divisibility = 16 : i32}, %arg3: index, %arg4: index, %arg5: index, %arg6: index, %arg7: index, %arg8: index, %arg9: index, %arg10: index, %arg11: index) {
    ...
    %2 = arith.muli %arg6, %arg9 : index
    %3 = arith.muli %arg7, %arg10 : index
    %c0 = arith.constant 0 : index
    %c8 = arith.constant 8 : index
    %c1 = arith.constant 1 : index
    %4 = scf.for %arg12 = %c0 to %c8 step %c1 iter_args(%arg13 = %1) -> (tensor<?x?xf32>) {
      %6 = arith.muli %arg12, %arg11 : index
      ...
      %12 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg13, %11 : tensor<?x?xf32>, tensor<?x?xf32>) outs(%arg13 : tensor<?x?xf32>) {

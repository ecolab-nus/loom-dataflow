        ...
        affine.parallel (%arg8) = (0) to (8) {
          affine.parallel (%arg9) = (0) to (8) {
            ...
            affine.for %arg10 = 0 to affine_map<(d0) -> (d0)>(%c16_0) {
              %12 = arith.muli %arg10, %9 : index
              %13 = arith.addi %c0, %12 : index
              %14 = arith.addi %13, %9 : index
              %15 = bufferization.to_tensor %alloc : memref<32x32xf32> to tensor<32x32xf32>
              %16 = scf.for %arg11 = %13 to %14 step %c1 iter_args(%arg12 = %15) -> (tensor<32x32xf32>) {
                %17 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 32 + d1 * 16384 + d2 * 1048576 + d3 * 131072)>(%arg11, %arg9, %arg6, %arg8)
                %reinterpret_cast_2 = memref.reinterpret_cast %arg0 to offset: [%17], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {sequential = [{depth = 4 : i64, iterator = "%arg10", reuse_type = "no_reuse", volume = 0 : i64}], spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "no_reuse", volume = 0 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "total_reuse", volume = 4096 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
                %alloc_3 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 4096 : i64}} : memref<32x32xf32>
                memref.copy %reinterpret_cast_2, %alloc_3 {tmd.copy.choice = {kind = "mem", memory_name = "L1"}} : memref<32x32xf32, strided<[512, 1], offset: ?>> to memref<32x32xf32>
                %18 = bufferization.to_tensor %alloc_3 restrict writable : memref<32x32xf32> to tensor<32x32xf32>
                %19 = affine.apply affine_map<(d0, d1) -> (d1 * 16384 + d0 * 32)>(%arg7, %arg11)
                %reinterpret_cast_4 = memref.reinterpret_cast %arg1 to offset: [%19], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {sequential = [{depth = 4 : i64, iterator = "%arg10", reuse_type = "no_reuse", volume = 0 : i64}], spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "total_reuse", volume = 4096 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "total_reuse", volume = 4096 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "total_reuse", volume = 4096 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
                %alloc_5 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 4096 : i64}} : memref<32x32xf32>
                memref.copy %reinterpret_cast_4, %alloc_5 {tmd.copy.choice = {kind = "mem", memory_name = "L1"}} : memref<32x32xf32, strided<[512, 1], offset: ?>> to memref<32x32xf32>
                %20 = bufferization.to_tensor %alloc_5 restrict writable : memref<32x32xf32> to tensor<32x32xf32>
                %21 = linalg.matmul ins(%18, %20 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%8 : tensor<32x32xf32>) -> tensor<32x32xf32>
                %22 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg12, %21 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%arg12 : tensor<32x32xf32>) {
                ^bb0(%in: f32, %in_6: f32, %out: f32):
                  %23 = arith.addf %in, %in_6 : f32
                  linalg.yield %23 : f32
                } -> tensor<32x32xf32>
                scf.yield %22 : tensor<32x32xf32>
              }
              bufferization.materialize_in_destination %16 in writable %alloc : (tensor<32x32xf32>, memref<32x32xf32>) -> ()
            }
            %10 = bufferization.to_tensor %alloc : memref<32x32xf32> to tensor<32x32xf32>
            %11 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 32 + d1 * 16384 + d2 * 1048576 + d3 * 131072)>(%arg7, %arg9, %arg6, %arg8)
            %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [%11], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "no_reuse", volume = 0 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
          ...
          affine.parallel (%arg9) = (0) to (8) {
            ...
            affine.for %arg10 = 0 to affine_map<(d0) -> (d0)>(%c16_0) {
              ...
              %16 = scf.for %arg11 = %13 to %14 step %c1 iter_args(%arg12 = %15) -> (tensor<32x32xf32>) {
                ...
                %reinterpret_cast_4 = memref.reinterpret_cast %arg1 to offset: [%19], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {sequential = [{depth = 4 : i64, iterator = "%arg10", reuse_type = "no_reuse", volume = 0 : i64}], spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "total_reuse", volume = 4096 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "total_reuse", volume = 4096 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "total_reuse", volume = 4096 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
                %alloc_5 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 4096 : i64}} : memref<32x32xf32>
                memref.copy %reinterpret_cast_4, %alloc_5 {tmd.copy.choice = {dim = "x", interconnect_name = "horizontal_links", kind = "broadcast"}} : memref<32x32xf32, strided<[512, 1], offset: ?>> to memref<32x32xf32>
                %20 = bufferization.to_tensor %alloc_5 restrict writable : memref<32x32xf32> to tensor<32x32xf32>
                %21 = linalg.matmul ins(%18, %20 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%8 : tensor<32x32xf32>) -> tensor<32x32xf32>
                %22 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg12, %21 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%arg12 : tensor<32x32xf32>) {
                ^bb0(%in: f32, %in_6: f32, %out: f32):
          ...
          affine.parallel (%arg9) = (0) to (8) {
            ...
            affine.for %arg10 = 0 to affine_map<(d0) -> (d0)>(%c16_0) {
              ...
              %16 = scf.for %arg11 = %13 to %14 step %c1 iter_args(%arg12 = %15) -> (tensor<32x32xf32>) {
                ...
                %reinterpret_cast_4 = memref.reinterpret_cast %arg1 to offset: [%19], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {sequential = [{depth = 4 : i64, iterator = "%arg10", reuse_type = "no_reuse", volume = 0 : i64}], spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "total_reuse", volume = 4096 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "total_reuse", volume = 4096 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "total_reuse", volume = 4096 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
                %alloc_5 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 4096 : i64}} : memref<32x32xf32>
                memref.copy %reinterpret_cast_4, %alloc_5 {tmd.copy.choice = {dim = "y", interconnect_name = "vertical_links", kind = "broadcast"}} : memref<32x32xf32, strided<[512, 1], offset: ?>> to memref<32x32xf32>
                %20 = bufferization.to_tensor %alloc_5 restrict writable : memref<32x32xf32> to tensor<32x32xf32>
                %21 = linalg.matmul ins(%18, %20 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%8 : tensor<32x32xf32>) -> tensor<32x32xf32>
                %22 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg12, %21 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%arg12 : tensor<32x32xf32>) {
                ^bb0(%in: f32, %in_6: f32, %out: f32):
      ...
      affine.for %arg7 = 0 to affine_map<(d0, d1) -> (d1)>(%arg3, %arg4) {
        affine.parallel (%arg8) = (0) to (8) {
          affine.parallel (%arg9) = (0) to (8) {
            ...
            %10 = bufferization.to_tensor %alloc : memref<32x32xf32> to tensor<32x32xf32>
            %11 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 32 + d1 * 16384 + d2 * 1048576 + d3 * 131072)>(%arg7, %arg9, %arg6, %arg8)
            %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [%11], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "x", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "y", reuse_type = "no_reuse", volume = 0 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
            bufferization.materialize_in_destination %10 in writable %reinterpret_cast : (tensor<32x32xf32>, memref<32x32xf32, strided<[512, 1], offset: ?>>) -> ()
          } {tmd.mapped_to = "y"}
        } {tmd.mapped_to = "x"}
      }
        ...
        affine.parallel (%arg8) = (0) to (8) {
          affine.parallel (%arg9) = (0) to (8) {
            ...
            affine.for %arg10 = 0 to affine_map<(d0) -> (d0)>(%c16_0) {
              ...
              %15 = bufferization.to_tensor %alloc : memref<32x32xf32> to tensor<32x32xf32>
              %16 = scf.for %arg11 = %13 to %14 step %c1 iter_args(%arg12 = %15) -> (tensor<32x32xf32>) {
                %17 = affine.apply affine_map<(d0, d1, d2) -> (d0 * 32 + d1 * 131072 + d2 * 16384)>(%arg11, %arg6, %arg9)
                ...
                memref.copy %reinterpret_cast_2, %alloc_3 {tmd.copy.choice = {kind = "mem", memory_name = "L1"}} : memref<32x32xf32, strided<[512, 1], offset: ?>> to memref<32x32xf32>
                %18 = bufferization.to_tensor %alloc_3 restrict writable : memref<32x32xf32> to tensor<32x32xf32>
                %19 = affine.apply affine_map<(d0, d1, d2) -> (d0 * 16384 + d1 * 256 + d2 * 32)>(%arg11, %arg7, %arg8)
            ...
            %10 = bufferization.to_tensor %alloc : memref<32x32xf32> to tensor<32x32xf32>
            %11 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 256 + d1 * 32 + d2 * 131072 + d3 * 16384)>(%arg7, %arg8, %arg6, %arg9)
            %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [%11], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "no_reuse", volume = 0 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
            bufferization.materialize_in_destination %10 in writable %reinterpret_cast : (tensor<32x32xf32>, memref<32x32xf32, strided<[512, 1], offset: ?>>) -> ()
          } {tmd.mapped_to = "x"}
        } {tmd.mapped_to = "y"}
          ...
          affine.parallel (%arg9) = (0) to (8) {
            ...
            affine.for %arg10 = 0 to affine_map<(d0) -> (d0)>(%c16_0) {
              ...
              %16 = scf.for %arg11 = %13 to %14 step %c1 iter_args(%arg12 = %15) -> (tensor<32x32xf32>) {
                ...
                %reinterpret_cast_2 = memref.reinterpret_cast %arg0 to offset: [%17], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {sequential = [{depth = 4 : i64, iterator = "%arg10", reuse_type = "no_reuse", volume = 0 : i64}], spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "total_reuse", volume = 4096 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "no_reuse", volume = 0 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "total_reuse", volume = 4096 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
                %alloc_3 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 4096 : i64}} : memref<32x32xf32>
                memref.copy %reinterpret_cast_2, %alloc_3 {tmd.copy.choice = {dim = "y", interconnect_name = "vertical_links", kind = "broadcast"}} : memref<32x32xf32, strided<[512, 1], offset: ?>> to memref<32x32xf32>
                %18 = bufferization.to_tensor %alloc_3 restrict writable : memref<32x32xf32> to tensor<32x32xf32>
                %19 = affine.apply affine_map<(d0, d1, d2) -> (d0 * 16384 + d1 * 256 + d2 * 32)>(%arg11, %arg7, %arg8)
                %reinterpret_cast_4 = memref.reinterpret_cast %arg1 to offset: [%19], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {sequential = [{depth = 4 : i64, iterator = "%arg10", reuse_type = "no_reuse", volume = 0 : i64}], spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "total_reuse", volume = 4096 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "total_reuse", volume = 4096 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
                %alloc_5 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 4096 : i64}} : memref<32x32xf32>
          ...
          affine.parallel (%arg9) = (0) to (8) {
            ...
            affine.for %arg10 = 0 to affine_map<(d0) -> (d0)>(%c16_0) {
              ...
              %16 = scf.for %arg11 = %13 to %14 step %c1 iter_args(%arg12 = %15) -> (tensor<32x32xf32>) {
                ...
                %reinterpret_cast_2 = memref.reinterpret_cast %arg0 to offset: [%17], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {sequential = [{depth = 4 : i64, iterator = "%arg10", reuse_type = "no_reuse", volume = 0 : i64}], spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "x", reuse_type = "total_reuse", volume = 4096 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "y", reuse_type = "no_reuse", volume = 0 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "total_reuse", volume = 4096 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
                %alloc_3 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 4096 : i64}} : memref<32x32xf32>
                memref.copy %reinterpret_cast_2, %alloc_3 {tmd.copy.choice = {dim = "x", interconnect_name = "horizontal_links", kind = "broadcast"}} : memref<32x32xf32, strided<[512, 1], offset: ?>> to memref<32x32xf32>
                %18 = bufferization.to_tensor %alloc_3 restrict writable : memref<32x32xf32> to tensor<32x32xf32>
                %19 = affine.apply affine_map<(d0, d1, d2) -> (d0 * 16384 + d1 * 256 + d2 * 32)>(%arg11, %arg7, %arg8)
                %reinterpret_cast_4 = memref.reinterpret_cast %arg1 to offset: [%19], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {sequential = [{depth = 4 : i64, iterator = "%arg10", reuse_type = "no_reuse", volume = 0 : i64}], spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "x", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "y", reuse_type = "total_reuse", volume = 4096 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "total_reuse", volume = 4096 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
                %alloc_5 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 4096 : i64}} : memref<32x32xf32>
        ...
        affine.parallel (%arg8) = (0) to (8) {
          affine.parallel (%arg9) = (0) to (8) {
            ...
            affine.for %arg10 = 0 to affine_map<(d0) -> (d0)>(%c16_0) {
              ...
              %15 = bufferization.to_tensor %alloc : memref<32x32xf32> to tensor<32x32xf32>
              %16 = scf.for %arg11 = %13 to %14 step %c1 iter_args(%arg12 = %15) -> (tensor<32x32xf32>) {
                %17 = affine.apply affine_map<(d0, d1) -> (d1 * 16384 + d0 * 32)>(%arg11, %arg6)
                ...
                memref.copy %reinterpret_cast_2, %alloc_3 {tmd.copy.choice = {kind = "mem", memory_name = "L1"}} : memref<32x32xf32, strided<[512, 1], offset: ?>> to memref<32x32xf32>
                %18 = bufferization.to_tensor %alloc_3 restrict writable : memref<32x32xf32> to tensor<32x32xf32>
                %19 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 16384 + d1 * 32 + d2 * 2048 + d3 * 256)>(%arg11, %arg9, %arg7, %arg8)
            ...
            %10 = bufferization.to_tensor %alloc : memref<32x32xf32> to tensor<32x32xf32>
            %11 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 16384 + d1 * 32 + d2 * 2048 + d3 * 256)>(%arg6, %arg9, %arg7, %arg8)
            %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [%11], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {spatial = [{depth = 2 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 3 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "no_reuse", volume = 0 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg6", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
            bufferization.materialize_in_destination %10 in writable %reinterpret_cast : (tensor<32x32xf32>, memref<32x32xf32, strided<[512, 1], offset: ?>>) -> ()
          } {tmd.mapped_to = "x"}
        } {tmd.mapped_to = "y"}

        ...
        affine.parallel (%arg11) = (0) to (8) {
          affine.parallel (%arg12) = (0) to (8) {
            ...
            %8 = scf.for %arg13 = %c0 to %7 step %c1 iter_args(%arg14 = %alloc_0) -> (memref<32x32xf32>) {
              ...
              %reinterpret_cast_1 = memref.reinterpret_cast %arg0 to offset: [%10], sizes: [32, 32], strides: [512, 1] : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
              ...
              %reinterpret_cast_3 = memref.reinterpret_cast %arg1 to offset: [%11], sizes: [32, 32], strides: [512, 1] : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>
            ...
            %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [%9], sizes: [32, 32], strides: [512, 1] : memref<*xf32> to memref<32x32xf32, strided<[512, 1], offset: ?>>

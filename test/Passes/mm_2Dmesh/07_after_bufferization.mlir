    ...
    affine.parallel (%arg6) = (0) to (8) {
      affine.parallel (%arg7) = (0) to (8) {
        affine.for %arg8 = 0 to affine_map<()[s0, s1] -> ((s0 ceildiv 8) ceildiv 8)>()[%arg3, %arg4] {
          ...
          %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%12], sizes: [8, 64, 64], strides: [64, 512, 1] {tmd.reuse = {spatial = [{depth = 0 : i64, iterator = "%arg6", mapped_to = "x", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", mapped_to = "y", reuse_type = "no_reuse", volume = 0 : i64}], temporal = [{depth = 2 : i64, iterator = "%arg8", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<8x64x64xf32, strided<[64, 512, 1], offset: ?>>
    ...
    affine.parallel (%arg6) = (0) to (8) {
      affine.parallel (%arg7) = (0) to (8) {
        affine.for %arg8 = 0 to affine_map<()[s0, s1] -> (s0 ceildiv 8)>()[%arg3, %arg4] {
          ...
          %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%12], sizes: [8, 64, 64], strides: [64, 512, 1] {tmd.reuse = {spatial = [{depth = 0 : i64, iterator = "%arg6", mapped_to = "x", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", mapped_to = "y", reuse_type = "total_reuse", volume = 131072 : i64}], temporal = [{depth = 2 : i64, iterator = "%arg8", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<8x64x64xf32, strided<[64, 512, 1], offset: ?>>
          %alloc = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 131072 : i64}} : memref<8x64x64xf32>
          memref.copy %reinterpret_cast, %alloc {tmd.copy.choice = {kind = "mem", memory_name = "L1"}} : memref<8x64x64xf32, strided<[64, 512, 1], offset: ?>> to memref<8x64x64xf32>
          affine.for %arg9 = 0 to affine_map<()[s0, s1] -> (s1 ceildiv 8)>()[%arg3, %arg4] {
            %cst = arith.constant 0.000000e+00 : f32
  ...
  func.func @matmul_kernel__d1i0_d0i1__f01__hoist_block_0__c0mem_c1mem(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: memref<*xf32> {tt.divisibility = 16 : i32}, %arg2: memref<*xf32> {tt.divisibility = 16 : i32}, %arg3: index, %arg4: index, %arg5: index) {
    affine.parallel (%arg6) = (0) to (8) {
      affine.parallel (%arg7) = (0) to (8) {
        affine.for %arg8 = 0 to affine_map<()[s0, s1] -> (s0 ceildiv 8)>()[%arg3, %arg4] {
          %12 = affine.apply affine_map<(d0, d1) -> (d0 * 262144 + d1 * 32768)>(%arg6, %arg8)
          %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%12], sizes: [8, 64, 64], strides: [64, 512, 1] {tmd.reuse = {spatial = [{depth = 0 : i64, iterator = "%arg6", mapped_to = "y", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", mapped_to = "x", reuse_type = "total_reuse", volume = 131072 : i64}], temporal = [{depth = 2 : i64, iterator = "%arg8", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<8x64x64xf32, strided<[64, 512, 1], offset: ?>>
          %alloc = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 131072 : i64}} : memref<8x64x64xf32>
          memref.copy %reinterpret_cast, %alloc {tmd.copy.choice = {kind = "mem", memory_name = "L1"}} : memref<8x64x64xf32, strided<[64, 512, 1], offset: ?>> to memref<8x64x64xf32>
          affine.for %arg9 = 0 to affine_map<()[s0, s1] -> (s1 ceildiv 8)>()[%arg3, %arg4] {
            %cst = arith.constant 0.000000e+00 : f32
    ...
    affine.parallel (%arg6) = (0) to (8) {
      affine.parallel (%arg7) = (0) to (8) {
        affine.for %arg8 = 0 to affine_map<()[s0, s1] -> (s0)>()[%arg3, %arg4] {
          ...
          %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%12], sizes: [8, 64, 64], strides: [64, 512, 1] {tmd.reuse = {spatial = [{depth = 0 : i64, iterator = "%arg6", mapped_to = "x", reuse_type = "total_reuse", volume = 131072 : i64}, {depth = 1 : i64, iterator = "%arg7", mapped_to = "y", reuse_type = "total_reuse", volume = 131072 : i64}], temporal = [{depth = 2 : i64, iterator = "%arg8", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<8x64x64xf32, strided<[64, 512, 1], offset: ?>>
          %alloc = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 131072 : i64}} : memref<8x64x64xf32>
          memref.copy %reinterpret_cast, %alloc {tmd.copy.choice = {kind = "mem", memory_name = "L1"}} : memref<8x64x64xf32, strided<[64, 512, 1], offset: ?>> to memref<8x64x64xf32>
          affine.for %arg9 = 0 to affine_map<()[s0, s1] -> ((s1 ceildiv 8) ceildiv 8)>()[%arg3, %arg4] {
            %cst = arith.constant 0.000000e+00 : f32
    ...
    affine.parallel (%arg6) = (0) to (8) {
      affine.parallel (%arg7) = (0) to (8) {
        affine.for %arg8 = 0 to affine_map<()[s0, s1] -> ((s1 ceildiv 8) ceildiv 8)>()[%arg3, %arg4] {
          ...
          %reinterpret_cast = memref.reinterpret_cast %arg1 to offset: [%12], sizes: [8, 64, 64], strides: [32768, 512, 1] {tmd.reuse = {spatial = [{depth = 0 : i64, iterator = "%arg6", mapped_to = "x", reuse_type = "no_reuse", volume = 0 : i64}, {depth = 1 : i64, iterator = "%arg7", mapped_to = "y", reuse_type = "no_reuse", volume = 0 : i64}], temporal = [{depth = 2 : i64, iterator = "%arg8", reuse_type = "no_reuse", volume = 0 : i64}]}} : memref<*xf32> to memref<8x64x64xf32, strided<[32768, 512, 1], offset: ?>>
          %alloc = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1", size = 131072 : i64}} : memref<8x64x64xf32>
          memref.copy %reinterpret_cast, %alloc {tmd.copy.choice = {kind = "mem", memory_name = "L1"}} : memref<8x64x64xf32, strided<[32768, 512, 1], offset: ?>> to memref<8x64x64xf32>
          affine.for %arg9 = 0 to affine_map<()[s0, s1] -> (s0)>()[%arg3, %arg4] {
            %cst = arith.constant 0.000000e+00 : f32

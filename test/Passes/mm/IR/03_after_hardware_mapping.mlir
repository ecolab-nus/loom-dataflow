            ...
            scf.for %arg6 = %c0 to %23 step %c1 {
              ...
              scf.for %arg7 = %c0 to %24 step %c1 {
                ...
                %36 = scf.for %arg8 = %c0 to %27 step %c1 iter_args(%arg9 = %31) -> (tensor<?x?xf16>) {
                  ...
                  %47 = loom.subview %arg0[%45, %46] [%18, %20] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                  ...
                  %50 = loom.subview %arg1[%46, %49] [%20, %19] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
            ...
            scf.for %arg6 = %c0 to %23 step %c1 {
              scf.for %arg7 = %c0 to %22 step %c1 {
                ...
                %34 = scf.for %arg8 = %c0 to %25 step %c1 iter_args(%arg9 = %29) -> (tensor<?x?xf16>) {
                  ...
                  %45 = loom.subview %arg0[%43, %44] [%18, %20] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                  ...
                  %48 = loom.subview %arg1[%44, %47] [%20, %19] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<512x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
                ...
                %41 = loom.subview %arg2[%39, %40] [%18, %19] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>

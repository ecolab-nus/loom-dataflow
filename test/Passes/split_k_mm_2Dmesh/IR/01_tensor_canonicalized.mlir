  ...
  func.func @split_k_matmul(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
    ...
    affine.parallel (%arg3, %arg4, %arg5) = (0, 0, 0) to (symbol(%3), symbol(%4), symbol(%5)) {
      ...
      scf.if %14 {
        ...
        %17 = loom.reduce_sum ins(%13) outs(%16) : tensor<?x?xf16> -> tensor<?x?xf16>
        %18 = bufferization.to_buffer %17 : tensor<?x?xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
        memref.copy %18, %subview_1 : memref<?x?xf16, strided<[512, 1], offset: ?>> to memref<?x?xf16, strided<[512, 1], offset: ?>>
      }
    }
    return
  }

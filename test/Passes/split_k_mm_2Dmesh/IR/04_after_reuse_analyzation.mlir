module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
  ...
  module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x8_y2y4__d0i2_d1i0_d2i1__f012(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
            ...
            scf.for %arg6 = %c0 to %26 step %c1 {
              ...
              scf.for %arg7 = %c0 to %27 step %c1 {
                ...
                scf.for %arg8 = %c0 to %28 step %c1 {
                  ...
                  %41 = loom.subview %arg2[%33, %38] [%22, %21] [1, 1], reuse : [seq = false, spat = true, temp = true] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                  ...
                  scf.if %51 {
                    ...
                    %56 = loom.subview %arg0[%32, %38] [%20, %21] [1, 1], reuse : [seq = false, spat = true, temp = true] : memref<512x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                    %57 = loom.bufferize_to_memref %55 : tensor<?x?xf16> -> memref<?x?xf16>
                    loom.copy %57, %56 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] : memref<?x?xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
  ...
  module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x8_y2y4__d0i2_d1i1_d2i0__f012(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c7 = arith.constant 7 : index
      %c8 = arith.constant 8 : index
      %c2 = arith.constant 2 : index
      %c1 = arith.constant 1 : index
  ...
  module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x8_y4y2__d0i2_d1i0_d2i1__f012(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c7 = arith.constant 7 : index
      %c8 = arith.constant 8 : index
      %c2 = arith.constant 2 : index
      %c1 = arith.constant 1 : index
  ...
  module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x8_y4y2__d0i2_d1i1_d2i0__f012(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c7 = arith.constant 7 : index
      %c8 = arith.constant 8 : index
      %c4 = arith.constant 4 : index
      %c1 = arith.constant 1 : index
  ...
  module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x2x4_y8__d0i2_d1i0_d2i1__f012(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c2 = arith.constant 2 : index
      %c4 = arith.constant 4 : index
      %c1 = arith.constant 1 : index
      %c8 = arith.constant 8 : index
  ...
  module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x2x4_y8__d0i2_d1i1_d2i0__f012(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c2 = arith.constant 2 : index
      %c8 = arith.constant 8 : index
      %c1 = arith.constant 1 : index
      %c4 = arith.constant 4 : index
              ...
              scf.for %arg7 = %c0 to %27 step %c1 {
                ...
                scf.for %arg8 = %c0 to %28 step %c1 {
                  ...
                  scf.if %51 {
                    ...
                    %53 = arith.muli %arg3, %c2 : index
                    %54 = arith.addi %53, %c1 : index
                    %55 = loom.reduce_sum ins(%47) outs(%52) region : (UL : [%53, %arg4], LR : [%54, %arg4]) : tensor<?x?xf16> -> tensor<?x?xf16>
                    loom.semaphore_give %44 : memref<?x?xf16>
                    %56 = loom.subview %arg0[%32, %38] [%20, %21] [1, 1], reuse : [seq = false, spat = true, temp = true] : memref<512x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
                    %57 = loom.bufferize_to_memref %55 : tensor<?x?xf16> -> memref<?x?xf16>
                    loom.copy %57, %56 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] : memref<?x?xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
  ...
  module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x4x2_y8__d0i2_d1i0_d2i1__f012(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
  ...
  module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x4x2_y8__d0i2_d1i1_d2i0__f012(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c3 = arith.constant 3 : index
      %c4 = arith.constant 4 : index
      %c8 = arith.constant 8 : index
      %c1 = arith.constant 1 : index

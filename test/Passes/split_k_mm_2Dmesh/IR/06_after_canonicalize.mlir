module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x8_y2y4__d0i2_d1i0_d2i1__f012__n_dim_y_level0_bc2_n__tile_k512__tile_m64__tile_n64(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
          ...
          affine.parallel (%arg5) = (0) to (8) {
            scf.for %arg6 = %c0 to %c4 step %c1 {
              scf.for %arg7 = %c0 to %c2 step %c1 {
                ...
                %39 = linalg.fill ins(%cst : f16) outs(%38 : tensor<64x64xf16>) -> tensor<64x64xf16>
                %40 = linalg.matmul ins(%29, %35 : tensor<64x512xf16>, tensor<512x64xf16>) outs(%39 : tensor<64x64xf16>) -> tensor<64x64xf16>
                ...
                %43 = loom.init_tensor %42[64, 64] : memref<64x64xf16> -> tensor<64x64xf16>
                %44 = arith.cmpi eq, %arg5, %c0 : index
                scf.if %44 {
                  %45 = linalg.fill ins(%cst : f16) outs(%43 : tensor<64x64xf16>) -> tensor<64x64xf16>
                  %46 = loom.reduce_sum ins(%40) outs(%45) region : (UL : [%c0, %28], LR : [%c7, %28]) : tensor<64x64xf16> -> tensor<64x64xf16>
                  loom.semaphore_give %37 : memref<64x64xf16>
                  %47 = affine.apply affine_map<(d0, d1) -> (d0 * 512 + d1)>(%22, %30)
                  %reinterpret_cast_1 = memref.reinterpret_cast %arg0 to offset: [%47], sizes: [64, 64], strides: [512, 1] : memref<512x512xf16> to memref<64x64xf16, strided<[512, 1], offset: ?>>
                  %48 = loom.bufferize_to_memref %46 : tensor<64x64xf16> -> memref<64x64xf16>
                  loom.copy %48, %reinterpret_cast_1 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %28], LR : [%arg5, %28]) : memref<64x64xf16> to memref<64x64xf16, strided<[512, 1], offset: ?>>
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x8_y2y4__d0i2_d1i1_d2i0__f012__dim_y_level0_bc2_n_n__tile_k512__tile_m64__tile_n64(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c4 = arith.constant 4 : index
      %c7 = arith.constant 7 : index
      %c2 = arith.constant 2 : index
      %c1 = arith.constant 1 : index
          ...
          affine.parallel (%arg5) = (0) to (8) {
            scf.for %arg6 = %c0 to %c2 step %c1 {
              scf.for %arg7 = %c0 to %c4 step %c1 {
                ...
                scf.if %44 {
                  %45 = linalg.fill ins(%cst : f16) outs(%43 : tensor<64x64xf16>) -> tensor<64x64xf16>
                  %46 = loom.reduce_sum ins(%40) outs(%45) region : (UL : [%c0, %34], LR : [%c7, %34]) : tensor<64x64xf16> -> tensor<64x64xf16>
                  loom.semaphore_give %37 : memref<64x64xf16>
                  %47 = affine.apply affine_map<(d0, d1) -> (d0 * 512 + d1)>(%22, %30)
                  %reinterpret_cast_1 = memref.reinterpret_cast %arg0 to offset: [%47], sizes: [64, 64], strides: [512, 1] : memref<512x512xf16> to memref<64x64xf16, strided<[512, 1], offset: ?>>
                  %48 = loom.bufferize_to_memref %46 : tensor<64x64xf16> -> memref<64x64xf16>
                  loom.copy %48, %reinterpret_cast_1 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %34], LR : [%arg5, %34]) : memref<64x64xf16> to memref<64x64xf16, strided<[512, 1], offset: ?>>
                  loom.semaphore_give %42 : memref<64x64xf16>
                }
              } {loom.block_sym = @tile_n, loom.iter_type = #loom.iter_type<temporal>}
            } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x8_y4y2__d0i2_d1i0_d2i1__f012__n_dim_y_level0_bc4_n__tile_k512__tile_m64__tile_n64(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c2 = arith.constant 2 : index
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x8_y4y2__d0i2_d1i1_d2i0__f012__dim_y_level0_bc4_n_n__tile_k512__tile_m64__tile_n64(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c2 = arith.constant 2 : index
      %c3 = arith.constant 3 : index
      %c7 = arith.constant 7 : index
      %c4 = arith.constant 4 : index
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x2x4_y8__d0i2_d1i0_d2i1__f012__n_dim_y_level0_bc8_n__tile_k512__tile_m64__tile_n64(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c4 = arith.constant 4 : index
      %c7 = arith.constant 7 : index
      %c2 = arith.constant 2 : index
      %c1 = arith.constant 1 : index
          ...
          affine.parallel (%arg5) = (0) to (2) {
            scf.for %arg6 = %c0 to %c2 step %c1 {
              scf.for %arg7 = %c0 to %c4 step %c1 {
                ...
                %38 = linalg.fill ins(%cst : f16) outs(%37 : tensor<64x64xf16>) -> tensor<64x64xf16>
                %39 = linalg.matmul ins(%29, %34 : tensor<64x512xf16>, tensor<512x64xf16>) outs(%38 : tensor<64x64xf16>) -> tensor<64x64xf16>
                loom.semaphore_give %32 : memref<512x64xf16>
                loom.semaphore_give %25 : memref<64x512xf16>
                %40 = loom.alloc [64, 64] on @L1 : memref<64x64xf16>
                %41 = loom.semaphore_take %40 : memref<64x64xf16> -> memref<64x64xf16>
                %42 = loom.init_tensor %41[64, 64] : memref<64x64xf16> -> tensor<64x64xf16>
                %43 = arith.cmpi eq, %arg5, %c0 : index
                scf.if %43 {
                  %44 = linalg.fill ins(%cst : f16) outs(%42 : tensor<64x64xf16>) -> tensor<64x64xf16>
                  %45 = arith.addi %27, %c1 : index
                  %46 = loom.reduce_sum ins(%39) outs(%44) region : (UL : [%27, %arg3], LR : [%45, %arg3]) : tensor<64x64xf16> -> tensor<64x64xf16>
                  loom.semaphore_give %36 : memref<64x64xf16>
                  %47 = affine.apply affine_map<(d0, d1) -> (d0 * 512 + d1)>(%22, %30)
                  %reinterpret_cast_1 = memref.reinterpret_cast %arg0 to offset: [%47], sizes: [64, 64], strides: [512, 1] : memref<512x512xf16> to memref<64x64xf16, strided<[512, 1], offset: ?>>
                  %48 = loom.bufferize_to_memref %46 : tensor<64x64xf16> -> memref<64x64xf16>
                  loom.copy %48, %reinterpret_cast_1 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%28, %arg3], LR : [%28, %arg3]) : memref<64x64xf16> to memref<64x64xf16, strided<[512, 1], offset: ?>>
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x2x4_y8__d0i2_d1i1_d2i0__f012__dim_y_level0_bc8_n_n__tile_k512__tile_m64__tile_n64(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c4 = arith.constant 4 : index
      %c7 = arith.constant 7 : index
      %c2 = arith.constant 2 : index
      %c1 = arith.constant 1 : index
            ...
            scf.for %arg6 = %c0 to %c2 step %c1 {
              scf.for %arg7 = %c0 to %c4 step %c1 {
                ...
                scf.if %43 {
                  %44 = linalg.fill ins(%cst : f16) outs(%42 : tensor<64x64xf16>) -> tensor<64x64xf16>
                  %45 = arith.addi %27, %c1 : index
                  %46 = loom.reduce_sum ins(%39) outs(%44) region : (UL : [%27, %arg4], LR : [%45, %arg4]) : tensor<64x64xf16> -> tensor<64x64xf16>
                  loom.semaphore_give %36 : memref<64x64xf16>
                  %47 = affine.apply affine_map<(d0, d1) -> (d0 * 512 + d1)>(%22, %30)
                  %reinterpret_cast_1 = memref.reinterpret_cast %arg0 to offset: [%47], sizes: [64, 64], strides: [512, 1] : memref<512x512xf16> to memref<64x64xf16, strided<[512, 1], offset: ?>>
                  %48 = loom.bufferize_to_memref %46 : tensor<64x64xf16> -> memref<64x64xf16>
                  loom.copy %48, %reinterpret_cast_1 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%28, %arg4], LR : [%28, %arg4]) : memref<64x64xf16> to memref<64x64xf16, strided<[512, 1], offset: ?>>
                  loom.semaphore_give %41 : memref<64x64xf16>
                }
              } {loom.block_sym = @tile_k, loom.iter_type = #loom.iter_type<temporal>}
            } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x4x2_y8__d0i2_d1i0_d2i1__f012__n_dim_y_level0_bc8_n__tile_k512__tile_m64__tile_n64(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c2 = arith.constant 2 : index
      %c7 = arith.constant 7 : index
      %c3 = arith.constant 3 : index
      %c4 = arith.constant 4 : index
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
    func.func @split_k_matmul__x4x2_y8__d0i2_d1i1_d2i0__f012__dim_y_level0_bc8_n_n__tile_k512__tile_m64__tile_n64(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
      %c2 = arith.constant 2 : index
      %c7 = arith.constant 7 : index
      %c3 = arith.constant 3 : index
      %c4 = arith.constant 4 : index

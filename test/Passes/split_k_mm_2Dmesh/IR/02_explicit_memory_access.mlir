module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 256 : index}, loom.tile_n = {is_reduction = false, upper_bound = 256 : index}} {
  func.func @split_k_matmul(%arg0: memref<256x256xf16>, %arg1: memref<256x4096xf16>, %arg2: memref<4096x256xf16>) {
    ...
    affine.parallel (%arg3, %arg4, %arg5) = (0, 0, 0) to (symbol(%3), symbol(%4), symbol(%5)) {
      ...
      %10 = loom.subview %arg1[%6, %7] [%0, %2] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<256x4096xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
      ...
      %13 = loom.alloc [%2, %1] on @L1 : memref<?x?xf16>
      %14 = loom.semaphore_take %13 : memref<?x?xf16> -> memref<?x?xf16>
      %15 = loom.subview %arg2[%7, %12] [%2, %1] [1, 1], reuse : [seq = false, spat = false, temp = false] : memref<4096x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
      loom.copy %15, %14 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x?xf16, strided<[256, 1], offset: ?>> to memref<?x?xf16>
      %16 = loom.bufferize_to_tensor %14[%2, %1] : memref<?x?xf16> -> tensor<?x?xf16>
      %17 = loom.alloc [%0, %1] on @L1 : memref<?x?xf16>
      ...
      %21 = linalg.matmul ins(%11, %16 : tensor<?x?xf16>, tensor<?x?xf16>) outs(%20 : tensor<?x?xf16>) -> tensor<?x?xf16>
      ...
      scf.if %22 {
        ...
        loom.copy %29, %28 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] : memref<?x?xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>

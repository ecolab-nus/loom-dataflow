      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c2, %c4, %c8) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c4 step %c1 {
          scf.for %arg7 = %c0 to %c2 step %c1 {
            ...
            loom.copy %reinterpret_cast, %26 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%arg5, %30], LR : [%arg5, %30]) : memref<32x512xf16, strided<[4096, 1], offset: ?>> to memref<32x512xf16>
            ...
            %34 = arith.muli %arg5, %c131072 : index
            %35 = arith.addi %34, %31 : index
            %reinterpret_cast_0 = memref.reinterpret_cast %arg2 to offset: [%35], sizes: [512, 32], strides: [256, 1] : memref<4096x256xf16> to memref<512x32xf16, strided<[256, 1], offset: ?>>
            loom.copy %reinterpret_cast_0, %33 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%arg5, %30], LR : [%arg5, %30]) : memref<512x32xf16, strided<[256, 1], offset: ?>> to memref<512x32xf16>
            ...
            linalg.matmul ins(%26, %33 : memref<32x512xf16>, memref<512x32xf16>) outs(%37 : memref<32x32xf16>)
            ...
            scf.if %40 {
              linalg.fill ins(%cst : f16) outs(%39 : memref<32x32xf16>)
              loom.reduce_sum ins(%37) outs(%39) region : (UL : [%c0, %30], LR : [%c7, %30]) : memref<32x32xf16>
              ...
              loom.copy %39, %reinterpret_cast_1 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %30], LR : [%arg5, %30]) : memref<32x32xf16> to memref<32x32xf16, strided<[256, 1], offset: ?>>
      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c2, %c4, %c8) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c4 step %c1 {
          scf.for %arg7 = %c0 to %c2 step %c1 {
            ...
            loom.copy %reinterpret_cast_0, %33 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 2] region : (UL : [%arg5, %29], LR : [%arg5, %36]) : memref<512x32xf16, strided<[256, 1], offset: ?>> to memref<512x32xf16>
            %37 = loom.alloc [32, 32] on @L1 : memref<32x32xf16>
            %38 = loom.semaphore_take %37 : memref<32x32xf16> -> memref<32x32xf16>
            linalg.fill ins(%cst : f16) outs(%38 : memref<32x32xf16>)
            linalg.matmul ins(%26, %33 : memref<32x512xf16>, memref<512x32xf16>) outs(%38 : memref<32x32xf16>)
            loom.semaphore_give %33 : memref<512x32xf16>
            loom.semaphore_give %26 : memref<32x512xf16>
            %39 = loom.alloc [32, 32] on @L1 : memref<32x32xf16>
            %40 = loom.semaphore_take %39 : memref<32x32xf16> -> memref<32x32xf16>
            %41 = arith.cmpi eq, %arg5, %c0 : index
            scf.if %41 {
              linalg.fill ins(%cst : f16) outs(%40 : memref<32x32xf16>)
              loom.reduce_sum ins(%38) outs(%40) region : (UL : [%c0, %30], LR : [%c7, %30]) : memref<32x32xf16>
              loom.semaphore_give %38 : memref<32x32xf16>
              %42 = arith.muli %21, %c8192 : index
              %43 = arith.addi %42, %31 : index
              %reinterpret_cast_1 = memref.reinterpret_cast %arg0 to offset: [%43], sizes: [32, 32], strides: [256, 1] : memref<256x256xf16> to memref<32x32xf16, strided<[256, 1], offset: ?>>
              loom.copy %40, %reinterpret_cast_1 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %30], LR : [%arg5, %30]) : memref<32x32xf16> to memref<32x32xf16, strided<[256, 1], offset: ?>>
              loom.semaphore_give %40 : memref<32x32xf16>
            }
          } {loom.block_sym = @tile_n, loom.iter_type = #loom.iter_type<temporal>}
        } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
        scf.reduce 
        ...
        scf.for %arg6 = %c0 to %c2 step %c1 {
          scf.for %arg7 = %c0 to %c4 step %c1 {
            ...
            scf.if %40 {
              ...
              %42 = arith.addi %arg3, %41 : index
              loom.reduce_sum ins(%37) outs(%39) region : (UL : [%c0, %42], LR : [%c7, %42]) : memref<32x32xf16>
              loom.semaphore_give %37 : memref<32x32xf16>
              %43 = arith.muli %21, %c8192 : index
              %44 = arith.addi %43, %31 : index
              %reinterpret_cast_1 = memref.reinterpret_cast %arg0 to offset: [%44], sizes: [32, 32], strides: [256, 1] : memref<256x256xf16> to memref<32x32xf16, strided<[256, 1], offset: ?>>
              loom.copy %39, %reinterpret_cast_1 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %30], LR : [%arg5, %30]) : memref<32x32xf16> to memref<32x32xf16, strided<[256, 1], offset: ?>>
              loom.semaphore_give %39 : memref<32x32xf16>
            }
          } {loom.block_sym = @tile_n, loom.iter_type = #loom.iter_type<temporal>}
      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c4, %c2, %c8) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c2 step %c1 {
          scf.for %arg7 = %c0 to %c4 step %c1 {
            ...
            loom.copy %reinterpret_cast, %26 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 2] region : (UL : [%arg5, %29], LR : [%arg5, %30]) : memref<32x512xf16, strided<[4096, 1], offset: ?>> to memref<32x512xf16>
            %31 = arith.muli %23, %c32 : index
            %32 = loom.alloc [512, 32] on @L1 : memref<512x32xf16>
            %33 = loom.semaphore_take %32 : memref<512x32xf16> -> memref<512x32xf16>
            %34 = arith.muli %arg5, %c131072 : index
            ...
            scf.if %41 {
              linalg.fill ins(%cst : f16) outs(%40 : memref<32x32xf16>)
              %42 = arith.muli %arg4, %c4 : index
              %43 = arith.addi %arg3, %42 : index
              loom.reduce_sum ins(%38) outs(%40) region : (UL : [%c0, %43], LR : [%c7, %43]) : memref<32x32xf16>
              loom.semaphore_give %38 : memref<32x32xf16>
              %44 = arith.muli %21, %c8192 : index
              %45 = arith.addi %44, %31 : index
              ...
              loom.copy %40, %reinterpret_cast_1 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %36], LR : [%arg5, %36]) : memref<32x32xf16> to memref<32x32xf16, strided<[256, 1], offset: ?>>
              loom.semaphore_give %40 : memref<32x32xf16>
            }
          } {loom.block_sym = @tile_n, loom.iter_type = #loom.iter_type<temporal>}
        } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c4, %c2, %c8) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c2 step %c1 {
          scf.for %arg7 = %c0 to %c4 step %c1 {
            ...
            loom.copy %reinterpret_cast_0, %33 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 4] region : (UL : [%arg5, %29], LR : [%arg5, %36]) : memref<512x32xf16, strided<[256, 1], offset: ?>> to memref<512x32xf16>
            %37 = loom.alloc [32, 32] on @L1 : memref<32x32xf16>
            %38 = loom.semaphore_take %37 : memref<32x32xf16> -> memref<32x32xf16>
            linalg.fill ins(%cst : f16) outs(%38 : memref<32x32xf16>)
            linalg.matmul ins(%26, %33 : memref<32x512xf16>, memref<512x32xf16>) outs(%38 : memref<32x32xf16>)
      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c2, %c4, %c8) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c4 step %c1 {
          scf.for %arg7 = %c0 to %c2 step %c1 {
            ...
            loom.copy %reinterpret_cast, %26 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 4] region : (UL : [%arg5, %29], LR : [%arg5, %30]) : memref<32x512xf16, strided<[4096, 1], offset: ?>> to memref<32x512xf16>
            %31 = arith.muli %23, %c32 : index
            %32 = loom.alloc [512, 32] on @L1 : memref<512x32xf16>
            %33 = loom.semaphore_take %32 : memref<512x32xf16> -> memref<512x32xf16>
            %34 = arith.muli %arg5, %c131072 : index
      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c8, %c4, %c2) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c2 step %c1 {
          scf.for %arg7 = %c0 to %c4 step %c1 {
            ...
            loom.copy %reinterpret_cast, %26 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%30, %arg3], LR : [%30, %arg3]) : memref<32x512xf16, strided<[4096, 1], offset: ?>> to memref<32x512xf16>
            %31 = arith.muli %21, %c32 : index
            %32 = loom.alloc [512, 32] on @L1 : memref<512x32xf16>
            %33 = loom.semaphore_take %32 : memref<512x32xf16> -> memref<512x32xf16>
            %34 = arith.muli %23, %c131072 : index
            %35 = arith.addi %34, %31 : index
            %reinterpret_cast_0 = memref.reinterpret_cast %arg2 to offset: [%35], sizes: [512, 32], strides: [256, 1] : memref<4096x256xf16> to memref<512x32xf16, strided<[256, 1], offset: ?>>
            loom.copy %reinterpret_cast_0, %33 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%30, %arg3], LR : [%30, %arg3]) : memref<512x32xf16, strided<[256, 1], offset: ?>> to memref<512x32xf16>
            %36 = loom.alloc [32, 32] on @L1 : memref<32x32xf16>
            %37 = loom.semaphore_take %36 : memref<32x32xf16> -> memref<32x32xf16>
            linalg.fill ins(%cst : f16) outs(%37 : memref<32x32xf16>)
            linalg.matmul ins(%26, %33 : memref<32x512xf16>, memref<512x32xf16>) outs(%37 : memref<32x32xf16>)
            ...
            scf.if %40 {
              linalg.fill ins(%cst : f16) outs(%39 : memref<32x32xf16>)
              %41 = arith.addi %29, %c1 : index
              loom.reduce_sum ins(%37) outs(%39) region : (UL : [%29, %arg3], LR : [%41, %arg3]) : memref<32x32xf16>
              loom.semaphore_give %37 : memref<32x32xf16>
              %42 = arith.muli %arg3, %c8192 : index
              %43 = arith.addi %42, %31 : index
              %reinterpret_cast_1 = memref.reinterpret_cast %arg0 to offset: [%43], sizes: [32, 32], strides: [256, 1] : memref<256x256xf16> to memref<32x32xf16, strided<[256, 1], offset: ?>>
              loom.copy %39, %reinterpret_cast_1 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%30, %arg3], LR : [%30, %arg3]) : memref<32x32xf16> to memref<32x32xf16, strided<[256, 1], offset: ?>>
              loom.semaphore_give %39 : memref<32x32xf16>
            }
      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c8, %c4, %c2) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c2 step %c1 {
          scf.for %arg7 = %c0 to %c4 step %c1 {
            ...
            %35 = arith.addi %34, %31 : index
            %reinterpret_cast_0 = memref.reinterpret_cast %arg2 to offset: [%35], sizes: [512, 32], strides: [256, 1] : memref<4096x256xf16> to memref<512x32xf16, strided<[256, 1], offset: ?>>
            loom.copy %reinterpret_cast_0, %33 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 8] region : (UL : [%30, %c0], LR : [%30, %c7]) : memref<512x32xf16, strided<[256, 1], offset: ?>> to memref<512x32xf16>
            %36 = loom.alloc [32, 32] on @L1 : memref<32x32xf16>
            %37 = loom.semaphore_take %36 : memref<32x32xf16> -> memref<32x32xf16>
            linalg.fill ins(%cst : f16) outs(%37 : memref<32x32xf16>)
            linalg.matmul ins(%26, %33 : memref<32x512xf16>, memref<512x32xf16>) outs(%37 : memref<32x32xf16>)
      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c4, %c8, %c2) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c2 step %c1 {
          scf.for %arg7 = %c0 to %c4 step %c1 {
            ...
            %29 = arith.muli %arg3, %c2 : index
            %30 = arith.addi %arg5, %29 : index
            loom.copy %reinterpret_cast, %26 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%30, %arg4], LR : [%30, %arg4]) : memref<32x512xf16, strided<[4096, 1], offset: ?>> to memref<32x512xf16>
            ...
            %35 = arith.addi %34, %31 : index
            %reinterpret_cast_0 = memref.reinterpret_cast %arg2 to offset: [%35], sizes: [512, 32], strides: [256, 1] : memref<4096x256xf16> to memref<512x32xf16, strided<[256, 1], offset: ?>>
            loom.copy %reinterpret_cast_0, %33 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%30, %arg4], LR : [%30, %arg4]) : memref<512x32xf16, strided<[256, 1], offset: ?>> to memref<512x32xf16>
            %36 = loom.alloc [32, 32] on @L1 : memref<32x32xf16>
            %37 = loom.semaphore_take %36 : memref<32x32xf16> -> memref<32x32xf16>
            linalg.fill ins(%cst : f16) outs(%37 : memref<32x32xf16>)
            linalg.matmul ins(%26, %33 : memref<32x512xf16>, memref<512x32xf16>) outs(%37 : memref<32x32xf16>)
            ...
            scf.if %40 {
              linalg.fill ins(%cst : f16) outs(%39 : memref<32x32xf16>)
              %41 = arith.addi %arg3, %c4 : index
              loom.reduce_sum ins(%37) outs(%39) region : (UL : [%arg3, %arg4], LR : [%41, %arg4]) : memref<32x32xf16>
              loom.semaphore_give %37 : memref<32x32xf16>
              %42 = arith.muli %21, %c8192 : index
              %43 = arith.addi %42, %31 : index
              %reinterpret_cast_1 = memref.reinterpret_cast %arg0 to offset: [%43], sizes: [32, 32], strides: [256, 1] : memref<256x256xf16> to memref<32x32xf16, strided<[256, 1], offset: ?>>
              loom.copy %39, %reinterpret_cast_1 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%30, %arg4], LR : [%30, %arg4]) : memref<32x32xf16> to memref<32x32xf16, strided<[256, 1], offset: ?>>
              loom.semaphore_give %39 : memref<32x32xf16>
            }
          } {loom.block_sym = @tile_k, loom.iter_type = #loom.iter_type<temporal>}
        } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c4, %c8, %c2) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c2 step %c1 {
          scf.for %arg7 = %c0 to %c4 step %c1 {
            ...
            %29 = arith.muli %arg3, %c2 : index
            %30 = arith.addi %arg5, %29 : index
            loom.copy %reinterpret_cast, %26 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 8] region : (UL : [%30, %c0], LR : [%30, %c7]) : memref<32x512xf16, strided<[4096, 1], offset: ?>> to memref<32x512xf16>
            %31 = arith.muli %arg4, %c32 : index
            %32 = loom.alloc [512, 32] on @L1 : memref<512x32xf16>
            %33 = loom.semaphore_take %32 : memref<512x32xf16> -> memref<512x32xf16>
            %34 = arith.muli %23, %c131072 : index

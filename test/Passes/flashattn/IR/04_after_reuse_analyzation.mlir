          ...
          affine.parallel (%arg6) = (0) to (1) {
            ...
            scf.for %arg7 = %c0 to %25 step %c1 {
              ...
              scf.for %arg8 = %c0 to %26 step %c1 {
                ...
                %87 = loom.subview %arg3[%29, %30, 0] [%20, %21, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<32x4096x128xf16> to memref<?x?x128xf16, strided<[524288, 128, 1], offset: ?>>
            ...
            scf.for %arg7 = %c0 to %23 step %c1 {
              ...
              scf.for %arg8 = %c0 to %25 step %c1 {
                ...
                %81:3 = scf.for %arg9 = %c0 to %40 step %c1 iter_args(%arg10 = %52, %arg11 = %48, %arg12 = %44) -> (tensor<?x?x1xf16>, tensor<?x?x1xf16>, tensor<?x?x128xf16>) {
                  ...
                  %88 = loom.subview %arg0[%27, 0, %87] [%20, 128, %22] [1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<32x128x4096xf16> to memref<?x128x?xf16, strided<[524288, 4096, 1], offset: ?>>
                  ...
                  %102 = loom.subview %arg1[%27, %87, 0] [%20, %22, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<32x4096x128xf16> to memref<?x?x128xf16, strided<[524288, 128, 1], offset: ?>>
                ...
                loom.semaphore_give %32 : memref<?x?x128xf16>
                %85 = loom.subview %arg3[%27, %28, 0] [%20, %21, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<32x4096x128xf16> to memref<?x?x128xf16, strided<[524288, 128, 1], offset: ?>>

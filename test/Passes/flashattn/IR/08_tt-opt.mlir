      ...
      scf.parallel (%arg4, %arg5) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg6 = %c0 to %c4 step %c1 {
          ...
          scf.for %arg7 = %c0 to %c64 step %c1 {
            ...
            loom.batch_matmul ins(%26, %45 : memref<1x1024x128xf16>, memref<1x128x64xf16>) outs(%48 : memref<1x1024x64xf16>)
            ...
            loom.batch_matmul ins(%48, %53 : memref<1x1024x64xf16>, memref<1x64x128xf16>) outs(%37 : memref<1x1024x128xf16>)
      ...
      scf.parallel (%arg4, %arg5, %arg6) = (%c0, %c0, %c0) to (%c4, %c8, %c2) step (%c1, %c1, %c1) {
        scf.for %arg7 = %c0 to %c8 step %c1 {
          ...
          scf.for %arg8 = %c0 to %c64 step %c1 {
            ...
            loom.batch_matmul ins(%28, %49 : memref<1x1024x128xf16>, memref<1x128x64xf16>) outs(%52 : memref<1x1024x64xf16>)
            ...
            loom.batch_matmul ins(%52, %57 : memref<1x1024x64xf16>, memref<1x64x128xf16>) outs(%41 : memref<1x1024x128xf16>)

    ...
    affine.for %arg7 = 0 to affine_map<(d0) -> ((d0 ceildiv 8) ceildiv 8)>(%arg4) {
      affine.parallel (%arg8) = (0) to (8) {
        affine.parallel (%arg9) = (0) to (8) {
          ...
          %alloc = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1"}} : memref<32x32xf16>
          ...
          %15:5 = scf.for %arg10 = %c0 to %c512 step %c32 iter_args(%arg11 = %c0_3, %arg12 = %c0_4, %arg13 = %12, %arg14 = %8, %arg15 = %11) -> (index, index, tensor<32xf32>, tensor<32xf32>, tensor<32x32xf32>) {
            ...
            %alloc_7 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1"}} : memref<32x32xf16>
            memref.copy %reinterpret_cast_6, %alloc_7 {tmd.copy.choice = {kind = "mem", memory_name = "L1"}} : memref<32x32xf16, strided<[512, 1], offset: ?>> to memref<32x32xf16>
            ...
            %alloc_12 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1"}} : memref<32x32xf16>
            memref.copy %reinterpret_cast_11, %alloc_12 {tmd.copy.choice = {kind = "mem", memory_name = "L1"}} : memref<32x32xf16, strided<[32, 1], offset: ?>> to memref<32x32xf16>
      ...
      affine.parallel (%arg8) = (0) to (8) {
        affine.parallel (%arg9) = (0) to (8) {
          ...
          %15:5 = scf.for %arg10 = %c0 to %c512 step %c32 iter_args(%arg11 = %c0_3, %arg12 = %c0_4, %arg13 = %12, %arg14 = %8, %arg15 = %11) -> (index, index, tensor<32xf32>, tensor<32xf32>, tensor<32x32xf32>) {
            ...
            %reinterpret_cast_6 = memref.reinterpret_cast %arg1 to offset: [%21], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {sequential = [{depth = 3 : i64, iterator = "%arg10", reuse_type = "total_reuse", volume = 2048 : i64}], spatial = [{depth = 1 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "total_reuse", volume = 2048 : i64}, {depth = 2 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "total_reuse", volume = 2048 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg7", reuse_type = "total_reuse", volume = 2048 : i64}]}} : memref<*xf16> to memref<32x32xf16, strided<[512, 1], offset: ?>>
            %alloc_7 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1"}} : memref<32x32xf16>
            memref.copy %reinterpret_cast_6, %alloc_7 {tmd.copy.choice = {dim = "x", interconnect_name = "horizontal_links", kind = "broadcast"}} : memref<32x32xf16, strided<[512, 1], offset: ?>> to memref<32x32xf16>
            %22 = bufferization.to_tensor %alloc_7 restrict writable : memref<32x32xf16> to tensor<32x32xf16>
            %23 = linalg.matmul ins(%14, %22 : tensor<32x32xf16>, tensor<32x32xf16>) outs(%11 : tensor<32x32xf32>) -> tensor<32x32xf32>
            %24 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%23, %10 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%23 : tensor<32x32xf32>) {
            ^bb0(%in: f32, %in_16: f32, %out: f32):
      ...
      affine.parallel (%arg8) = (0) to (8) {
        affine.parallel (%arg9) = (0) to (8) {
          ...
          %15:5 = scf.for %arg10 = %c0 to %c512 step %c32 iter_args(%arg11 = %c0_3, %arg12 = %c0_4, %arg13 = %12, %arg14 = %8, %arg15 = %11) -> (index, index, tensor<32xf32>, tensor<32xf32>, tensor<32x32xf32>) {
            ...
            %reinterpret_cast_6 = memref.reinterpret_cast %arg1 to offset: [%21], sizes: [32, 32], strides: [512, 1] {tmd.reuse = {sequential = [{depth = 3 : i64, iterator = "%arg10", reuse_type = "total_reuse", volume = 2048 : i64}], spatial = [{depth = 1 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "total_reuse", volume = 2048 : i64}, {depth = 2 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "total_reuse", volume = 2048 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg7", reuse_type = "total_reuse", volume = 2048 : i64}]}} : memref<*xf16> to memref<32x32xf16, strided<[512, 1], offset: ?>>
            %alloc_7 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1"}} : memref<32x32xf16>
            memref.copy %reinterpret_cast_6, %alloc_7 {tmd.copy.choice = {dim = "y", interconnect_name = "vertical_links", kind = "broadcast"}} : memref<32x32xf16, strided<[512, 1], offset: ?>> to memref<32x32xf16>
            %22 = bufferization.to_tensor %alloc_7 restrict writable : memref<32x32xf16> to tensor<32x32xf16>
            %23 = linalg.matmul ins(%14, %22 : tensor<32x32xf16>, tensor<32x32xf16>) outs(%11 : tensor<32x32xf32>) -> tensor<32x32xf32>
            %24 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%23, %10 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%23 : tensor<32x32xf32>) {
            ^bb0(%in: f32, %in_16: f32, %out: f32):
      ...
      affine.parallel (%arg8) = (0) to (8) {
        affine.parallel (%arg9) = (0) to (8) {
          ...
          %15:5 = scf.for %arg10 = %c0 to %c512 step %c32 iter_args(%arg11 = %c0_3, %arg12 = %c0_4, %arg13 = %12, %arg14 = %8, %arg15 = %11) -> (index, index, tensor<32xf32>, tensor<32xf32>, tensor<32x32xf32>) {
            ...
            %reinterpret_cast_11 = memref.reinterpret_cast %arg2 to offset: [%34], sizes: [32, 32], strides: [32, 1] {tmd.reuse = {sequential = [{depth = 3 : i64, iterator = "%arg10", reuse_type = "total_reuse", volume = 2048 : i64}], spatial = [{depth = 1 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "total_reuse", volume = 2048 : i64}, {depth = 2 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "total_reuse", volume = 2048 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg7", reuse_type = "total_reuse", volume = 2048 : i64}]}} : memref<*xf16> to memref<32x32xf16, strided<[32, 1], offset: ?>>
            %alloc_12 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1"}} : memref<32x32xf16>
            memref.copy %reinterpret_cast_11, %alloc_12 {tmd.copy.choice = {dim = "x", interconnect_name = "horizontal_links", kind = "broadcast"}} : memref<32x32xf16, strided<[32, 1], offset: ?>> to memref<32x32xf16>
            %35 = bufferization.to_tensor %alloc_12 restrict writable : memref<32x32xf16> to tensor<32x32xf16>
            %36 = tensor.empty() : tensor<32x32xf16>
            %37 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%28 : tensor<32x32xf32>) outs(%36 : tensor<32x32xf16>) {
            ^bb0(%in: f32, %out: f16):
      ...
      affine.parallel (%arg8) = (0) to (8) {
        affine.parallel (%arg9) = (0) to (8) {
          ...
          %15:5 = scf.for %arg10 = %c0 to %c512 step %c32 iter_args(%arg11 = %c0_3, %arg12 = %c0_4, %arg13 = %12, %arg14 = %8, %arg15 = %11) -> (index, index, tensor<32xf32>, tensor<32xf32>, tensor<32x32xf32>) {
            ...
            %reinterpret_cast_11 = memref.reinterpret_cast %arg2 to offset: [%34], sizes: [32, 32], strides: [32, 1] {tmd.reuse = {sequential = [{depth = 3 : i64, iterator = "%arg10", reuse_type = "total_reuse", volume = 2048 : i64}], spatial = [{depth = 1 : i64, iterator = "%arg8", mapped_to = "y", reuse_type = "total_reuse", volume = 2048 : i64}, {depth = 2 : i64, iterator = "%arg9", mapped_to = "x", reuse_type = "total_reuse", volume = 2048 : i64}], temporal = [{depth = 0 : i64, iterator = "%arg7", reuse_type = "total_reuse", volume = 2048 : i64}]}} : memref<*xf16> to memref<32x32xf16, strided<[32, 1], offset: ?>>
            %alloc_12 = memref.alloc() {tmd.alloc = {local = true, memory_name = "L1"}} : memref<32x32xf16>
            memref.copy %reinterpret_cast_11, %alloc_12 {tmd.copy.choice = {dim = "y", interconnect_name = "vertical_links", kind = "broadcast"}} : memref<32x32xf16, strided<[32, 1], offset: ?>> to memref<32x32xf16>
            %35 = bufferization.to_tensor %alloc_12 restrict writable : memref<32x32xf16> to tensor<32x32xf16>
            %36 = tensor.empty() : tensor<32x32xf16>
            %37 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%28 : tensor<32x32xf32>) outs(%36 : tensor<32x32xf16>) {
            ^bb0(%in: f32, %out: f16):

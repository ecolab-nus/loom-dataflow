  ...
  func.func @flashattn_fwd(%arg0: memref<*xf16> {tt.divisibility = 16 : i32}, %arg1: memref<*xf16> {tt.divisibility = 16 : i32}, %arg2: memref<*xf16> {tt.divisibility = 16 : i32}, %arg3: memref<*xf16> {tt.divisibility = 16 : i32}, %arg4: index, %arg5: index, %arg6: index) {
    affine.parallel (%arg7) = (0) to (%arg4) {
      ...
      %8:5 = scf.for %arg8 = %c0 to %c512 step %c32 iter_args(%arg9 = %c0_3, %arg10 = %c0_4, %arg11 = %5, %arg12 = %1, %arg13 = %4) -> (index, index, tensor<32xf32>, tensor<32xf32>, tensor<32x32xf32>) {
        ...
        %18 = linalg.generic {indexing_maps = [#map3, #map3, #map3], iterator_types = ["parallel"]} ins(%arg11, %reduced : tensor<32xf32>, tensor<32xf32>) outs(%arg11 : tensor<32xf32>) {
        ^bb0(%in: f32, %in_16: f32, %out: f32):
        ...
        %23 = linalg.generic {indexing_maps = [#map3, #map3, #map3], iterator_types = ["parallel"]} ins(%arg11, %18 : tensor<32xf32>, tensor<32xf32>) outs(%arg11 : tensor<32xf32>) {
        ^bb0(%in: f32, %in_16: f32, %out: f32):
          %37 = arith.subf %in, %in_16 : f32
          linalg.yield %37 : f32
        } -> tensor<32xf32>
        ...
        %25 = linalg.generic {indexing_maps = [#map3, #map3, #map3], iterator_types = ["parallel"]} ins(%arg12, %24 : tensor<32xf32>, tensor<32xf32>) outs(%arg12 : tensor<32xf32>) {
        ^bb0(%in: f32, %in_16: f32, %out: f32):
          %37 = arith.mulf %in, %in_16 : f32
          linalg.yield %37 : f32
        } -> tensor<32xf32>
        ...
        %32 = linalg.generic {indexing_maps = [#map2, #map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg13, %31 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%arg13 : tensor<32x32xf32>) {
        ^bb0(%in: f32, %in_16: f32, %out: f32):
          %37 = arith.mulf %in, %in_16 : f32
          linalg.yield %37 : f32
        } -> tensor<32x32xf32>

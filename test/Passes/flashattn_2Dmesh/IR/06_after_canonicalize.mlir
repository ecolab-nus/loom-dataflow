  ...
  module attributes {loom.pass_name = "Materialize"} {
    func.func @attention__BB64__BM64__BN64(%arg0: memref<2x4096x4096xf32>, %arg1: memref<2x4096x4096xf32>, %arg2: memref<2x4096x4096xf32>, %arg3: memref<2x4096x4096xf32>) {
      ...
      affine.parallel (%arg4, %arg5) = (0, 0) to (1, 64) {
        ...
        %20 = linalg.fill ins(%cst_3 : f32) outs(%15 : tensor<64x64xf32>) -> tensor<64x64xf32>
        %21 = linalg.fill ins(%cst_2 : f32) outs(%13 : tensor<64x64xf32>) -> tensor<64x64xf32>
        %22 = linalg.fill ins(%cst_1 : f32) outs(%8 : tensor<64x64x4096xf32>) -> tensor<64x64x4096xf32>
        ...
        %27:3 = affine.for %arg6 = 0 to 64 iter_args(%arg7 = %20, %arg8 = %21, %arg9 = %22) -> (tensor<64x64xf32>, tensor<64x64xf32>, tensor<64x64x4096xf32>) {
          ...
          %35 = linalg.fill ins(%cst_3 : f32) outs(%17 : tensor<64x64xf32>) -> tensor<64x64xf32>
          ...
          %37 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg7, %36 : tensor<64x64xf32>, tensor<64x64xf32>) outs(%15 : tensor<64x64xf32>) {
          ^bb0(%in: f32, %in_10: f32, %out: f32):
            %48 = arith.truncf %cst_0 : f64 to f32
            %49 = arith.mulf %in_10, %48 : f32
            %50 = arith.cmpf ogt, %in, %49 : f32
            %51 = arith.select %50, %in, %49 : f32
            linalg.yield %51 : f32
          } -> tensor<64x64xf32>
          ...
          ^bb0(%in: f32, %in_10: f32, %out: f32):
            %48 = arith.truncf %cst_0 : f64 to f32
            %49 = arith.mulf %in, %48 : f32
            %50 = arith.subf %49, %in_10 : f32
            %51 = math.powf %cst, %50 : f32
            linalg.yield %51 : f32
          } -> tensor<64x64x64xf32>
          %39 = linalg.fill ins(%cst_1 : f32) outs(%17 : tensor<64x64xf32>) -> tensor<64x64xf32>
          ...
          %41 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg7, %37 : tensor<64x64xf32>, tensor<64x64xf32>) outs(%19 : tensor<64x64xf32>) {
          ^bb0(%in: f32, %in_10: f32, %out: f32):
            %48 = arith.subf %in, %in_10 : f32
            %49 = math.powf %cst, %48 : f32
            linalg.yield %49 : f32
          } -> tensor<64x64xf32>
          %42 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg8, %41, %40 : tensor<64x64xf32>, tensor<64x64xf32>, tensor<64x64xf32>) outs(%13 : tensor<64x64xf32>) {
          ^bb0(%in: f32, %in_10: f32, %in_11: f32, %out: f32):
            %48 = arith.mulf %in, %in_10 : f32
            %49 = arith.addf %48, %in_11 : f32
            linalg.yield %49 : f32
          } -> tensor<64x64xf32>
          %c0_8 = arith.constant 0 : index
          %43 = affine.apply affine_map<(d0, d1, d2) -> (d0 * 16777216 + d1 * 4096 + d2)>(%23, %30, %c0_8)
          ...
          %45 = linalg.fill ins(%cst_1 : f32) outs(%10 : tensor<64x64x4096xf32>) -> tensor<64x64x4096xf32>
          ...
          %47 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%46, %arg9, %41 : tensor<64x64x4096xf32>, tensor<64x64x4096xf32>, tensor<64x64xf32>) outs(%8 : tensor<64x64x4096xf32>) {
          ^bb0(%in: f32, %in_10: f32, %in_11: f32, %out: f32):
            %48 = arith.mulf %in_10, %in_11 : f32
            %49 = arith.addf %in, %48 : f32
            linalg.yield %49 : f32
          } -> tensor<64x64x4096xf32>
          affine.yield %37, %42, %47 : tensor<64x64xf32>, tensor<64x64xf32>, tensor<64x64x4096xf32>
        }
    ...
    func.func @attention__BB32__BM32__BN256(%arg0: memref<2x4096x4096xf32>, %arg1: memref<2x4096x4096xf32>, %arg2: memref<2x4096x4096xf32>, %arg3: memref<2x4096x4096xf32>) {
      ...
      affine.parallel (%arg4, %arg5) = (0, 0) to (1, 128) {
        ...
        %20 = linalg.fill ins(%cst_3 : f32) outs(%15 : tensor<32x32xf32>) -> tensor<32x32xf32>
        %21 = linalg.fill ins(%cst_2 : f32) outs(%13 : tensor<32x32xf32>) -> tensor<32x32xf32>
        %22 = linalg.fill ins(%cst_1 : f32) outs(%8 : tensor<32x32x4096xf32>) -> tensor<32x32x4096xf32>
        ...
        %27:3 = affine.for %arg6 = 0 to 16 iter_args(%arg7 = %20, %arg8 = %21, %arg9 = %22) -> (tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32x4096xf32>) {
          ...
          %35 = linalg.fill ins(%cst_3 : f32) outs(%17 : tensor<32x32xf32>) -> tensor<32x32xf32>
          ...
          %37 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg7, %36 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%15 : tensor<32x32xf32>) {
          ^bb0(%in: f32, %in_10: f32, %out: f32):
            %48 = arith.truncf %cst_0 : f64 to f32
            %49 = arith.mulf %in_10, %48 : f32
            %50 = arith.cmpf ogt, %in, %49 : f32
          ...
          %39 = linalg.fill ins(%cst_1 : f32) outs(%17 : tensor<32x32xf32>) -> tensor<32x32xf32>
          ...
          %41 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg7, %37 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%19 : tensor<32x32xf32>) {
          ^bb0(%in: f32, %in_10: f32, %out: f32):
            %48 = arith.subf %in, %in_10 : f32
            %49 = math.powf %cst, %48 : f32
            linalg.yield %49 : f32
          } -> tensor<32x32xf32>
          %42 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg8, %41, %40 : tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>) outs(%13 : tensor<32x32xf32>) {
          ^bb0(%in: f32, %in_10: f32, %in_11: f32, %out: f32):
            %48 = arith.mulf %in, %in_10 : f32
            %49 = arith.addf %48, %in_11 : f32
            linalg.yield %49 : f32
          ...
          %45 = linalg.fill ins(%cst_1 : f32) outs(%10 : tensor<32x32x4096xf32>) -> tensor<32x32x4096xf32>
          ...
          %47 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%46, %arg9, %41 : tensor<32x32x4096xf32>, tensor<32x32x4096xf32>, tensor<32x32xf32>) outs(%8 : tensor<32x32x4096xf32>) {
          ^bb0(%in: f32, %in_10: f32, %in_11: f32, %out: f32):
            %48 = arith.mulf %in_10, %in_11 : f32
            %49 = arith.addf %in, %48 : f32
            linalg.yield %49 : f32
          } -> tensor<32x32x4096xf32>
          affine.yield %37, %42, %47 : tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32x4096xf32>
        }

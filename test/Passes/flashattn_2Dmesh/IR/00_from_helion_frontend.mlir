  ...
  module {
    ...
    func.func @attention(%arg0: memref<2x4096x4096xf32>, %arg1: memref<2x4096x4096xf32>, %arg2: memref<2x4096x4096xf32>, %arg3: memref<2x4096x4096xf32>) {
      ...
      affine.parallel (%arg4, %arg5) = (0, 0) to (2 ceildiv symbol(%0), 4096 ceildiv symbol(%1)) {
        ...
        %7 = linalg.fill ins(%cst_1 : f32) outs(%6 : tensor<?x?x4096xf32>) -> tensor<?x?x4096xf32>
        ...
        %11:3 = affine.for %arg6 = 0 to #map()[%2] iter_args(%arg7 = %4, %arg8 = %5, %arg9 = %7) -> (tensor<?x?xf32>, tensor<?x?xf32>, tensor<?x?x4096xf32>) {
          ...
          %20 = linalg.batch_matmul ins(%10, %15 : tensor<?x?x4096xf32>, tensor<?x4096x?xf32>) outs(%19 : tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
          ...
          %subview_10 = memref.subview %arg1[%8, %14, 0] [%0, %2, 4096] [1, 1, 1] : memref<2x4096x4096xf32> to memref<?x?x4096xf32, strided<[16777216, 4096, 1], offset: ?>>

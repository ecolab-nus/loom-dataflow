      ...
      scf.parallel (%arg4, %arg5) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg6 = %c0 to %c64 step %c1 {
          ...
          scf.for %arg7 = %c0 to %c32 step %c1 {
            ...
            loom.batch_matmul ins(%32, %19 : memref<1x64x128xf16>, memref<1x128x128xf16>) outs(%17 : memref<1x64x128xf16>)
            ...
            loom.batch_matmul ins(%17, %15 : memref<1x64x128xf16>, memref<1x128x128xf16>) outs(%36 : memref<1x64x128xf16>)

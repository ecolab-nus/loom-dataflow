      ...
      scf.parallel (%arg4, %arg5) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg6 = %c0 to %c2 step %c1 {
          scf.for %arg7 = %c0 to %c2 step %c1 {
            ...
            %52 = arith.muli %19, %c1048576 overflow<nsw> : index
            ...
            loom.copy %reinterpret_cast_3, %43 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg5, %arg4], LR : [%arg5, %arg4]) : memref<1x128x512xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<1x128x512xf16>
            loom.batch_matmul ins(%23, %43 : memref<1x32x128xf16>, memref<1x128x512xf16>) outs(%45 : memref<1x32x512xf16>)
            ...
            loom.copy %reinterpret_cast_4, %51 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg5, %arg4], LR : [%arg5, %arg4]) : memref<1x512x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<1x512x128xf16>
            loom.batch_matmul ins(%45, %51 : memref<1x32x512xf16>, memref<1x512x128xf16>) outs(%35 : memref<1x32x128xf16>)
    ...
    func.func @flash_decode__x8_y2y4__d0i1_d1i1_d2i0__f01__dim_x_level0_bc8_dim_y_level0_bc2_n_n_n__tile_b1__tile_n512__tile_s512(%arg0: memref<16x128x8192xf16>, %arg1: memref<16x8192x128xf16>, %arg2: memref<16x32x128xf16>, %arg3: memref<16x32x128xf16>) {
      ...
      scf.parallel (%arg4, %arg5, %arg6) = (%c0, %c0, %c0) to (%c4, %c8, %c2) step (%c1, %c1, %c1) {
        scf.for %arg7 = %c0 to %c4 step %c1 {
          ...
          %54 = arith.muli %19, %c1048576 overflow<nsw> : index
          ...
          %56 = arith.addi %arg6, %25 : index
          loom.copy %reinterpret_cast_3, %45 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg5, %56], LR : [%arg5, %56]) : memref<1x128x512xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<1x128x512xf16>
          loom.batch_matmul ins(%23, %45 : memref<1x32x128xf16>, memref<1x128x512xf16>) outs(%47 : memref<1x32x512xf16>)
          ...
          %57 = loom.broadcast ins(%39 : memref<1x32x1xf16>) outs(%51 : memref<1x32x32xf16>) dim(2) -> memref<1x32x512xf16, strided<[?, ?, ?], offset: ?>>
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%47, %57 : memref<1x32x512xf16>, memref<1x32x512xf16, strided<[?, ?, ?], offset: ?>>) outs(%47 : memref<1x32x512xf16>) {
          ^bb0(%in: f16, %in_5: f16, %out: f16):
          ...
          loom.semaphore_give %41 : memref<1x32x1xf16>
          %58 = loom.broadcast ins(%43 : memref<1x32x1xf16>) outs(%50 : memref<1x32x32xf16>) dim(2) -> memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>
          loom.semaphore_give %43 : memref<1x32x1xf16>
          %59 = arith.muli %21, %c65536 : index
          %60 = arith.addi %54, %59 : index
          ...
          loom.copy %reinterpret_cast_4, %53 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg5, %56], LR : [%arg5, %56]) : memref<1x512x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<1x512x128xf16>
          loom.batch_matmul ins(%47, %53 : memref<1x32x512xf16>, memref<1x512x128xf16>) outs(%37 : memref<1x32x128xf16>)
          loom.semaphore_give %53 : memref<1x512x128xf16>
          loom.semaphore_give %47 : memref<1x32x512xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%37, %29, %58 : memref<1x32x128xf16>, memref<1x32x128xf16>, memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>) outs(%29 : memref<1x32x128xf16>) {
          ^bb0(%in: f16, %in_5: f16, %in_6: f16, %out: f16):
          ...
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%33, %35 : memref<1x32x1xf16>, memref<1x32x1xf16>) outs(%62 : memref<1x32x1xf16>) {
          ^bb0(%in: f16, %in_5: f16, %out: f16):
            %79 = math.log %in : f16
          ...
          %63 = loom.broadcast ins(%33 : memref<1x32x1xf16>) outs(%49 : memref<1x32x32xf16>) dim(2) -> memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>
          loom.semaphore_give %33 : memref<1x32x1xf16>
          %64 = loom.alloc [1, 32, 128] on @L1 : memref<1x32x128xf16>
          %65 = loom.semaphore_take %64 : memref<1x32x128xf16> -> memref<1x32x128xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%29, %63 : memref<1x32x128xf16>, memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>) outs(%65 : memref<1x32x128xf16>) {
          ^bb0(%in: f16, %in_5: f16, %out: f16):
    ...
    func.func @flash_decode__x8_y8y1__d0i1_d1i1_d2i0__f01__dim_x_level0_bc8_dim_y_level1_bc8_n_n_n__tile_b1__tile_n512__tile_s512(%arg0: memref<16x128x8192xf16>, %arg1: memref<16x8192x128xf16>, %arg2: memref<16x32x128xf16>, %arg3: memref<16x32x128xf16>) {
      ...
      scf.parallel (%arg4, %arg5) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg6 = %c0 to %c16 step %c1 {
          ...
          %42 = loom.alloc [1, 32, 512] on @L1 : memref<1x32x512xf16>
          %43 = loom.semaphore_take %42 : memref<1x32x512xf16> -> memref<1x32x512xf16>
          %44 = loom.alloc [1, 32, 32] on @L1 : memref<1x32x32xf16>
          %45 = loom.semaphore_take %44 : memref<1x32x32xf16> -> memref<1x32x32xf16>
          %46 = loom.semaphore_take %44 : memref<1x32x32xf16> -> memref<1x32x32xf16>
          %47 = loom.semaphore_take %44 : memref<1x32x32xf16> -> memref<1x32x32xf16>
          %48 = loom.alloc [1, 512, 128] on @L1 : memref<1x512x128xf16>
          %49 = loom.semaphore_take %48 : memref<1x512x128xf16> -> memref<1x512x128xf16>
          %50 = arith.muli %arg6, %c1048576 overflow<nsw> : index
          %51 = arith.addi %50, %23 : index
          %reinterpret_cast_3 = memref.reinterpret_cast %arg0 to offset: [%51], sizes: [1, 128, 512], strides: [1048576, 8192, 1] : memref<16x128x8192xf16> to memref<1x128x512xf16, strided<[1048576, 8192, 1], offset: ?>>
          loom.copy %reinterpret_cast_3, %41 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg4, %arg5], LR : [%arg4, %arg5]) : memref<1x128x512xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<1x128x512xf16>
          loom.batch_matmul ins(%21, %41 : memref<1x32x128xf16>, memref<1x128x512xf16>) outs(%43 : memref<1x32x512xf16>)
          loom.semaphore_give %41 : memref<1x128x512xf16>
          linalg.fill ins(%cst_1 : f16) outs(%35 : memref<1x32x1xf16>)
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, 0)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%43 : memref<1x32x512xf16>) outs(%35 : memref<1x32x1xf16>) {
          ^bb0(%in: f16, %out: f16):
            %74 = arith.maximumf %in, %out : f16
            linalg.yield %74 : f16
          }
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%31, %35 : memref<1x32x1xf16>, memref<1x32x1xf16>) outs(%35 : memref<1x32x1xf16>) {
          ^bb0(%in: f16, %in_5: f16, %out: f16):
          ...
          %52 = loom.broadcast ins(%35 : memref<1x32x1xf16>) outs(%47 : memref<1x32x32xf16>) dim(2) -> memref<1x32x512xf16, strided<[?, ?, ?], offset: ?>>
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%43, %52 : memref<1x32x512xf16>, memref<1x32x512xf16, strided<[?, ?, ?], offset: ?>>) outs(%43 : memref<1x32x512xf16>) {
          ^bb0(%in: f16, %in_5: f16, %out: f16):
          ...
          loom.semaphore_give %47 : memref<1x32x32xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, 0)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%43 : memref<1x32x512xf16>) outs(%37 : memref<1x32x1xf16>) {
          ^bb0(%in: f16, %out: f16):
            %74 = arith.addf %in, %out : f16
            linalg.yield %74 : f16
          }
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%31, %35 : memref<1x32x1xf16>, memref<1x32x1xf16>) outs(%39 : memref<1x32x1xf16>) {
          ^bb0(%in: f16, %in_5: f16, %out: f16):
            %74 = arith.subf %in, %in_5 : f16
            %75 = math.exp %74 : f16
            linalg.yield %75 : f16
          }
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%29, %39, %37 : memref<1x32x1xf16>, memref<1x32x1xf16>, memref<1x32x1xf16>) outs(%29 : memref<1x32x1xf16>) {
          ^bb0(%in: f16, %in_5: f16, %in_6: f16, %out: f16):
          ...
          loom.semaphore_give %37 : memref<1x32x1xf16>
          %53 = loom.broadcast ins(%39 : memref<1x32x1xf16>) outs(%46 : memref<1x32x32xf16>) dim(2) -> memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>
          loom.semaphore_give %39 : memref<1x32x1xf16>
          %54 = arith.muli %19, %c65536 : index
          %55 = arith.addi %50, %54 : index
          %reinterpret_cast_4 = memref.reinterpret_cast %arg1 to offset: [%55], sizes: [1, 512, 128], strides: [1048576, 128, 1] : memref<16x8192x128xf16> to memref<1x512x128xf16, strided<[1048576, 128, 1], offset: ?>>
          loom.copy %reinterpret_cast_4, %49 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg4, %arg5], LR : [%arg4, %arg5]) : memref<1x512x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<1x512x128xf16>
          loom.batch_matmul ins(%43, %49 : memref<1x32x512xf16>, memref<1x512x128xf16>) outs(%33 : memref<1x32x128xf16>)
          loom.semaphore_give %49 : memref<1x512x128xf16>
          loom.semaphore_give %43 : memref<1x32x512xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%33, %25, %53 : memref<1x32x128xf16>, memref<1x32x128xf16>, memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>) outs(%25 : memref<1x32x128xf16>) {
          ^bb0(%in: f16, %in_5: f16, %in_6: f16, %out: f16):
            %74 = arith.mulf %in_5, %in_6 : f16
            %75 = arith.addf %in, %74 : f16
            linalg.yield %75 : f16
          }
          loom.semaphore_give %46 : memref<1x32x32xf16>
          loom.semaphore_give %33 : memref<1x32x128xf16>
          linalg.copy ins(%35 : memref<1x32x1xf16>) outs(%31 : memref<1x32x1xf16>)
          loom.semaphore_give %35 : memref<1x32x1xf16>
          ...
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%29, %31 : memref<1x32x1xf16>, memref<1x32x1xf16>) outs(%57 : memref<1x32x1xf16>) {
          ^bb0(%in: f16, %in_5: f16, %out: f16):
            %74 = math.log %in : f16
          ...
          loom.semaphore_give %31 : memref<1x32x1xf16>
          %58 = loom.broadcast ins(%29 : memref<1x32x1xf16>) outs(%45 : memref<1x32x32xf16>) dim(2) -> memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>
          loom.semaphore_give %29 : memref<1x32x1xf16>
          %59 = loom.alloc [1, 32, 128] on @L1 : memref<1x32x128xf16>
          %60 = loom.semaphore_take %59 : memref<1x32x128xf16> -> memref<1x32x128xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%25, %58 : memref<1x32x128xf16>, memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>) outs(%60 : memref<1x32x128xf16>) {
          ^bb0(%in: f16, %in_5: f16, %out: f16):
            %74 = arith.divf %in, %in_5 : f16
            linalg.yield %74 : f16
          }
          loom.semaphore_give %45 : memref<1x32x32xf16>
      ...
      scf.parallel (%arg4, %arg5) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg6 = %c0 to %c2 step %c1 {
          scf.for %arg7 = %c0 to %c2 step %c1 {
            ...
            %53 = arith.addi %52, %25 : index
            %reinterpret_cast_3 = memref.reinterpret_cast %arg0 to offset: [%53], sizes: [1, 128, 512], strides: [1048576, 8192, 1] : memref<16x128x8192xf16> to memref<1x128x512xf16, strided<[1048576, 8192, 1], offset: ?>>
            loom.copy %reinterpret_cast_3, %43 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg4, %arg5], LR : [%arg4, %arg5]) : memref<1x128x512xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<1x128x512xf16>
            loom.batch_matmul ins(%23, %43 : memref<1x32x128xf16>, memref<1x128x512xf16>) outs(%45 : memref<1x32x512xf16>)
            loom.semaphore_give %43 : memref<1x128x512xf16>
            linalg.fill ins(%cst_1 : f16) outs(%37 : memref<1x32x1xf16>)
            linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, 0)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%45 : memref<1x32x512xf16>) outs(%37 : memref<1x32x1xf16>) {
            ...
            %57 = arith.addi %52, %56 : index
            %reinterpret_cast_4 = memref.reinterpret_cast %arg1 to offset: [%57], sizes: [1, 512, 128], strides: [1048576, 128, 1] : memref<16x8192x128xf16> to memref<1x512x128xf16, strided<[1048576, 128, 1], offset: ?>>
            loom.copy %reinterpret_cast_4, %51 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg4, %arg5], LR : [%arg4, %arg5]) : memref<1x512x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<1x512x128xf16>
            loom.batch_matmul ins(%45, %51 : memref<1x32x512xf16>, memref<1x512x128xf16>) outs(%35 : memref<1x32x128xf16>)
            loom.semaphore_give %51 : memref<1x512x128xf16>
            loom.semaphore_give %45 : memref<1x32x512xf16>
            linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%35, %27, %55 : memref<1x32x128xf16>, memref<1x32x128xf16>, memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>) outs(%27 : memref<1x32x128xf16>) {
    ...
    func.func @flash_decode__x2x4_y8__d0i1_d1i1_d2i0__f01__dim_x_level0_bc2_dim_y_level0_bc8_n_n_n__tile_b1__tile_n512__tile_s512(%arg0: memref<16x128x8192xf16>, %arg1: memref<16x8192x128xf16>, %arg2: memref<16x32x128xf16>, %arg3: memref<16x32x128xf16>) {
      ...
      scf.parallel (%arg4, %arg5, %arg6) = (%c0, %c0, %c0) to (%c4, %c2, %c8) step (%c1, %c1, %c1) {
        scf.for %arg7 = %c0 to %c4 step %c1 {
          ...
          %55 = arith.addi %54, %27 : index
          %reinterpret_cast_3 = memref.reinterpret_cast %arg0 to offset: [%55], sizes: [1, 128, 512], strides: [1048576, 8192, 1] : memref<16x128x8192xf16> to memref<1x128x512xf16, strided<[1048576, 8192, 1], offset: ?>>
          %56 = arith.addi %arg5, %25 : index
          loom.copy %reinterpret_cast_3, %45 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%56, %arg6], LR : [%56, %arg6]) : memref<1x128x512xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<1x128x512xf16>
          loom.batch_matmul ins(%23, %45 : memref<1x32x128xf16>, memref<1x128x512xf16>) outs(%47 : memref<1x32x512xf16>)
          loom.semaphore_give %45 : memref<1x128x512xf16>
          linalg.fill ins(%cst_1 : f16) outs(%39 : memref<1x32x1xf16>)
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, 0)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%47 : memref<1x32x512xf16>) outs(%39 : memref<1x32x1xf16>) {
          ...
          %60 = arith.addi %54, %59 : index
          %reinterpret_cast_4 = memref.reinterpret_cast %arg1 to offset: [%60], sizes: [1, 512, 128], strides: [1048576, 128, 1] : memref<16x8192x128xf16> to memref<1x512x128xf16, strided<[1048576, 128, 1], offset: ?>>
          loom.copy %reinterpret_cast_4, %53 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%56, %arg6], LR : [%56, %arg6]) : memref<1x512x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<1x512x128xf16>
          loom.batch_matmul ins(%47, %53 : memref<1x32x512xf16>, memref<1x512x128xf16>) outs(%37 : memref<1x32x128xf16>)
          loom.semaphore_give %53 : memref<1x512x128xf16>
          loom.semaphore_give %47 : memref<1x32x512xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%37, %29, %58 : memref<1x32x128xf16>, memref<1x32x128xf16>, memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>) outs(%29 : memref<1x32x128xf16>) {

    ...
    func.func @flash_decode__x8_y8__d0i1_d1i0__f01__dim_x_level0_bc8_n_n_n__tile_b1__tile_n64__tile_s1024(%arg0: memref<16x128x8192xf16>, %arg1: memref<16x8192x128xf16>, %arg2: memref<16x32x128xf16>, %arg3: memref<16x32x128xf16>) {
      ...
      scf.parallel (%arg4, %arg5) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg6 = %c0 to %c2 step %c1 {
          ...
          %cast = memref.cast %33 : memref<1x32x1xf16> to memref<?x32x1xf16>
          ...
          scf.for %arg7 = %c0 to %c16 step %c1 {
            ...
            linalg.fill ins(%cst : f16) outs(%48 : memref<1x32x64xf16>)
            linalg.batch_matmul ins(%25, %46 : memref<1x32x128xf16>, memref<1x128x64xf16>) outs(%48 : memref<1x32x64xf16>)
            ...
            %alloc = memref.alloc() {alignment = 64 : i64} : memref<1x32x1xf16>
            memref.copy %33, %alloc : memref<1x32x1xf16> to memref<1x32x1xf16>
            linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%alloc, %44, %42 : memref<1x32x1xf16>, memref<1x32x1xf16>, memref<1x32x1xf16>) outs(%33 : memref<1x32x1xf16>) {
            ...
            linalg.batch_matmul ins(%48, %54 : memref<1x32x64xf16>, memref<1x64x128xf16>) outs(%38 : memref<1x32x128xf16>)
          ...
          %55 = loom.broadcast ins(%cast : memref<?x32x1xf16>) outs(%50 : memref<1x32x32xf16>) dim(2) -> memref<1x32x128xf16, strided<[?, ?, ?], offset: ?>>
          ...
          %62 = loom.alloc [1024, 1, 32, 32] on @L1 : memref<1024x1x32x32xf16>
          %63 = loom.semaphore_take %62 : memref<1024x1x32x32xf16> -> memref<1024x1x32x32xf16>
          ...
          scf.if %64 {
            ...
            %66 = loom.broadcast ins(%57 : memref<8x1x32x1xf16>) outs(%63 : memref<1024x1x32x32xf16>) dim(3) -> memref<8x1x32x128xf16, strided<[?, ?, ?, ?], offset: ?>>
            ...
            loom.semaphore_give %63 : memref<1024x1x32x32xf16>

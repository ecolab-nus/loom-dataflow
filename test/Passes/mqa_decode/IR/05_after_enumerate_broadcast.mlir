          ...
          affine.parallel (%arg6) = (0) to (1) {
            ...
            scf.for %arg7 = %c0 to %25 step %c1 {
              ...
              scf.for %arg8 = %c0 to %26 step %c1 {
                ...
                %39 = loom.init_tensor %38[%20, 32, 128] : memref<?x32x128xf16> -> tensor<?x32x128xf16>
                %40 = linalg.fill ins(%cst : f16) outs(%39 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
                %41 = loom.alloc [%20, 32, 1] on @L1 : memref<?x32x1xf16>
                ...
                %49 = loom.alloc [%20, 32, 1] on @L1 : memref<?x32x1xf16>
                %50 = loom.semaphore_take %49 : memref<?x32x1xf16> -> memref<?x32x1xf16>
                %51 = loom.init_tensor %50[%20, 32, 1] : memref<?x32x1xf16> -> tensor<?x32x1xf16>
                %52 = linalg.fill ins(%cst_1 : f16) outs(%51 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                %53 = loom.alloc [%20, 32, 128] on @L1 : memref<?x32x128xf16>
                %54 = loom.semaphore_take %53 : memref<?x32x128xf16> -> memref<?x32x128xf16>
                %55 = loom.init_tensor %54[%20, 32, 128] : memref<?x32x128xf16> -> tensor<?x32x128xf16>
                ...
                %67 = loom.alloc [%20, 32, %22] on @L1 : memref<?x32x?xf16>
                %68 = loom.semaphore_take %67 : memref<?x32x?xf16> -> memref<?x32x?xf16>
                %69 = loom.init_tensor %68[%20, 32, %22] : memref<?x32x?xf16> -> tensor<?x32x?xf16>
                %70 = loom.alloc [%20, 32, 32] on @L1 : memref<?x32x32xf16>
                %71 = loom.semaphore_take %70 : memref<?x32x32xf16> -> memref<?x32x32xf16>
                %72 = loom.init_tensor %71[%20, 32, 32] : memref<?x32x32xf16> -> tensor<?x32x32xf16>
                %73 = loom.semaphore_take %70 : memref<?x32x32xf16> -> memref<?x32x32xf16>
                %74 = loom.init_tensor %73[%20, 32, 32] : memref<?x32x32xf16> -> tensor<?x32x32xf16>
                %75 = loom.semaphore_take %70 : memref<?x32x32xf16> -> memref<?x32x32xf16>
                ...
                %79:3 = scf.for %arg9 = %c0 to %36 step %c1 iter_args(%arg10 = %52, %arg11 = %48, %arg12 = %40) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  loom.copy %113, %66 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%arg5, %33], LR : [%arg5, %33]) : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  %114 = loom.bufferize_to_tensor %66[%20, 128, %22] : memref<?x128x?xf16> -> tensor<?x128x?xf16>
                  %115 = linalg.fill ins(%cst : f16) outs(%69 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  ...
                  %117 = linalg.fill ins(%cst_1 : f16) outs(%58 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %119 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %118 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%58 : tensor<?x32x1xf16>) {
                  ...
                  %120 = loom.broadcast ins(%119 : tensor<?x32x1xf16>) outs(%76 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x?xf16>
                  %121 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%116, %120 : tensor<?x32x?xf16>, tensor<?x32x?xf16>) outs(%69 : tensor<?x32x?xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %122 = linalg.fill ins(%cst : f16) outs(%61 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %124 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %119 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%64 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %126 = loom.broadcast ins(%124 : tensor<?x32x1xf16>) outs(%74 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x128xf16>
                  ...
                  loom.copy %127, %78 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%arg5, %33], LR : [%arg5, %33]) : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
                  %128 = loom.bufferize_to_tensor %78[%20, %22, 128] : memref<?x?x128xf16> -> tensor<?x?x128xf16>
                  %129 = linalg.fill ins(%cst : f16) outs(%55 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
                ...
                %80 = loom.alloc [%20, 32, 1] on @L1 : memref<?x32x1xf16>
                %81 = loom.semaphore_take %80 : memref<?x32x1xf16> -> memref<?x32x1xf16>
                %82 = loom.init_tensor %81[%20, 32, 1] : memref<?x32x1xf16> -> tensor<?x32x1xf16>
                ...
                %84 = loom.broadcast ins(%79#1 : tensor<?x32x1xf16>) outs(%72 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x128xf16>
                loom.semaphore_give %46 : memref<?x32x1xf16>
                %85 = loom.alloc [%20, 32, 128] on @L1 : memref<?x32x128xf16>
                %86 = loom.semaphore_take %85 : memref<?x32x128xf16> -> memref<?x32x128xf16>
                %87 = loom.init_tensor %86[%20, 32, 128] : memref<?x32x128xf16> -> tensor<?x32x128xf16>
                ...
                %89 = loom.alloc [%24, %20, 32, 1] on @L1 : memref<?x?x32x1xf16>
                %90 = loom.semaphore_take %89 : memref<?x?x32x1xf16> -> memref<?x?x32x1xf16>
                %91 = loom.init_tensor %90[%24, %20, 32, 1] : memref<?x?x32x1xf16> -> tensor<?x?x32x1xf16>
                %92 = arith.addi %arg6, %arg4 : index
                %93 = loom.gather ins(%83 : tensor<?x32x1xf16>) outs(%91 : tensor<?x?x32x1xf16>) across(%arg5 : index) region : (UL : [%c0, %92], LR : [%c7, %92]) -> tensor<?x?x32x1xf16>
                ...
                %97 = loom.gather ins(%88 : tensor<?x32x128xf16>) outs(%96 : tensor<?x?x32x128xf16>) across(%arg5 : index) region : (UL : [%c0, %92], LR : [%c7, %92]) -> tensor<?x?x32x128xf16>
                ...
                scf.if %110 {
                  %111 = linalg.fill ins(%cst_1 : f16) outs(%45 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %114 = linalg.fill ins(%cst : f16) outs(%43 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  loom.copy %122, %121 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %33], LR : [%arg5, %33]) : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
          ...
          affine.parallel (%arg6) = (0) to (2) {
            ...
            scf.for %arg7 = %c0 to %25 step %c1 {
              ...
              scf.for %arg8 = %c0 to %26 step %c1 {
                ...
                %80:3 = scf.for %arg9 = %c0 to %37 step %c1 iter_args(%arg10 = %53, %arg11 = %49, %arg12 = %41) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  %115 = arith.addi %arg6, %33 : index
                  loom.copy %114, %67 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%arg5, %115], LR : [%arg5, %115]) : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  %116 = loom.bufferize_to_tensor %67[%20, 128, %22] : memref<?x128x?xf16> -> tensor<?x128x?xf16>
                  %117 = linalg.fill ins(%cst : f16) outs(%70 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  ...
                  loom.semaphore_give %31 : memref<?x32x128xf16>
                  %119 = linalg.fill ins(%cst_1 : f16) outs(%59 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %121 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %120 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%59 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %122 = loom.broadcast ins(%121 : tensor<?x32x1xf16>) outs(%77 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x?xf16>
                  %123 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%118, %122 : tensor<?x32x?xf16>, tensor<?x32x?xf16>) outs(%70 : tensor<?x32x?xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %124 = linalg.fill ins(%cst : f16) outs(%62 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %126 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %121 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%65 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %128 = loom.broadcast ins(%126 : tensor<?x32x1xf16>) outs(%75 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x128xf16>
                  ...
                  loom.copy %129, %79 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%arg5, %115], LR : [%arg5, %115]) : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
                  %130 = loom.bufferize_to_tensor %79[%20, %22, 128] : memref<?x?x128xf16> -> tensor<?x?x128xf16>
                  %131 = linalg.fill ins(%cst : f16) outs(%56 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
                ...
                scf.if %111 {
                  ...
                  loom.copy %123, %122 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %93], LR : [%arg5, %93]) : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
            ...
            scf.for %arg7 = %c0 to %23 step %c1 {
              ...
              scf.for %arg8 = %c0 to %25 step %c1 {
                ...
                %76:3 = scf.for %arg9 = %c0 to %33 step %c1 iter_args(%arg10 = %49, %arg11 = %45, %arg12 = %37) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  %111 = loom.subview %arg0[%27, 0, %110] [%20, 128, %22] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<16x128x8192xf16> to memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>>
                  %112 = arith.muli %arg4, %c8 : index
                  %113 = arith.addi %arg6, %112 : index
                  loom.copy %111, %63 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%arg5, %113], LR : [%arg5, %113]) : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  %114 = loom.bufferize_to_tensor %63[%20, 128, %22] : memref<?x128x?xf16> -> tensor<?x128x?xf16>
                  %115 = linalg.fill ins(%cst : f16) outs(%66 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  %116 = linalg.batch_matmul ins(%31, %114 : tensor<?x32x128xf16>, tensor<?x128x?xf16>) outs(%115 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  loom.semaphore_give %63 : memref<?x128x?xf16>
                  loom.semaphore_give %29 : memref<?x32x128xf16>
                  %117 = linalg.fill ins(%cst_1 : f16) outs(%55 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  %118 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, 0)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%116 : tensor<?x32x?xf16>) outs(%117 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %out: f16):
                    %133 = arith.maximumf %in, %out : f16
                    linalg.yield %133 : f16
                  } -> tensor<?x32x1xf16>
                  %119 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %118 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%55 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                    %133 = arith.mulf %in_3, %cst_2 : f16
                    %134 = arith.cmpf ogt, %in, %133 : f16
                    %135 = arith.select %134, %in, %133 : f16
                  ...
                  %120 = loom.broadcast ins(%119 : tensor<?x32x1xf16>) outs(%73 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x?xf16>
                  %121 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%116, %120 : tensor<?x32x?xf16>, tensor<?x32x?xf16>) outs(%66 : tensor<?x32x?xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                    %133 = arith.mulf %in, %cst_2 : f16
                    %134 = arith.subf %133, %in_3 : f16
                    %135 = math.exp %134 : f16
                  ...
                  loom.semaphore_give %72 : memref<?x32x32xf16>
                  %122 = linalg.fill ins(%cst : f16) outs(%58 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  %123 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, 0)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%121 : tensor<?x32x?xf16>) outs(%122 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %out: f16):
                    %133 = arith.addf %in, %out : f16
                    linalg.yield %133 : f16
                  } -> tensor<?x32x1xf16>
                  %124 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %119 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%61 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                    %133 = arith.subf %in, %in_3 : f16
                    %134 = math.exp %133 : f16
                    linalg.yield %134 : f16
                  ...
                  loom.semaphore_give %57 : memref<?x32x1xf16>
                  %126 = loom.broadcast ins(%124 : tensor<?x32x1xf16>) outs(%71 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x128xf16>
                  loom.semaphore_give %60 : memref<?x32x1xf16>
                  %127 = loom.subview %arg1[%27, %110, 0] [%20, %22, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<16x8192x128xf16> to memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>>
                  loom.copy %127, %75 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%arg5, %113], LR : [%arg5, %113]) : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
                  %128 = loom.bufferize_to_tensor %75[%20, %22, 128] : memref<?x?x128xf16> -> tensor<?x?x128xf16>
                  %129 = linalg.fill ins(%cst : f16) outs(%52 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
                  %130 = linalg.batch_matmul ins(%121, %128 : tensor<?x32x?xf16>, tensor<?x?x128xf16>) outs(%129 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
                ...
                scf.if %108 {
                  ...
                  %119 = loom.subview %arg2[%27, 0, 0] [%20, 32, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<16x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
                  %120 = loom.bufferize_to_memref %118 : tensor<?x32x128xf16> -> memref<?x32x128xf16>
                  loom.copy %120, %119 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %90], LR : [%arg5, %90]) : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
            ...
            scf.for %arg7 = %c0 to %25 step %c1 {
              ...
              scf.for %arg8 = %c0 to %26 step %c1 {
                ...
                %79:3 = scf.for %arg9 = %c0 to %36 step %c1 iter_args(%arg10 = %52, %arg11 = %48, %arg12 = %40) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  %112 = loom.subview %arg0[%29, 0, %111] [%20, 128, %22] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<16x128x8192xf16> to memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>>
                  loom.copy %112, %66 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%33, %arg6], LR : [%33, %arg6]) : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  %113 = loom.bufferize_to_tensor %66[%20, 128, %22] : memref<?x128x?xf16> -> tensor<?x128x?xf16>
                  %114 = linalg.fill ins(%cst : f16) outs(%69 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  %115 = linalg.batch_matmul ins(%34, %113 : tensor<?x32x128xf16>, tensor<?x128x?xf16>) outs(%114 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  loom.semaphore_give %66 : memref<?x128x?xf16>
                  loom.semaphore_give %31 : memref<?x32x128xf16>
                  %116 = linalg.fill ins(%cst_1 : f16) outs(%58 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %118 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %117 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%58 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %119 = loom.broadcast ins(%118 : tensor<?x32x1xf16>) outs(%76 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x?xf16>
                  %120 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%115, %119 : tensor<?x32x?xf16>, tensor<?x32x?xf16>) outs(%69 : tensor<?x32x?xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  loom.semaphore_give %75 : memref<?x32x32xf16>
                  %121 = linalg.fill ins(%cst : f16) outs(%61 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %123 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %118 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%64 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  loom.semaphore_give %60 : memref<?x32x1xf16>
                  %125 = loom.broadcast ins(%123 : tensor<?x32x1xf16>) outs(%74 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x128xf16>
                  loom.semaphore_give %63 : memref<?x32x1xf16>
                  %126 = loom.subview %arg1[%29, %111, 0] [%20, %22, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<16x8192x128xf16> to memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>>
                  loom.copy %126, %78 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%33, %arg6], LR : [%33, %arg6]) : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
                  %127 = loom.bufferize_to_tensor %78[%20, %22, 128] : memref<?x?x128xf16> -> tensor<?x?x128xf16>
                  %128 = linalg.fill ins(%cst : f16) outs(%55 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
                ...
                %90 = loom.semaphore_take %89 : memref<?x?x32x1xf16> -> memref<?x?x32x1xf16>
                %91 = loom.init_tensor %90[%24, %20, 32, 1] : memref<?x?x32x1xf16> -> tensor<?x?x32x1xf16>
                %92 = loom.gather ins(%83 : tensor<?x32x1xf16>) outs(%91 : tensor<?x?x32x1xf16>) across(%arg5 : index) region : (UL : [%arg4, %arg6], LR : [%arg4, %arg6]) -> tensor<?x?x32x1xf16>
                loom.semaphore_give %81 : memref<?x32x1xf16>
                ...
                %96 = loom.gather ins(%88 : tensor<?x32x128xf16>) outs(%95 : tensor<?x?x32x128xf16>) across(%arg5 : index) region : (UL : [%arg4, %arg6], LR : [%arg4, %arg6]) -> tensor<?x?x32x128xf16>
                loom.semaphore_give %86 : memref<?x32x128xf16>
                ...
                scf.if %109 {
                  ...
                  %120 = loom.subview %arg2[%29, 0, 0] [%20, 32, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<16x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
                  %121 = loom.bufferize_to_memref %119 : tensor<?x32x128xf16> -> memref<?x32x128xf16>
                  loom.copy %121, %120 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%33, %arg6], LR : [%33, %arg6]) : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
            ...
            scf.for %arg7 = %c0 to %25 step %c1 {
              ...
              scf.for %arg8 = %c0 to %26 step %c1 {
                ...
                %80:3 = scf.for %arg9 = %c0 to %37 step %c1 iter_args(%arg10 = %53, %arg11 = %49, %arg12 = %41) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  %114 = arith.addi %arg5, %33 : index
                  loom.copy %113, %67 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%114, %arg6], LR : [%114, %arg6]) : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  ...
                  %117 = linalg.batch_matmul ins(%35, %115 : tensor<?x32x128xf16>, tensor<?x128x?xf16>) outs(%116 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  loom.semaphore_give %67 : memref<?x128x?xf16>
                  loom.semaphore_give %31 : memref<?x32x128xf16>
                  ...
                  loom.semaphore_give %64 : memref<?x32x1xf16>
                  %128 = loom.subview %arg1[%29, %112, 0] [%20, %22, 128] [1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<16x8192x128xf16> to memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>>
                  loom.copy %128, %79 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%114, %arg6], LR : [%114, %arg6]) : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
                ...
                %91 = loom.semaphore_take %90 : memref<?x?x32x1xf16> -> memref<?x?x32x1xf16>
                %92 = loom.init_tensor %91[%24, %20, 32, 1] : memref<?x?x32x1xf16> -> tensor<?x?x32x1xf16>
                %93 = loom.gather ins(%84 : tensor<?x32x1xf16>) outs(%92 : tensor<?x?x32x1xf16>) across(%arg5 : index) region : (UL : [%33, %arg6], LR : [%34, %arg6]) -> tensor<?x?x32x1xf16>
                loom.semaphore_give %82 : memref<?x32x1xf16>
                %94 = loom.alloc [%24, %20, 32, 128] on @L1 : memref<?x?x32x128xf16>
                %95 = loom.semaphore_take %94 : memref<?x?x32x128xf16> -> memref<?x?x32x128xf16>
                %96 = loom.init_tensor %95[%24, %20, 32, 128] : memref<?x?x32x128xf16> -> tensor<?x?x32x128xf16>
                %97 = loom.gather ins(%89 : tensor<?x32x128xf16>) outs(%96 : tensor<?x?x32x128xf16>) across(%arg5 : index) region : (UL : [%33, %arg6], LR : [%34, %arg6]) -> tensor<?x?x32x128xf16>
                loom.semaphore_give %87 : memref<?x32x128xf16>
                %98 = loom.alloc [%20, 32, 128] on @L1 : memref<?x32x128xf16>
                %99 = loom.semaphore_take %98 : memref<?x32x128xf16> -> memref<?x32x128xf16>
                %100 = loom.init_tensor %99[%20, 32, 128] : memref<?x32x128xf16> -> tensor<?x32x128xf16>
                ...
                scf.if %110 {
                  ...
                  %121 = loom.subview %arg2[%29, 0, 0] [%20, 32, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<16x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
                  %122 = loom.bufferize_to_memref %120 : tensor<?x32x128xf16> -> memref<?x32x128xf16>
                  %123 = arith.addi %arg5, %33 : index
                  loom.copy %122, %121 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%123, %arg6], LR : [%123, %arg6]) : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
                  loom.semaphore_give %99 : memref<?x32x128xf16>
                }
              } {loom.block_sym = @tile_s, loom.iter_type = #loom.iter_type<temporal>}
            } {loom.block_sym = @tile_b, loom.iter_type = #loom.iter_type<temporal>}
            ...
            scf.for %arg7 = %c0 to %23 step %c1 {
              ...
              scf.for %arg8 = %c0 to %25 step %c1 {
                ...
                %76:3 = scf.for %arg9 = %c0 to %33 step %c1 iter_args(%arg10 = %49, %arg11 = %45, %arg12 = %37) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  %111 = loom.subview %arg0[%27, 0, %110] [%20, 128, %22] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<16x128x8192xf16> to memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>>
                  %112 = arith.muli %arg4, %c8 : index
                  %113 = arith.addi %arg5, %112 : index
                  loom.copy %111, %63 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%113, %arg6], LR : [%113, %arg6]) : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  %114 = loom.bufferize_to_tensor %63[%20, 128, %22] : memref<?x128x?xf16> -> tensor<?x128x?xf16>
                  %115 = linalg.fill ins(%cst : f16) outs(%66 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  %116 = linalg.batch_matmul ins(%31, %114 : tensor<?x32x128xf16>, tensor<?x128x?xf16>) outs(%115 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  loom.semaphore_give %63 : memref<?x128x?xf16>
                  ...
                  loom.semaphore_give %60 : memref<?x32x1xf16>
                  %127 = loom.subview %arg1[%27, %110, 0] [%20, %22, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<16x8192x128xf16> to memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>>
                  loom.copy %127, %75 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%113, %arg6], LR : [%113, %arg6]) : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
                  %128 = loom.bufferize_to_tensor %75[%20, %22, 128] : memref<?x?x128xf16> -> tensor<?x?x128xf16>
                  %129 = linalg.fill ins(%cst : f16) outs(%52 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
                  %130 = linalg.batch_matmul ins(%121, %128 : tensor<?x32x?xf16>, tensor<?x?x128xf16>) outs(%129 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
                  loom.semaphore_give %75 : memref<?x?x128xf16>
                ...
                scf.if %108 {
                  ...
                  %119 = loom.subview %arg2[%27, 0, 0] [%20, 32, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<16x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
                  %120 = loom.bufferize_to_memref %118 : tensor<?x32x128xf16> -> memref<?x32x128xf16>
                  %121 = arith.addi %arg5, %89 : index
                  loom.copy %120, %119 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%121, %arg6], LR : [%121, %arg6]) : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
                  loom.semaphore_give %97 : memref<?x32x128xf16>
                }
              } {loom.block_sym = @tile_s, loom.iter_type = #loom.iter_type<temporal>}
            } {loom.block_sym = @tile_b, loom.iter_type = #loom.iter_type<temporal>}

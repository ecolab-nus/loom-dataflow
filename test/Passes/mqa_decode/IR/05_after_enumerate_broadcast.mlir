          ...
          scf.for %arg6 = %c0 to %25 step %c1 {
            ...
            scf.for %arg7 = %c0 to %26 step %c1 {
              ...
              %80:3 = scf.for %arg8 = %c0 to %37 step %c1 iter_args(%arg9 = %55, %arg10 = %51, %arg11 = %41) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                ...
                loom.copy %102, %69 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%arg5, %arg4], LR : [%arg5, %arg4]) : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                ...
                %109 = loom.broadcast ins(%108 : tensor<?x32x1xf16>) outs(%77 : tensor<?x32x32xf16>) dim(%c2 : index) -> tensor<?x32x?xf16>
                ...
                %115 = loom.broadcast ins(%113 : tensor<?x32x1xf16>) outs(%75 : tensor<?x32x32xf16>) dim(%c2 : index) -> tensor<?x32x128xf16>
                ...
                loom.copy %116, %79 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] region : (UL : [%arg5, %arg4], LR : [%arg5, %arg4]) : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
              ...
              scf.if %99 {
                ...
                %109 = loom.broadcast ins(%108 : tensor<?x?x32x1xf16>) outs(%98 : tensor<?x?x32x32xf16>) dim(%c3 : index) -> tensor<?x?x32x128xf16>
                ...
                loom.copy %120, %116 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] region : (UL : [%arg5, %arg4], LR : [%arg5, %arg4]) : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>

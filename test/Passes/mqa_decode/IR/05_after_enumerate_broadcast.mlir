            ...
            scf.for %arg7 = %c0 to %23 step %c1 {
              ...
              scf.for %arg8 = %c0 to %24 step %c1 {
                ...
                %77:3 = scf.for %arg9 = %c0 to %34 step %c1 iter_args(%arg10 = %50, %arg11 = %46, %arg12 = %38) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  %110 = arith.addi %33, %109 : index
                  %111 = loom.subview %arg0[%27, 0, %110] [%18, 128, %20] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<16x128x8192xf16> to memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>>
                  loom.copy %111, %64 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg5, %31], LR : [%arg5, %31]) : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  %112 = loom.bufferize_to_tensor %64[%18, 128, %20] : memref<?x128x?xf16> -> tensor<?x128x?xf16>
                  %113 = linalg.fill ins(%cst : f16) outs(%67 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  %114 = linalg.batch_matmul ins(%32, %112 : tensor<?x32x128xf16>, tensor<?x128x?xf16>) outs(%113 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  loom.semaphore_give %64 : memref<?x128x?xf16>
                  %115 = linalg.fill ins(%cst_1 : f16) outs(%56 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %117 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %116 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%56 : tensor<?x32x1xf16>) {
                  ...
                  %118 = loom.broadcast ins(%117 : tensor<?x32x1xf16>) outs(%74 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x?xf16>
                  %119 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%114, %118 : tensor<?x32x?xf16>, tensor<?x32x?xf16>) outs(%67 : tensor<?x32x?xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %120 = linalg.fill ins(%cst : f16) outs(%59 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %122 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %117 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%62 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %124 = loom.broadcast ins(%122 : tensor<?x32x1xf16>) outs(%72 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x128xf16>
                  loom.semaphore_give %61 : memref<?x32x1xf16>
                  %125 = loom.subview %arg1[%27, %110, 0] [%18, %20, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<16x8192x128xf16> to memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>>
                  loom.copy %125, %76 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg5, %31], LR : [%arg5, %31]) : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
                  %126 = loom.bufferize_to_tensor %76[%18, %20, 128] : memref<?x?x128xf16> -> tensor<?x?x128xf16>
                  %127 = linalg.fill ins(%cst : f16) outs(%53 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
                ...
                %90 = arith.addi %arg6, %arg4 : index
                loom.gather %87, %89 across(%arg5 : index), area : [1, 1] region : (UL : [%c0, %90], LR : [%c7, %90]) : memref<?x32x1xf16> to memref<?x?x32x1xf16>
                loom.semaphore_give %79 : memref<?x32x1xf16>
                %91 = loom.bufferize_to_tensor %89[%22, %18, 32, 1] : memref<?x?x32x1xf16> -> tensor<?x?x32x1xf16>
                %92 = loom.bufferize_to_memref %86 : tensor<?x32x128xf16> -> memref<?x32x128xf16>
                ...
                scf.if %108 {
                  %109 = linalg.fill ins(%cst_1 : f16) outs(%43 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %112 = linalg.fill ins(%cst : f16) outs(%41 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  loom.copy %120, %119 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, area : [1, 1] region : (UL : [%arg5, %31], LR : [%arg5, %31]) : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
            ...
            scf.for %arg7 = %c0 to %23 step %c1 {
              ...
              scf.for %arg8 = %c0 to %24 step %c1 {
                ...
                %78:3 = scf.for %arg9 = %c0 to %35 step %c1 iter_args(%arg10 = %51, %arg11 = %47, %arg12 = %39) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  %110 = arith.muli %arg9, %20 : index
                  %111 = arith.addi %34, %110 : index
                  %112 = loom.subview %arg0[%27, 0, %111] [%18, 128, %20] [1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<16x128x8192xf16> to memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>>
                  %113 = arith.addi %arg6, %31 : index
                  loom.copy %112, %65 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg5, %113], LR : [%arg5, %113]) : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  %114 = loom.bufferize_to_tensor %65[%18, 128, %20] : memref<?x128x?xf16> -> tensor<?x128x?xf16>
                  ...
                  %127 = loom.subview %arg1[%27, %111, 0] [%18, %20, 128] [1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<16x8192x128xf16> to memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>>
                  loom.copy %127, %77 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] region : (UL : [%arg5, %113], LR : [%arg5, %113]) : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
                  %128 = loom.bufferize_to_tensor %77[%18, %20, 128] : memref<?x?x128xf16> -> tensor<?x?x128xf16>
                ...
                %91 = arith.addi %arg6, %31 : index
                loom.gather %88, %90 across(%arg5 : index), area : [1, 1] region : (UL : [%c0, %91], LR : [%c7, %91]) : memref<?x32x1xf16> to memref<?x?x32x1xf16>
                loom.semaphore_give %80 : memref<?x32x1xf16>
                %92 = loom.bufferize_to_tensor %90[%22, %18, 32, 1] : memref<?x?x32x1xf16> -> tensor<?x?x32x1xf16>
                %93 = loom.bufferize_to_memref %87 : tensor<?x32x128xf16> -> memref<?x32x128xf16>
                %94 = loom.alloc [%22, %18, 32, 128] on @L1 : memref<?x?x32x128xf16>
                %95 = loom.semaphore_take %94 : memref<?x?x32x128xf16> -> memref<?x?x32x128xf16>
                loom.gather %93, %95 across(%arg5 : index), area : [1, 1] region : (UL : [%c0, %91], LR : [%c7, %91]) : memref<?x32x128xf16> to memref<?x?x32x128xf16>
                ...
                scf.if %109 {
                  ...
                  %120 = loom.subview %arg2[%27, 0, 0] [%18, 32, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = true] : memref<16x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
                  %121 = loom.bufferize_to_memref %119 : tensor<?x32x128xf16> -> memref<?x32x128xf16>
                  loom.copy %121, %120 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, area : [1, 1] region : (UL : [%arg5, %91], LR : [%arg5, %91]) : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
            ...
            scf.for %arg7 = %c0 to %21 step %c1 {
              ...
              scf.for %arg8 = %c0 to %23 step %c1 {
                ...
                scf.if %106 {
                  ...
                  loom.copy %118, %117 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, area : [1, 1] region : (UL : [%arg5, %88], LR : [%arg5, %88]) : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
          ...
          affine.parallel (%arg6) = (0) to (8) {
            ...
            scf.for %arg7 = %c0 to %23 step %c1 {
              ...
              scf.for %arg8 = %c0 to %24 step %c1 {
                ...
                %88 = loom.alloc [%22, %18, 32, 1] on @L1 : memref<?x?x32x1xf16>
                %89 = loom.semaphore_take %88 : memref<?x?x32x1xf16> -> memref<?x?x32x1xf16>
                loom.gather %87, %89 across(%arg5 : index), area : [1, 1] region : (UL : [%arg4, %arg6], LR : [%arg4, %arg6]) : memref<?x32x1xf16> to memref<?x?x32x1xf16>
                loom.semaphore_give %79 : memref<?x32x1xf16>
                ...
                loom.gather %91, %93 across(%arg5 : index), area : [1, 1] region : (UL : [%arg4, %arg6], LR : [%arg4, %arg6]) : memref<?x32x128xf16> to memref<?x?x32x128xf16>
                loom.semaphore_give %84 : memref<?x32x128xf16>
          ...
          affine.parallel (%arg6) = (0) to (8) {
            ...
            scf.for %arg7 = %c0 to %23 step %c1 {
              ...
              scf.for %arg8 = %c0 to %24 step %c1 {
                ...
                %89 = loom.alloc [%22, %18, 32, 1] on @L1 : memref<?x?x32x1xf16>
                %90 = loom.semaphore_take %89 : memref<?x?x32x1xf16> -> memref<?x?x32x1xf16>
                loom.gather %88, %90 across(%arg5 : index), area : [1, 1] region : (UL : [%31, %arg6], LR : [%32, %arg6]) : memref<?x32x1xf16> to memref<?x?x32x1xf16>
                loom.semaphore_give %80 : memref<?x32x1xf16>
                ...
                %93 = loom.alloc [%22, %18, 32, 128] on @L1 : memref<?x?x32x128xf16>
                %94 = loom.semaphore_take %93 : memref<?x?x32x128xf16> -> memref<?x?x32x128xf16>
                loom.gather %92, %94 across(%arg5 : index), area : [1, 1] region : (UL : [%31, %arg6], LR : [%32, %arg6]) : memref<?x32x128xf16> to memref<?x?x32x128xf16>
                loom.semaphore_give %85 : memref<?x32x128xf16>
                %95 = loom.bufferize_to_tensor %94[%22, %18, 32, 128] : memref<?x?x32x128xf16> -> tensor<?x?x32x128xf16>
                %96 = loom.alloc [%18, 32, 128] on @L1 : memref<?x32x128xf16>
                %97 = loom.semaphore_take %96 : memref<?x32x128xf16> -> memref<?x32x128xf16>

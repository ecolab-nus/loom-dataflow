          ...
          affine.parallel (%arg6) = (0) to (1) {
            ...
            scf.for %arg7 = %c0 to %25 step %c1 {
              ...
              scf.for %arg8 = %c0 to %26 step %c1 {
                ...
                %38 = loom.semaphore_take %36 : memref<?x32x128xf16> -> memref<?x32x128xf16>
                ...
                %79:3 = scf.for %arg9 = %c0 to %35 step %c1 iter_args(%arg10 = %52, %arg11 = %48, %arg12 = %40) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  loom.copy %113, %66 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  ...
                  loom.copy %127, %78 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
            ...
            scf.for %arg7 = %c0 to %25 step %c1 {
              ...
              scf.for %arg8 = %c0 to %26 step %c1 {
                ...
                %79:3 = scf.for %arg9 = %c0 to %35 step %c1 iter_args(%arg10 = %52, %arg11 = %48, %arg12 = %40) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  loom.copy %114, %66 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  %115 = loom.bufferize_to_tensor %66[%20, 128, %22] : memref<?x128x?xf16> -> tensor<?x128x?xf16>
                  %116 = linalg.fill ins(%cst : f16) outs(%69 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  %117 = linalg.batch_matmul ins(%33, %115 : tensor<?x32x128xf16>, tensor<?x128x?xf16>) outs(%116 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  loom.semaphore_give %66 : memref<?x128x?xf16>
                  loom.semaphore_give %31 : memref<?x32x128xf16>
                  %118 = linalg.fill ins(%cst_1 : f16) outs(%58 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %120 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %119 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%58 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %121 = loom.broadcast ins(%120 : tensor<?x32x1xf16>) outs(%76 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x?xf16>
                  %122 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%117, %121 : tensor<?x32x?xf16>, tensor<?x32x?xf16>) outs(%69 : tensor<?x32x?xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  loom.semaphore_give %75 : memref<?x32x32xf16>
                  %123 = linalg.fill ins(%cst : f16) outs(%61 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %125 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %120 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%64 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  loom.semaphore_give %60 : memref<?x32x1xf16>
                  %127 = loom.broadcast ins(%125 : tensor<?x32x1xf16>) outs(%74 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x128xf16>
                  loom.semaphore_give %63 : memref<?x32x1xf16>
                  %128 = loom.subview %arg1[%29, %113, 0] [%20, %22, 128] [1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<16x8192x128xf16> to memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>>
                  loom.copy %128, %78 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
                  %129 = loom.bufferize_to_tensor %78[%20, %22, 128] : memref<?x?x128xf16> -> tensor<?x?x128xf16>
                  %130 = linalg.fill ins(%cst : f16) outs(%55 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
                ...
                %90 = loom.semaphore_take %89 : memref<?x?x32x1xf16> -> memref<?x?x32x1xf16>
                %91 = loom.init_tensor %90[%24, %20, 32, 1] : memref<?x?x32x1xf16> -> tensor<?x?x32x1xf16>
                %92 = arith.muli %arg4, %c2 : index
                %93 = arith.addi %arg6, %92 : index
                %94 = loom.gather ins(%83 : tensor<?x32x1xf16>) outs(%91 : tensor<?x?x32x1xf16>) across(%arg5 : index) region : (UL : [%c0, %93], LR : [%c7, %93]) -> tensor<?x?x32x1xf16>
                loom.semaphore_give %81 : memref<?x32x1xf16>
                ...
                %98 = loom.gather ins(%88 : tensor<?x32x128xf16>) outs(%97 : tensor<?x?x32x128xf16>) across(%arg5 : index) region : (UL : [%c0, %93], LR : [%c7, %93]) -> tensor<?x?x32x128xf16>
                loom.semaphore_give %86 : memref<?x32x128xf16>
                ...
                scf.if %111 {
                  %112 = linalg.fill ins(%cst_1 : f16) outs(%45 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  loom.semaphore_give %90 : memref<?x?x32x1xf16>
                  loom.semaphore_give %44 : memref<?x32x1xf16>
                  %115 = linalg.fill ins(%cst : f16) outs(%43 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  loom.copy %123, %122 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [1, 1] : memref<?x32x128xf16> to memref<?x32x128xf16, strided<[4096, 128, 1], offset: ?>>
            ...
            scf.for %arg7 = %c0 to %23 step %c1 {
              ...
              scf.for %arg8 = %c0 to %25 step %c1 {
                ...
                %77:3 = scf.for %arg9 = %c0 to %33 step %c1 iter_args(%arg10 = %50, %arg11 = %46, %arg12 = %38) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  loom.copy %112, %64 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  %113 = loom.bufferize_to_tensor %64[%20, 128, %22] : memref<?x128x?xf16> -> tensor<?x128x?xf16>
                  %114 = linalg.fill ins(%cst : f16) outs(%67 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  %115 = linalg.batch_matmul ins(%31, %113 : tensor<?x32x128xf16>, tensor<?x128x?xf16>) outs(%114 : tensor<?x32x?xf16>) -> tensor<?x32x?xf16>
                  loom.semaphore_give %64 : memref<?x128x?xf16>
                  loom.semaphore_give %29 : memref<?x32x128xf16>
                  %116 = linalg.fill ins(%cst_1 : f16) outs(%56 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %118 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %117 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%56 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %119 = loom.broadcast ins(%118 : tensor<?x32x1xf16>) outs(%74 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x?xf16>
                  %120 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%115, %119 : tensor<?x32x?xf16>, tensor<?x32x?xf16>) outs(%67 : tensor<?x32x?xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  loom.semaphore_give %73 : memref<?x32x32xf16>
                  %121 = linalg.fill ins(%cst : f16) outs(%59 : tensor<?x32x1xf16>) -> tensor<?x32x1xf16>
                  ...
                  %123 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg10, %118 : tensor<?x32x1xf16>, tensor<?x32x1xf16>) outs(%62 : tensor<?x32x1xf16>) {
                  ^bb0(%in: f16, %in_3: f16, %out: f16):
                  ...
                  %125 = loom.broadcast ins(%123 : tensor<?x32x1xf16>) outs(%72 : tensor<?x32x32xf16>) dim(2) -> tensor<?x32x128xf16>
                  loom.semaphore_give %61 : memref<?x32x1xf16>
                  %126 = loom.subview %arg1[%27, %111, 0] [%20, %22, 128] [1, 1, 1], reuse : [seq = false, spat = true, temp = false] : memref<16x8192x128xf16> to memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>>
                  loom.copy %126, %76 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
                  %127 = loom.bufferize_to_tensor %76[%20, %22, 128] : memref<?x?x128xf16> -> tensor<?x?x128xf16>
                  %128 = linalg.fill ins(%cst : f16) outs(%53 : tensor<?x32x128xf16>) -> tensor<?x32x128xf16>
            ...
            scf.for %arg7 = %c0 to %25 step %c1 {
              ...
              scf.for %arg8 = %c0 to %26 step %c1 {
                ...
                %79:3 = scf.for %arg9 = %c0 to %35 step %c1 iter_args(%arg10 = %52, %arg11 = %48, %arg12 = %40) -> (tensor<?x32x1xf16>, tensor<?x32x1xf16>, tensor<?x32x128xf16>) {
                  ...
                  loom.copy %112, %66 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x128x?xf16, strided<[1048576, 8192, 1], offset: ?>> to memref<?x128x?xf16>
                  ...
                  loom.copy %126, %78 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 1] : memref<?x?x128xf16, strided<[1048576, 128, 1], offset: ?>> to memref<?x?x128xf16>
          ...
          affine.parallel (%arg6) = (0) to (8) {
            ...
            scf.for %arg7 = %c0 to %25 step %c1 {
              ...
              scf.for %arg8 = %c0 to %26 step %c1 {
                ...
                %94 = loom.gather ins(%83 : tensor<?x32x1xf16>) outs(%91 : tensor<?x?x32x1xf16>) across(%arg5 : index) region : (UL : [%92, %arg6], LR : [%93, %arg6]) -> tensor<?x?x32x1xf16>
                loom.semaphore_give %81 : memref<?x32x1xf16>
                %95 = loom.alloc [%24, %20, 32, 128] on @L1 : memref<?x?x32x128xf16>
                %96 = loom.semaphore_take %95 : memref<?x?x32x128xf16> -> memref<?x?x32x128xf16>
                %97 = loom.init_tensor %96[%24, %20, 32, 128] : memref<?x?x32x128xf16> -> tensor<?x?x32x128xf16>
                %98 = loom.gather ins(%88 : tensor<?x32x128xf16>) outs(%97 : tensor<?x?x32x128xf16>) across(%arg5 : index) region : (UL : [%92, %arg6], LR : [%93, %arg6]) -> tensor<?x?x32x128xf16>
                loom.semaphore_give %86 : memref<?x32x128xf16>
                %99 = loom.alloc [%20, 32, 128] on @L1 : memref<?x32x128xf16>
                %100 = loom.semaphore_take %99 : memref<?x32x128xf16> -> memref<?x32x128xf16>
                %101 = loom.init_tensor %100[%20, 32, 128] : memref<?x32x128xf16> -> tensor<?x32x128xf16>

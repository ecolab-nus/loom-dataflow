    ...
    func.func @helion_mamba2_chunk_scan_kernel__x2x4_y2y2y2__d0i1_d1i2_d2i3_d3i4_d4i0__f01234__dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_x_level1_bc8_dim_y_level1_bc4_dim_x_level0_bc2_dim_x_level0_bc2__tile_c64__tile_h64__tile_k64__tile_m64__tile_n64(%arg0: memref<1x8x1x256x256xf16>, %arg1: memref<1x16x8x256xf16>, %arg2: memref<1x16x8x256xf16>, %arg3: memref<1x2048x16x64xf16>, %arg4: memref<1x2048x1x16xf16>, %arg5: memref<1x8x16x64x16xf16>, %arg6: memref<16xf16>, %arg7: memref<1x2048x16x64xf16>) {
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c2, %c2, %c4, %c2) step (%c1, %c1, %c1, %c1, %c1) {
        scf.for %arg13 = %c0 to %c2 step %c1 {
          ...
          %reinterpret_cast_1 = memref.reinterpret_cast %arg4 to offset: [%49], sizes: [64, 16], strides: [16, 1] : memref<1x2048x1x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
          ...
          %reinterpret_cast_2 = memref.reinterpret_cast %arg5 to offset: [%60], sizes: [64, 16], strides: [16, 1] : memref<1x8x16x64x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
          %61 = arith.addi %arg10, %34 : index
          %62 = arith.addi %61, %35 : index
          loom.copy %reinterpret_cast_2, %53 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%32, %62], LR : [%50, %62]) : memref<?x16xf16, strided<[16, 1], offset: ?>> to memref<64x16xf16>
          ...
          loom.matmul ins(%45, %64 : memref<64x16xf16>, memref<16x64xf16>) outs(%66 : memref<64x64xf32>)
          ...
          scf.for %arg14 = %c0 to %70 step %c1 {
            ...
            %reinterpret_cast_6 = memref.reinterpret_cast %arg0 to offset: [%101], sizes: [64, 64], strides: [256, 1] : memref<1x8x1x256x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
            ...
            %reinterpret_cast_7 = memref.reinterpret_cast %arg1 to offset: [%102], sizes: [64], strides: [1] : memref<1x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
            ...
            %reinterpret_cast_8 = memref.reinterpret_cast %arg2 to offset: [%102], sizes: [64], strides: [1] : memref<1x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
            ...
            %reinterpret_cast_9 = memref.reinterpret_cast %arg3 to offset: [%108], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
            loom.copy %reinterpret_cast_9, %81 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%32, %62], LR : [%50, %62]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
          ...
          %reinterpret_cast_4 = memref.reinterpret_cast %arg3 to offset: [%92], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
          loom.copy %reinterpret_cast_4, %86 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%32, %62], LR : [%50, %62]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
          ...
          %reinterpret_cast_5 = memref.reinterpret_cast %arg7 to offset: [%92], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
          loom.copy %86, %reinterpret_cast_5 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%32, %62], LR : [%50, %62]) : memref<64x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_c = {is_reduction = false, upper_bound = 8 : index}, loom.tile_h = {is_reduction = false, upper_bound = 16 : index}, loom.tile_k = {is_reduction = false, upper_bound = 8192 : index}, loom.tile_m = {is_reduction = false, upper_bound = 256 : index}, loom.tile_n = {is_reduction = false, upper_bound = 64 : index}} {
    func.func @helion_mamba2_chunk_scan_kernel__x4x2_y2y2y2__d0i1_d1i2_d2i3_d3i4_d4i0__f01234__dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_x_level1_bc8_dim_y_level1_bc4_dim_x_level0_bc4_dim_x_level0_bc4__tile_c64__tile_h64__tile_k64__tile_m64__tile_n64(%arg0: memref<1x8x1x256x256xf16>, %arg1: memref<1x16x8x256xf16>, %arg2: memref<1x16x8x256xf16>, %arg3: memref<1x2048x16x64xf16>, %arg4: memref<1x2048x1x16xf16>, %arg5: memref<1x8x16x64x16xf16>, %arg6: memref<16xf16>, %arg7: memref<1x2048x16x64xf16>) {
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c4, %c2, %c2, %c2) step (%c1, %c1, %c1, %c1, %c1) {
        ...
        %reinterpret_cast_1 = memref.reinterpret_cast %arg4 to offset: [%47], sizes: [64, 16], strides: [16, 1] : memref<1x2048x1x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
        ...
        %58 = arith.addi %56, %57 : index
        %reinterpret_cast_2 = memref.reinterpret_cast %arg5 to offset: [%58], sizes: [64, 16], strides: [16, 1] : memref<1x8x16x64x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
        %59 = arith.addi %arg10, %32 : index
        %60 = arith.addi %59, %33 : index
        loom.copy %reinterpret_cast_2, %51 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%30, %60], LR : [%48, %60]) : memref<?x16xf16, strided<[16, 1], offset: ?>> to memref<64x16xf16>
        ...
        loom.matmul ins(%43, %62 : memref<64x16xf16>, memref<16x64xf16>) outs(%64 : memref<64x64xf32>)
        ...
        scf.for %arg13 = %c0 to %68 step %c1 {
          ...
          %reinterpret_cast_6 = memref.reinterpret_cast %arg0 to offset: [%99], sizes: [64, 64], strides: [256, 1] : memref<1x8x1x256x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
          ...
          %reinterpret_cast_7 = memref.reinterpret_cast %arg1 to offset: [%100], sizes: [64], strides: [1] : memref<1x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
          ...
          %reinterpret_cast_8 = memref.reinterpret_cast %arg2 to offset: [%100], sizes: [64], strides: [1] : memref<1x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
          ...
          %reinterpret_cast_9 = memref.reinterpret_cast %arg3 to offset: [%106], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
          loom.copy %reinterpret_cast_9, %79 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%30, %60], LR : [%48, %60]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
        ...
        %reinterpret_cast_4 = memref.reinterpret_cast %arg3 to offset: [%90], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
        loom.copy %reinterpret_cast_4, %84 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%30, %60], LR : [%48, %60]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
        ...
        %reinterpret_cast_5 = memref.reinterpret_cast %arg7 to offset: [%90], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
        loom.copy %84, %reinterpret_cast_5 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [4, 1] region : (UL : [%30, %60], LR : [%48, %60]) : memref<64x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
    ...
    func.func @helion_mamba2_chunk_scan_kernel__x2x2x2_y2y4__d0i1_d1i2_d2i3_d3i4_d4i0__f01234__dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_x_level1_bc4_dim_y_level1_bc8_dim_x_level0_bc2_dim_x_level0_bc2__tile_c64__tile_h64__tile_k64__tile_m64__tile_n64(%arg0: memref<1x8x1x256x256xf16>, %arg1: memref<1x16x8x256xf16>, %arg2: memref<1x16x8x256xf16>, %arg3: memref<1x2048x16x64xf16>, %arg4: memref<1x2048x1x16xf16>, %arg5: memref<1x8x16x64x16xf16>, %arg6: memref<16xf16>, %arg7: memref<1x2048x16x64xf16>) {
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c2, %c2, %c2, %c4) step (%c1, %c1, %c1, %c1, %c1) {
        scf.for %arg13 = %c0 to %c2 step %c1 {
          ...
          %reinterpret_cast_1 = memref.reinterpret_cast %arg4 to offset: [%48], sizes: [64, 16], strides: [16, 1] : memref<1x2048x1x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
          ...
          %reinterpret_cast_2 = memref.reinterpret_cast %arg5 to offset: [%61], sizes: [64, 16], strides: [16, 1] : memref<1x8x16x64x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
          %62 = arith.addi %arg10, %36 : index
          loom.copy %reinterpret_cast_2, %54 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%49, %62], LR : [%51, %62]) : memref<?x16xf16, strided<[16, 1], offset: ?>> to memref<64x16xf16>
          %63 = loom.alloc [16, 64] on @L1 : memref<16x64xf16>
          %64 = loom.semaphore_take %63 : memref<16x64xf16> -> memref<16x64xf16>
          ...
          %66 = loom.semaphore_take %65 : memref<64x64xf32> -> memref<64x64xf32>
          %67 = loom.semaphore_take %65 : memref<64x64xf32> -> memref<64x64xf32>
          loom.matmul ins(%44, %64 : memref<64x16xf16>, memref<16x64xf16>) outs(%66 : memref<64x64xf32>)
          loom.semaphore_give %64 : memref<16x64xf16>
          ...
          scf.for %arg14 = %c0 to %70 step %c1 {
            ...
            %reinterpret_cast_9 = memref.reinterpret_cast %arg3 to offset: [%108], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
            loom.copy %reinterpret_cast_9, %81 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%49, %62], LR : [%51, %62]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
            linalg.matmul ins(%72, %81 : memref<64x64xf16>, memref<64x64xf16>) outs(%67 : memref<64x64xf32>)
            loom.semaphore_give %81 : memref<64x64xf16>
            loom.semaphore_give %72 : memref<64x64xf16>
          } {loom.iter_type = #loom.iter_type<sequential>}
          ...
          %reinterpret_cast_4 = memref.reinterpret_cast %arg3 to offset: [%92], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
          loom.copy %reinterpret_cast_4, %86 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%49, %62], LR : [%51, %62]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> ()>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%67, %86, %83 : memref<64x64xf32>, memref<64x64xf16>, memref<f16>) outs(%86 : memref<64x64xf16>) {
          ^bb0(%in: f32, %in_6: f16, %in_7: f16, %out: f16):
            %93 = arith.extf %in_7 : f16 to f32
            %94 = arith.extf %in_6 : f16 to f32
          ...
          loom.semaphore_give %67 : memref<64x64xf32>
          %reinterpret_cast_5 = memref.reinterpret_cast %arg7 to offset: [%92], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
          loom.copy %86, %reinterpret_cast_5 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%49, %62], LR : [%51, %62]) : memref<64x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
          loom.semaphore_give %86 : memref<64x64xf16>
        } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
        scf.reduce 

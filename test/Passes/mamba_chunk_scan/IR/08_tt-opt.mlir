      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c2, %c2, %c4, %c2) step (%c1, %c1, %c1, %c1, %c1) {
        scf.for %arg13 = %c0 to %c2 step %c1 {
          ...
          scf.for %arg14 = %c0 to %68 step %c1 {
            ...
            %reinterpret_cast_7 = memref.reinterpret_cast %arg1 to offset: [%97], sizes: [64], strides: [1] : memref<2x16x8x256xf16> to memref<64xf16, strided<[1], offset: ?>>
            ...
            %reinterpret_cast_8 = memref.reinterpret_cast %arg2 to offset: [%97], sizes: [64], strides: [1] : memref<2x16x8x256xf16> to memref<64xf16, strided<[1], offset: ?>>
            ...
            %reinterpret_cast_9 = memref.reinterpret_cast %arg3 to offset: [%103], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
            loom.copy %reinterpret_cast_9, %76 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%32, %60], LR : [%48, %60]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
          ...
          %reinterpret_cast_4 = memref.reinterpret_cast %arg3 to offset: [%87], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.copy %reinterpret_cast_4, %81 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%32, %60], LR : [%48, %60]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
          ...
          %reinterpret_cast_5 = memref.reinterpret_cast %arg7 to offset: [%87], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.copy %81, %reinterpret_cast_5 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%32, %60], LR : [%48, %60]) : memref<64x32xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
    ...
    func.func @helion_mamba2_chunk_scan_kernel__x4x2_y2y2y2__d0i1_d1i2_d2i3_d3i4_d4i0__f01234__dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_x_level1_bc8_dim_y_level1_bc4_dim_x_level0_bc4_dim_x_level0_bc4__tile_b1__tile_c4__tile_h8__tile_k64__tile_m64__tile_n32(%arg0: memref<2x8x1x256x256xf16>, %arg1: memref<2x16x8x256xf16>, %arg2: memref<2x16x8x256xf16>, %arg3: memref<2x2048x16x64xf16>, %arg4: memref<2x2048x1x16xf16>, %arg5: memref<2x8x16x64x16xf16>, %arg6: memref<16xf16>, %arg7: memref<2x2048x16x64xf16>) {
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c4, %c2, %c2, %c2) step (%c1, %c1, %c1, %c1, %c1) {
        ...
        scf.for %arg13 = %c0 to %66 step %c1 {
          ...
          %reinterpret_cast_7 = memref.reinterpret_cast %arg1 to offset: [%95], sizes: [64], strides: [1] : memref<2x16x8x256xf16> to memref<64xf16, strided<[1], offset: ?>>
          ...
          %reinterpret_cast_8 = memref.reinterpret_cast %arg2 to offset: [%95], sizes: [64], strides: [1] : memref<2x16x8x256xf16> to memref<64xf16, strided<[1], offset: ?>>
          ...
          %reinterpret_cast_9 = memref.reinterpret_cast %arg3 to offset: [%101], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.copy %reinterpret_cast_9, %74 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%30, %58], LR : [%46, %58]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
        ...
        %reinterpret_cast_4 = memref.reinterpret_cast %arg3 to offset: [%85], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
        loom.copy %reinterpret_cast_4, %79 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%30, %58], LR : [%46, %58]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
        ...
        %reinterpret_cast_5 = memref.reinterpret_cast %arg7 to offset: [%85], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
        loom.copy %79, %reinterpret_cast_5 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [4, 1] region : (UL : [%30, %58], LR : [%46, %58]) : memref<64x32xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c2, %c2, %c2, %c4) step (%c1, %c1, %c1, %c1, %c1) {
        scf.for %arg13 = %c0 to %c2 step %c1 {
          ...
          scf.for %arg14 = %c0 to %68 step %c1 {
            ...
            %reinterpret_cast_9 = memref.reinterpret_cast %arg3 to offset: [%103], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
            loom.copy %reinterpret_cast_9, %76 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%47, %60], LR : [%49, %60]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
            linalg.matmul ins(%70, %76 : memref<64x64xf16>, memref<64x32xf16>) outs(%65 : memref<64x32xf16>)
            loom.semaphore_give %76 : memref<64x32xf16>
            loom.semaphore_give %70 : memref<64x64xf16>
          } {loom.iter_type = #loom.iter_type<sequential>}
          ...
          %reinterpret_cast_4 = memref.reinterpret_cast %arg3 to offset: [%87], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.copy %reinterpret_cast_4, %81 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%47, %60], LR : [%49, %60]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> ()>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%65, %81, %78 : memref<64x32xf16>, memref<64x32xf16>, memref<f16>) outs(%81 : memref<64x32xf16>) {
          ^bb0(%in: f16, %in_6: f16, %in_7: f16, %out: f16):
            %88 = arith.mulf %in_6, %in_7 : f16
            %89 = arith.addf %in, %88 : f16
          ...
          loom.semaphore_give %65 : memref<64x32xf16>
          %reinterpret_cast_5 = memref.reinterpret_cast %arg7 to offset: [%87], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.copy %81, %reinterpret_cast_5 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%47, %60], LR : [%49, %60]) : memref<64x32xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.semaphore_give %81 : memref<64x32xf16>
        } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
        scf.reduce 

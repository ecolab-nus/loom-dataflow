module attributes {loom.tile_b = {is_reduction = false, upper_bound = 2 : index}, loom.tile_c = {is_reduction = false, upper_bound = 8 : index}, loom.tile_h = {is_reduction = false, upper_bound = 64 : index}, loom.tile_k = {is_reduction = false, upper_bound = 8192 : index}, loom.tile_m = {is_reduction = false, upper_bound = 256 : index}, loom.tile_n = {is_reduction = false, upper_bound = 64 : index}} {
  func.func @helion_mamba2_chunk_scan_kernel(%arg0: memref<2x8x1x256x256xf16>, %arg1: memref<2x64x8x256xf16>, %arg2: memref<2x64x8x256xf16>, %arg3: memref<2x2048x64x64xf16>, %arg4: memref<2x2048x1x64xf16>, %arg5: memref<2x8x64x64x64xf16>, %arg6: memref<64xf16>, %arg7: memref<2x2048x64x64xf16>) {
    ...
    affine.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (0, 0, 0, 0, 0) to (symbol(%6), symbol(%7), symbol(%8), symbol(%9), symbol(%10)) {
      ...
      %20 = arith.divui %13, %c64 : index
      %subview_2 = memref.subview %arg4[%12, %19, %20, 0] [1, %0, 1, 64] [1, 1, 1, 1] : memref<2x2048x1x64xf16> to memref<?x64xf16, strided<[64, 1], offset: ?>>
      %21 = bufferization.to_tensor %subview_2 : memref<?x64xf16, strided<[64, 1], offset: ?>> to tensor<?x64xf16>
      %22 = arith.muli %arg10, %1 : index
      %subview_3 = memref.subview %arg5[%12, %14, %13, %22, 0] [1, 1, 1, %1, 64] [1, 1, 1, 1, 1] : memref<2x8x64x64x64xf16> to memref<?x64xf16, strided<[64, 1], offset: ?>>
      %23 = bufferization.to_tensor %subview_3 : memref<?x64xf16, strided<[64, 1], offset: ?>> to tensor<?x64xf16>
      %24 = tensor.empty(%1) : tensor<64x?xf16>
      %transposed = linalg.transpose ins(%23 : tensor<?x64xf16>) outs(%24 : tensor<64x?xf16>) permutation = [1, 0] 
      %25 = linalg.fill ins(%cst_0 : f16) outs(%11 : tensor<?x?xf16>) -> tensor<?x?xf16>
      %26 = linalg.matmul ins(%21, %transposed : tensor<?x64xf16>, tensor<64x?xf16>) outs(%25 : tensor<?x?xf16>) -> tensor<?x?xf16>
      ...
      %31 = scf.for %arg13 = %c0 to %30 step %c1 iter_args(%arg14 = %27) -> (tensor<?x?xf16>) {
        ...
        %subview_8 = memref.subview %arg1[%12, %13, %14, %36] [1, 1, 1, %2] [1, 1, 1, 1] : memref<2x64x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
        %38 = bufferization.to_tensor %subview_8 : memref<?xf16, strided<[1], offset: ?>> to tensor<?xf16>
        %39 = tensor.empty(%0, %2) : tensor<?x?xf16>
        %subview_9 = memref.subview %arg2[%12, %13, %14, %36] [1, 1, 1, %2] [1, 1, 1, 1] : memref<2x64x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %subview_10 = memref.subview %arg3[%12, %19, %13, %22] [1, %2, 1, %1] [1, 1, 1, 1] : memref<2x2048x64x64xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
        %42 = bufferization.to_tensor %subview_10 : memref<?x?xf16, strided<[4096, 1], offset: ?>> to tensor<?x?xf16>
      ...
      %subview_5 = memref.subview %arg3[%12, %19, %13, %22] [1, %0, 1, %1] [1, 1, 1, 1] : memref<2x2048x64x64xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
      %33 = bufferization.to_tensor %subview_5 : memref<?x?xf16, strided<[4096, 1], offset: ?>> to tensor<?x?xf16>
      ...
      %subview_6 = memref.subview %arg7[%12, %19, %13, %22] [1, %0, 1, %1] [1, 1, 1, 1] : memref<2x2048x64x64xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
      %35 = bufferization.to_buffer %34 : tensor<?x?xf16> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
      memref.copy %35, %subview_6 : memref<?x?xf16, strided<[4096, 1], offset: ?>> to memref<?x?xf16, strided<[4096, 1], offset: ?>>
    }
    return
  }
}

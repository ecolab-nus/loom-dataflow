            ...
            affine.parallel (%arg11) = (0) to (4) {
              affine.parallel (%arg12) = (0) to (2) {
                scf.for %arg13 = %c0 to %c2 step %c1 {
                  ...
                  %21 = arith.muli %arg8, %c64 : index
                  %22 = arith.muli %arg12, %c64 : index
                  ...
                  %reinterpret_cast = memref.reinterpret_cast %arg1 to offset: [%26], sizes: [64], strides: [1] : memref<1x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                  ...
                  %reinterpret_cast_3 = memref.reinterpret_cast %arg4 to offset: [%47], sizes: [64, 16], strides: [16, 1] : memref<1x2048x1x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
                  ...
                  %50 = arith.muli %arg10, %c64 : index
                  %51 = loom.alloc [64, 16] on @L1 : memref<64x16xf16>
                  %52 = loom.semaphore_take %51 : memref<64x16xf16> -> memref<64x16xf16>
                  %c0_4 = arith.constant 0 : index
                  %53 = affine.apply affine_map<(d0, d1, d2, d3, d4) -> (d0 * 131072 + d1 * 16384 + d2 * 1024 + d3 * 16 + d4)>(%arg11, %22, %21, %50, %c0_4)
                  %reinterpret_cast_5 = memref.reinterpret_cast %arg5 to offset: [%53], sizes: [64, 16], strides: [16, 1] : memref<1x8x16x64x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
                  %54 = arith.addi %arg10, %29 : index
                  %55 = arith.addi %54, %30 : index
                  loom.copy %reinterpret_cast_5, %52 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%27, %55], LR : [%48, %55]) : memref<?x16xf16, strided<[16, 1], offset: ?>> to memref<64x16xf16>
                  %56 = loom.bufferize_to_tensor %52[64, 16] : memref<64x16xf16> -> tensor<64x16xf16>
                  %57 = loom.alloc [16, 64] on @L1 : memref<16x64xf16>
                  %58 = loom.semaphore_take %57 : memref<16x64xf16> -> memref<16x64xf16>
                  %59 = loom.init_tensor %58[16, 64] : memref<16x64xf16> -> tensor<16x64xf16>
                  %transposed = linalg.transpose ins(%56 : tensor<64x16xf16>) outs(%59 : tensor<16x64xf16>) permutation = [1, 0] 
                  loom.semaphore_give %52 : memref<64x16xf16>
                  %60 = loom.alloc [64, 64] on @L1 : memref<64x64xf32>
                  %61 = loom.semaphore_take %60 : memref<64x64xf32> -> memref<64x64xf32>
                  %62 = loom.init_tensor %61[64, 64] : memref<64x64xf32> -> tensor<64x64xf32>
                  %63 = loom.semaphore_take %60 : memref<64x64xf32> -> memref<64x64xf32>
                  %64 = loom.init_tensor %63[64, 64] : memref<64x64xf32> -> tensor<64x64xf32>
                  %65 = linalg.fill ins(%cst_1 : f32) outs(%62 : tensor<64x64xf32>) -> tensor<64x64xf32>
                  %66 = linalg.matmul ins(%49, %transposed : tensor<64x16xf16>, tensor<16x64xf16>) outs(%65 : tensor<64x64xf32>) -> tensor<64x64xf32>
                  loom.semaphore_give %58 : memref<16x64xf16>
                  loom.semaphore_give %46 : memref<64x16xf16>
                  %67 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%66, %42 : tensor<64x64xf32>, tensor<64xf32>) outs(%64 : tensor<64x64xf32>) {
                  ^bb0(%in: f32, %in_9: f32, %out: f32):
                    %99 = arith.mulf %in, %in_9 : f32
                    linalg.yield %99 : f32
                  } -> tensor<64x64xf32>
                  loom.semaphore_give %61 : memref<64x64xf32>
                  ...
                  %85 = scf.for %arg14 = %c0 to %70 step %c1 iter_args(%arg15 = %67) -> (tensor<64x64xf32>) {
                    ...
                    %reinterpret_cast_9 = memref.reinterpret_cast %arg0 to offset: [%100], sizes: [64, 64], strides: [256, 1] : memref<1x8x1x256x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
                    ...
                    %reinterpret_cast_10 = memref.reinterpret_cast %arg1 to offset: [%102], sizes: [64], strides: [1] : memref<1x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                    ...
                    %reinterpret_cast_11 = memref.reinterpret_cast %arg2 to offset: [%105], sizes: [64], strides: [1] : memref<1x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                    ...
                    %reinterpret_cast_12 = memref.reinterpret_cast %arg3 to offset: [%109], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                    loom.copy %reinterpret_cast_12, %84 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%27, %55], LR : [%48, %55]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
                    %110 = loom.bufferize_to_tensor %84[64, 64] : memref<64x64xf16> -> tensor<64x64xf16>
                    %111 = linalg.matmul ins(%108, %110 : tensor<64x64xf16>, tensor<64x64xf16>) outs(%arg15 : tensor<64x64xf32>) -> tensor<64x64xf32>
                    loom.semaphore_give %84 : memref<64x64xf16>
                    loom.semaphore_give %72 : memref<64x64xf16>
                    scf.yield %111 : tensor<64x64xf32>
                  ...
                  %91 = loom.alloc [64, 64] on @L1 : memref<64x64xf16>
                  %92 = loom.semaphore_take %91 : memref<64x64xf16> -> memref<64x64xf16>
                  %93 = loom.init_tensor %92[64, 64] : memref<64x64xf16> -> tensor<64x64xf16>
                  %94 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 2097152 + d1 * 1024 + d2 * 64 + d3)>(%arg11, %43, %21, %50)
                  %reinterpret_cast_7 = memref.reinterpret_cast %arg3 to offset: [%94], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                  loom.copy %reinterpret_cast_7, %92 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%27, %55], LR : [%48, %55]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
                  %95 = loom.bufferize_to_tensor %92[64, 64] : memref<64x64xf16> -> tensor<64x64xf16>
                  %96 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> ()>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%85, %95, %90 : tensor<64x64xf32>, tensor<64x64xf16>, tensor<f16>) outs(%93 : tensor<64x64xf16>) {
                  ...
                  loom.semaphore_give %63 : memref<64x64xf32>
                  %97 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 2097152 + d1 * 1024 + d2 * 64 + d3)>(%arg11, %43, %21, %50)
                  %reinterpret_cast_8 = memref.reinterpret_cast %arg7 to offset: [%97], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                  %98 = loom.bufferize_to_memref %96 : tensor<64x64xf16> -> memref<64x64xf16>
                  loom.copy %98, %reinterpret_cast_8 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%27, %55], LR : [%48, %55]) : memref<64x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                  loom.semaphore_give %92 : memref<64x64xf16>
          ...
          affine.parallel (%arg10) = (0) to (2) {
            affine.parallel (%arg11) = (0) to (2) {
              affine.parallel (%arg12) = (0) to (2) {
                ...
                %reinterpret_cast = memref.reinterpret_cast %arg1 to offset: [%25], sizes: [64], strides: [1] : memref<1x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                ...
                %reinterpret_cast_3 = memref.reinterpret_cast %arg4 to offset: [%46], sizes: [64, 16], strides: [16, 1] : memref<1x2048x1x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
                ...
                %reinterpret_cast_5 = memref.reinterpret_cast %arg5 to offset: [%52], sizes: [64, 16], strides: [16, 1] : memref<1x8x16x64x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
                %53 = arith.addi %arg10, %28 : index
                %54 = arith.addi %53, %29 : index
                loom.copy %reinterpret_cast_5, %51 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%26, %54], LR : [%47, %54]) : memref<?x16xf16, strided<[16, 1], offset: ?>> to memref<64x16xf16>
                %55 = loom.bufferize_to_tensor %51[64, 16] : memref<64x16xf16> -> tensor<64x16xf16>
                %56 = loom.alloc [16, 64] on @L1 : memref<16x64xf16>
                %57 = loom.semaphore_take %56 : memref<16x64xf16> -> memref<16x64xf16>
                %58 = loom.init_tensor %57[16, 64] : memref<16x64xf16> -> tensor<16x64xf16>
                %transposed = linalg.transpose ins(%55 : tensor<64x16xf16>) outs(%58 : tensor<16x64xf16>) permutation = [1, 0] 
                loom.semaphore_give %51 : memref<64x16xf16>
                %59 = loom.alloc [64, 64] on @L1 : memref<64x64xf32>
                %60 = loom.semaphore_take %59 : memref<64x64xf32> -> memref<64x64xf32>
                %61 = loom.init_tensor %60[64, 64] : memref<64x64xf32> -> tensor<64x64xf32>
                %62 = loom.semaphore_take %59 : memref<64x64xf32> -> memref<64x64xf32>
                %63 = loom.init_tensor %62[64, 64] : memref<64x64xf32> -> tensor<64x64xf32>
                %64 = linalg.fill ins(%cst_1 : f32) outs(%61 : tensor<64x64xf32>) -> tensor<64x64xf32>
                %65 = linalg.matmul ins(%48, %transposed : tensor<64x16xf16>, tensor<16x64xf16>) outs(%64 : tensor<64x64xf32>) -> tensor<64x64xf32>
                loom.semaphore_give %57 : memref<16x64xf16>
                loom.semaphore_give %45 : memref<64x16xf16>
                %66 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%65, %41 : tensor<64x64xf32>, tensor<64xf32>) outs(%63 : tensor<64x64xf32>) {
                ^bb0(%in: f32, %in_9: f32, %out: f32):
                  %98 = arith.mulf %in, %in_9 : f32
                  linalg.yield %98 : f32
                } -> tensor<64x64xf32>
                loom.semaphore_give %60 : memref<64x64xf32>
                ...
                %82 = loom.alloc [64, 64] on @L1 : memref<64x64xf16>
                %83 = loom.semaphore_take %82 : memref<64x64xf16> -> memref<64x64xf16>
                %84 = scf.for %arg13 = %c0 to %69 step %c1 iter_args(%arg14 = %66) -> (tensor<64x64xf32>) {
                  ...
                  %reinterpret_cast_9 = memref.reinterpret_cast %arg0 to offset: [%99], sizes: [64, 64], strides: [256, 1] : memref<1x8x1x256x256xf16> to memref<?x?xf16, strided<[256, 1], offset: ?>>
                  ...
                  %reinterpret_cast_10 = memref.reinterpret_cast %arg1 to offset: [%101], sizes: [64], strides: [1] : memref<1x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                  ...
                  %reinterpret_cast_11 = memref.reinterpret_cast %arg2 to offset: [%104], sizes: [64], strides: [1] : memref<1x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
                  ...
                  %reinterpret_cast_12 = memref.reinterpret_cast %arg3 to offset: [%108], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                  loom.copy %reinterpret_cast_12, %83 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%26, %54], LR : [%47, %54]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
                  %109 = loom.bufferize_to_tensor %83[64, 64] : memref<64x64xf16> -> tensor<64x64xf16>
                  %110 = linalg.matmul ins(%107, %109 : tensor<64x64xf16>, tensor<64x64xf16>) outs(%arg14 : tensor<64x64xf32>) -> tensor<64x64xf32>
                  loom.semaphore_give %83 : memref<64x64xf16>
                  loom.semaphore_give %71 : memref<64x64xf16>
                  scf.yield %110 : tensor<64x64xf32>
                } {loom.iter_type = #loom.iter_type<sequential>}
                ...
                %90 = loom.alloc [64, 64] on @L1 : memref<64x64xf16>
                %91 = loom.semaphore_take %90 : memref<64x64xf16> -> memref<64x64xf16>
                %92 = loom.init_tensor %91[64, 64] : memref<64x64xf16> -> tensor<64x64xf16>
                %93 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 2097152 + d1 * 1024 + d2 * 64 + d3)>(%arg11, %42, %20, %49)
                %reinterpret_cast_7 = memref.reinterpret_cast %arg3 to offset: [%93], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                loom.copy %reinterpret_cast_7, %91 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%26, %54], LR : [%47, %54]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
                %94 = loom.bufferize_to_tensor %91[64, 64] : memref<64x64xf16> -> tensor<64x64xf16>
                %95 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> ()>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%84, %94, %89 : tensor<64x64xf32>, tensor<64x64xf16>, tensor<f16>) outs(%92 : tensor<64x64xf16>) {
                ^bb0(%in: f32, %in_9: f16, %in_10: f16, %out: f16):
                ...
                loom.semaphore_give %62 : memref<64x64xf32>
                %96 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 2097152 + d1 * 1024 + d2 * 64 + d3)>(%arg11, %42, %20, %49)
                %reinterpret_cast_8 = memref.reinterpret_cast %arg7 to offset: [%96], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                %97 = loom.bufferize_to_memref %95 : tensor<64x64xf16> -> memref<64x64xf16>
                loom.copy %97, %reinterpret_cast_8 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [4, 1] region : (UL : [%26, %54], LR : [%47, %54]) : memref<64x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                loom.semaphore_give %91 : memref<64x64xf16>
              } {loom.block_sym = @tile_c, loom.iter_type = #loom.iter_type<spatial>, loom.logical_level = 1 : i64, loom.physical_dim = @dim_y}
            } {loom.iter_type = #loom.iter_type<spatial>, loom.logical_level = 1 : i64, loom.physical_dim = @dim_x}
          } {loom.block_sym = @tile_n, loom.iter_type = #loom.iter_type<spatial>, loom.logical_level = 0 : i64, loom.physical_dim = @dim_y}
        } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<spatial>, loom.logical_level = 0 : i64, loom.physical_dim = @dim_x}
            ...
            affine.parallel (%arg11) = (0) to (2) {
              affine.parallel (%arg12) = (0) to (4) {
                scf.for %arg13 = %c0 to %c2 step %c1 {
                  ...
                  %reinterpret_cast_5 = memref.reinterpret_cast %arg5 to offset: [%54], sizes: [64, 16], strides: [16, 1] : memref<1x8x16x64x16xf16> to memref<?x16xf16, strided<[16, 1], offset: ?>>
                  %55 = arith.addi %arg10, %31 : index
                  loom.copy %reinterpret_cast_5, %53 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%47, %55], LR : [%49, %55]) : memref<?x16xf16, strided<[16, 1], offset: ?>> to memref<64x16xf16>
                  %56 = loom.bufferize_to_tensor %53[64, 16] : memref<64x16xf16> -> tensor<64x16xf16>
                  %57 = loom.alloc [16, 64] on @L1 : memref<16x64xf16>
                  %58 = loom.semaphore_take %57 : memref<16x64xf16> -> memref<16x64xf16>
                  %59 = loom.init_tensor %58[16, 64] : memref<16x64xf16> -> tensor<16x64xf16>
                  %transposed = linalg.transpose ins(%56 : tensor<64x16xf16>) outs(%59 : tensor<16x64xf16>) permutation = [1, 0] 
                  ...
                  %64 = loom.init_tensor %63[64, 64] : memref<64x64xf32> -> tensor<64x64xf32>
                  %65 = linalg.fill ins(%cst_1 : f32) outs(%62 : tensor<64x64xf32>) -> tensor<64x64xf32>
                  %66 = linalg.matmul ins(%50, %transposed : tensor<64x16xf16>, tensor<16x64xf16>) outs(%65 : tensor<64x64xf32>) -> tensor<64x64xf32>
                  loom.semaphore_give %58 : memref<16x64xf16>
                  loom.semaphore_give %45 : memref<64x16xf16>
                  %67 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%66, %41 : tensor<64x64xf32>, tensor<64xf32>) outs(%64 : tensor<64x64xf32>) {
                  ^bb0(%in: f32, %in_9: f32, %out: f32):
                    %99 = arith.mulf %in, %in_9 : f32
                    linalg.yield %99 : f32
                  } -> tensor<64x64xf32>
                  ...
                  %85 = scf.for %arg14 = %c0 to %70 step %c1 iter_args(%arg15 = %67) -> (tensor<64x64xf32>) {
                    ...
                    %reinterpret_cast_12 = memref.reinterpret_cast %arg3 to offset: [%109], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                    loom.copy %reinterpret_cast_12, %84 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%47, %55], LR : [%49, %55]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
                    %110 = loom.bufferize_to_tensor %84[64, 64] : memref<64x64xf16> -> tensor<64x64xf16>
                    %111 = linalg.matmul ins(%108, %110 : tensor<64x64xf16>, tensor<64x64xf16>) outs(%arg15 : tensor<64x64xf32>) -> tensor<64x64xf32>
                    loom.semaphore_give %84 : memref<64x64xf16>
                    loom.semaphore_give %72 : memref<64x64xf16>
                  ...
                  %reinterpret_cast_7 = memref.reinterpret_cast %arg3 to offset: [%94], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                  loom.copy %reinterpret_cast_7, %92 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%47, %55], LR : [%49, %55]) : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<64x64xf16>
                  %95 = loom.bufferize_to_tensor %92[64, 64] : memref<64x64xf16> -> tensor<64x64xf16>
                  %96 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> ()>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%85, %95, %90 : tensor<64x64xf32>, tensor<64x64xf16>, tensor<f16>) outs(%93 : tensor<64x64xf16>) {
                  ^bb0(%in: f32, %in_9: f16, %in_10: f16, %out: f16):
                    %99 = arith.extf %in_10 : f16 to f32
                  ...
                  %reinterpret_cast_8 = memref.reinterpret_cast %arg7 to offset: [%97], sizes: [64, 64], strides: [1024, 1] : memref<1x2048x16x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                  %98 = loom.bufferize_to_memref %96 : tensor<64x64xf16> -> memref<64x64xf16>
                  loom.copy %98, %reinterpret_cast_8 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%47, %55], LR : [%49, %55]) : memref<64x64xf16> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
                  loom.semaphore_give %92 : memref<64x64xf16>
                } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
              } {loom.block_sym = @tile_c, loom.iter_type = #loom.iter_type<spatial>, loom.logical_level = 1 : i64, loom.physical_dim = @dim_y}
            } {loom.iter_type = #loom.iter_type<spatial>, loom.logical_level = 1 : i64, loom.physical_dim = @dim_x}

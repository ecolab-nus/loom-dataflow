              ...
              affine.parallel (%arg12) = (0) to (2) {
                scf.for %arg13 = %c0 to %c2 step %c1 {
                  ...
                  %76 = scf.for %arg14 = %c0 to %66 step %c1 iter_args(%arg15 = %63) -> (tensor<64x32xf16>) {
                    ...
                    %93 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 131072 + d1 * 2048 + d2 * 256 + d3)>(%arg11, %21, %22, %90)
                    ...
                    %95 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 131072 + d1 * 2048 + d2 * 256 + d3)>(%arg11, %21, %22, %90)
                    ...
                    %98 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 8388608 + d1 * 4096 + d2 * 64 + d3)>(%arg11, %39, %21, %46)
                  ...
                  loom.copy %89, %reinterpret_cast_8 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%27, %51], LR : [%44, %51]) : memref<64x32xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
            ...
            affine.parallel (%arg11) = (0) to (2) {
              affine.parallel (%arg12) = (0) to (2) {
                ...
                %75 = scf.for %arg13 = %c0 to %65 step %c1 iter_args(%arg14 = %62) -> (tensor<64x32xf16>) {
                  ...
                  %92 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 131072 + d1 * 2048 + d2 * 256 + d3)>(%arg11, %20, %21, %89)
                  %reinterpret_cast_10 = memref.reinterpret_cast %arg1 to offset: [%92], sizes: [64], strides: [1] : memref<2x64x8x256xf16> to memref<64xf16, strided<[1], offset: ?>>
                  ...
                  %94 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 131072 + d1 * 2048 + d2 * 256 + d3)>(%arg11, %20, %21, %89)
                  %reinterpret_cast_11 = memref.reinterpret_cast %arg2 to offset: [%94], sizes: [64], strides: [1] : memref<2x64x8x256xf16> to memref<64xf16, strided<[1], offset: ?>>
                  ...
                  %97 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 8388608 + d1 * 4096 + d2 * 64 + d3)>(%arg11, %38, %20, %45)
                  %reinterpret_cast_12 = memref.reinterpret_cast %arg3 to offset: [%97], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
                ...
                loom.copy %88, %reinterpret_cast_8 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [4, 1] region : (UL : [%26, %50], LR : [%43, %50]) : memref<64x32xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
              ...
              affine.parallel (%arg12) = (0) to (4) {
                scf.for %arg13 = %c0 to %c2 step %c1 {
                  ...
                  %76 = scf.for %arg14 = %c0 to %66 step %c1 iter_args(%arg15 = %63) -> (tensor<64x32xf16>) {
                    ...
                    loom.semaphore_give %73 : memref<64xf16>
                    loom.semaphore_give %71 : memref<64xf16>
                    %98 = affine.apply affine_map<(d0, d1, d2, d3) -> (d0 * 8388608 + d1 * 4096 + d2 * 64 + d3)>(%arg11, %38, %21, %47)
                    %reinterpret_cast_12 = memref.reinterpret_cast %arg3 to offset: [%98], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
                  ...
                  %reinterpret_cast_8 = memref.reinterpret_cast %arg7 to offset: [%88], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
                  %89 = loom.bufferize_to_memref %87 : tensor<64x32xf16> -> memref<64x32xf16>
                  loom.copy %89, %reinterpret_cast_8 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%43, %51], LR : [%45, %51]) : memref<64x32xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
                  loom.semaphore_give %83 : memref<64x32xf16>
                } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
              } {loom.block_sym = @tile_c, loom.iter_type = #loom.iter_type<spatial>, loom.logical_level = 1 : i64, loom.physical_dim = @dim_y}
            } {loom.block_sym = @tile_b, loom.iter_type = #loom.iter_type<spatial>, loom.logical_level = 1 : i64, loom.physical_dim = @dim_x}

    ...
    func.func @helion_mamba2_chunk_scan_kernel__x2x4_y2y2y2__d0i1_d1i2_d2i3_d3i4_d4i0__f01234__dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_x_level1_bc8_dim_y_level1_bc4_dim_x_level0_bc2_dim_x_level0_bc2__tile_b1__tile_c4__tile_h32__tile_k64__tile_m64__tile_n32(%arg0: memref<2x8x1x256x256xf16>, %arg1: memref<2x64x8x256xf16>, %arg2: memref<2x64x8x256xf16>, %arg3: memref<2x2048x64x64xf16>, %arg4: memref<2x2048x1x64xf16>, %arg5: memref<2x8x64x64x64xf16>, %arg6: memref<64xf16>, %arg7: memref<2x2048x64x64xf16>) {
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c2, %c2, %c4, %c2) step (%c1, %c1, %c1, %c1, %c1) {
        scf.for %arg13 = %c0 to %c2 step %c1 {
          ...
          %reinterpret_cast_2 = memref.reinterpret_cast %arg4 to offset: [%47], sizes: [64, 64], strides: [64, 1] : memref<2x2048x1x64xf16> to memref<64x64xf16, strided<[64, 1], offset: ?>>
          %48 = arith.addi %32, %c1 : index
          loom.copy %reinterpret_cast_2, %43 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 2] region : (UL : [%32, %36], LR : [%48, %38]) : memref<64x64xf16, strided<[64, 1], offset: ?>> to memref<64x64xf16>
          ...
          %reinterpret_cast_3 = memref.reinterpret_cast %arg5 to offset: [%58], sizes: [32, 64], strides: [64, 1] : memref<2x8x64x64x64xf16> to memref<32x64xf16, strided<[64, 1], offset: ?>>
          %59 = arith.addi %arg10, %34 : index
          %60 = arith.addi %59, %35 : index
          loom.copy %reinterpret_cast_3, %51 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%32, %60], LR : [%48, %60]) : memref<32x64xf16, strided<[64, 1], offset: ?>> to memref<32x64xf16>
          ...
          linalg.matmul ins(%43, %62 : memref<64x64xf16>, memref<64x32xf16>) outs(%64 : memref<64x32xf16>)
          ...
          scf.for %arg14 = %c0 to %68 step %c1 {
            ...
            %reinterpret_cast_7 = memref.reinterpret_cast %arg0 to offset: [%97], sizes: [64, 64], strides: [256, 1] : memref<2x8x1x256x256xf16> to memref<64x64xf16, strided<[256, 1], offset: ?>>
            ...
            %reinterpret_cast_8 = memref.reinterpret_cast %arg1 to offset: [%98], sizes: [64], strides: [1] : memref<2x64x8x256xf16> to memref<64xf16, strided<[1], offset: ?>>
            ...
            %reinterpret_cast_9 = memref.reinterpret_cast %arg2 to offset: [%98], sizes: [64], strides: [1] : memref<2x64x8x256xf16> to memref<64xf16, strided<[1], offset: ?>>
            ...
            ^bb0(%in: f16, %in_11: f16, %in_12: f16, %in_13: f16, %out: f16):
              %105 = arith.mulf %in_12, %cst_1 : f16
              %106 = arith.mulf %in_11, %cst_1 : f16
              %107 = arith.subf %106, %105 : f16
              %108 = math.powf %cst, %107 : f16
              %109 = arith.mulf %in, %108 : f16
              %110 = arith.mulf %109, %in_13 : f16
            ...
            %reinterpret_cast_10 = memref.reinterpret_cast %arg3 to offset: [%104], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
            loom.copy %reinterpret_cast_10, %76 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%32, %60], LR : [%48, %60]) : memref<64x32xf16, strided<[4096, 1], offset: ?>> to memref<64x32xf16>
          ...
          %reinterpret_cast_5 = memref.reinterpret_cast %arg3 to offset: [%87], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
          loom.copy %reinterpret_cast_5, %81 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%32, %60], LR : [%48, %60]) : memref<64x32xf16, strided<[4096, 1], offset: ?>> to memref<64x32xf16>
          ...
          ^bb0(%in: f16, %in_7: f16, %in_8: f16, %out: f16):
            %89 = arith.mulf %in_7, %in_8 : f16
            %90 = arith.addf %in, %89 : f16
            linalg.yield %90 : f16
          }
          loom.semaphore_give %78 : memref<f16>
          loom.semaphore_give %65 : memref<64x32xf16>
          %reinterpret_cast_6 = memref.reinterpret_cast %arg7 to offset: [%87], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
          %88 = loom.semaphore_take %80 : memref<64x32xf16> -> memref<64x32xf16>
          loom.sync ins(%81 : memref<64x32xf16>) outs(%88 : memref<64x32xf16>)
          loom.copy %88, %reinterpret_cast_6 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%32, %60], LR : [%48, %60]) : memref<64x32xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
  ...
  module attributes {loom.pass_name = "Materialize", loom.tile_b = {is_reduction = false, upper_bound = 2 : index}, loom.tile_c = {is_reduction = false, upper_bound = 8 : index}, loom.tile_h = {is_reduction = false, upper_bound = 64 : index}, loom.tile_k = {is_reduction = false, upper_bound = 8192 : index}, loom.tile_m = {is_reduction = false, upper_bound = 256 : index}, loom.tile_n = {is_reduction = false, upper_bound = 64 : index}} {
    func.func @helion_mamba2_chunk_scan_kernel__x4x2_y2y2y2__d0i1_d1i2_d2i3_d3i4_d4i0__f01234__dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_x_level1_bc8_dim_y_level1_bc4_dim_x_level0_bc4_dim_x_level0_bc4__tile_b1__tile_c4__tile_h32__tile_k64__tile_m64__tile_n32(%arg0: memref<2x8x1x256x256xf16>, %arg1: memref<2x64x8x256xf16>, %arg2: memref<2x64x8x256xf16>, %arg3: memref<2x2048x64x64xf16>, %arg4: memref<2x2048x1x64xf16>, %arg5: memref<2x8x64x64x64xf16>, %arg6: memref<64xf16>, %arg7: memref<2x2048x64x64xf16>) {
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c4, %c2, %c2, %c2) step (%c1, %c1, %c1, %c1, %c1) {
        ...
        loom.copy %reinterpret_cast_2, %41 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 2] region : (UL : [%30, %34], LR : [%46, %36]) : memref<64x64xf16, strided<[64, 1], offset: ?>> to memref<64x64xf16>
        ...
        loom.copy %reinterpret_cast_3, %49 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%30, %58], LR : [%46, %58]) : memref<32x64xf16, strided<[64, 1], offset: ?>> to memref<32x64xf16>
        ...
        scf.for %arg13 = %c0 to %66 step %c1 {
          ...
          %reinterpret_cast_7 = memref.reinterpret_cast %arg0 to offset: [%95], sizes: [64, 64], strides: [256, 1] : memref<2x8x1x256x256xf16> to memref<64x64xf16, strided<[256, 1], offset: ?>>
          ...
          %reinterpret_cast_8 = memref.reinterpret_cast %arg1 to offset: [%96], sizes: [64], strides: [1] : memref<2x64x8x256xf16> to memref<64xf16, strided<[1], offset: ?>>
          ...
          %reinterpret_cast_9 = memref.reinterpret_cast %arg2 to offset: [%96], sizes: [64], strides: [1] : memref<2x64x8x256xf16> to memref<64xf16, strided<[1], offset: ?>>
          ...
          ^bb0(%in: f16, %in_11: f16, %in_12: f16, %in_13: f16, %out: f16):
            %103 = arith.mulf %in_12, %cst_1 : f16
            %104 = arith.mulf %in_11, %cst_1 : f16
            %105 = arith.subf %104, %103 : f16
            %106 = math.powf %cst, %105 : f16
            %107 = arith.mulf %in, %106 : f16
            %108 = arith.mulf %107, %in_13 : f16
          ...
          %reinterpret_cast_10 = memref.reinterpret_cast %arg3 to offset: [%102], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
          loom.copy %reinterpret_cast_10, %74 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%30, %58], LR : [%46, %58]) : memref<64x32xf16, strided<[4096, 1], offset: ?>> to memref<64x32xf16>
        ...
        %reinterpret_cast_5 = memref.reinterpret_cast %arg3 to offset: [%85], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
        loom.copy %reinterpret_cast_5, %79 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%30, %58], LR : [%46, %58]) : memref<64x32xf16, strided<[4096, 1], offset: ?>> to memref<64x32xf16>
        ...
        ^bb0(%in: f16, %in_7: f16, %in_8: f16, %out: f16):
          %87 = arith.mulf %in_7, %in_8 : f16
          %88 = arith.addf %in, %87 : f16
          linalg.yield %88 : f16
        }
        loom.semaphore_give %76 : memref<f16>
        loom.semaphore_give %63 : memref<64x32xf16>
        %reinterpret_cast_6 = memref.reinterpret_cast %arg7 to offset: [%85], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
        %86 = loom.semaphore_take %78 : memref<64x32xf16> -> memref<64x32xf16>
        loom.sync ins(%79 : memref<64x32xf16>) outs(%86 : memref<64x32xf16>)
        loom.copy %86, %reinterpret_cast_6 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [4, 1] region : (UL : [%30, %58], LR : [%46, %58]) : memref<64x32xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
    ...
    func.func @helion_mamba2_chunk_scan_kernel__x2x2x2_y2y4__d0i1_d1i2_d2i3_d3i4_d4i0__f01234__dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_y_level0_bc2_dim_x_level0_bc2_dim_x_level1_bc4_dim_y_level1_bc8_dim_x_level0_bc2_dim_x_level0_bc2__tile_b1__tile_c4__tile_h32__tile_k64__tile_m64__tile_n32(%arg0: memref<2x8x1x256x256xf16>, %arg1: memref<2x64x8x256xf16>, %arg2: memref<2x64x8x256xf16>, %arg3: memref<2x2048x64x64xf16>, %arg4: memref<2x2048x1x64xf16>, %arg5: memref<2x8x64x64x64xf16>, %arg6: memref<64xf16>, %arg7: memref<2x2048x64x64xf16>) {
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c2, %c2, %c2, %c4) step (%c1, %c1, %c1, %c1, %c1) {
        scf.for %arg13 = %c0 to %c2 step %c1 {
          ...
          %reinterpret_cast_2 = memref.reinterpret_cast %arg4 to offset: [%46], sizes: [64, 64], strides: [64, 1] : memref<2x2048x1x64xf16> to memref<64x64xf16, strided<[64, 1], offset: ?>>
          %47 = arith.addi %32, %34 : index
          %48 = arith.addi %32, %c1 : index
          %49 = arith.addi %48, %34 : index
          loom.copy %reinterpret_cast_2, %42 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 2] region : (UL : [%47, %36], LR : [%49, %37]) : memref<64x64xf16, strided<[64, 1], offset: ?>> to memref<64x64xf16>
          ...
          %reinterpret_cast_3 = memref.reinterpret_cast %arg5 to offset: [%59], sizes: [32, 64], strides: [64, 1] : memref<2x8x64x64x64xf16> to memref<32x64xf16, strided<[64, 1], offset: ?>>
          %60 = arith.addi %arg10, %36 : index
          loom.copy %reinterpret_cast_3, %52 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%47, %60], LR : [%49, %60]) : memref<32x64xf16, strided<[64, 1], offset: ?>> to memref<32x64xf16>
          %61 = loom.alloc [64, 32] on @L1 : memref<64x32xf16>
          %62 = loom.semaphore_take %61 : memref<64x32xf16> -> memref<64x32xf16>
          ...
          %65 = loom.semaphore_take %63 : memref<64x32xf16> -> memref<64x32xf16>
          linalg.fill ins(%cst_0 : f16) outs(%64 : memref<64x32xf16>)
          linalg.matmul ins(%42, %62 : memref<64x64xf16>, memref<64x32xf16>) outs(%64 : memref<64x32xf16>)
          loom.semaphore_give %62 : memref<64x32xf16>
          ...
          scf.for %arg14 = %c0 to %68 step %c1 {
            ...
            %reinterpret_cast_10 = memref.reinterpret_cast %arg3 to offset: [%104], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
            loom.copy %reinterpret_cast_10, %76 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%47, %60], LR : [%49, %60]) : memref<64x32xf16, strided<[4096, 1], offset: ?>> to memref<64x32xf16>
            linalg.matmul ins(%70, %76 : memref<64x64xf16>, memref<64x32xf16>) outs(%65 : memref<64x32xf16>)
            loom.semaphore_give %76 : memref<64x32xf16>
            loom.semaphore_give %70 : memref<64x64xf16>
          } {loom.iter_type = #loom.iter_type<sequential>}
          ...
          %reinterpret_cast_5 = memref.reinterpret_cast %arg3 to offset: [%87], sizes: [64, 32], strides: [4096, 1] : memref<2x2048x64x64xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
          loom.copy %reinterpret_cast_5, %81 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%47, %60], LR : [%49, %60]) : memref<64x32xf16, strided<[4096, 1], offset: ?>> to memref<64x32xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> ()>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%65, %81, %78 : memref<64x32xf16>, memref<64x32xf16>, memref<f16>) outs(%81 : memref<64x32xf16>) {
          ^bb0(%in: f16, %in_7: f16, %in_8: f16, %out: f16):
            %89 = arith.mulf %in_7, %in_8 : f16
            %90 = arith.addf %in, %89 : f16
          ...
          %88 = loom.semaphore_take %80 : memref<64x32xf16> -> memref<64x32xf16>
          loom.sync ins(%81 : memref<64x32xf16>) outs(%88 : memref<64x32xf16>)
          loom.copy %88, %reinterpret_cast_6 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%47, %60], LR : [%49, %60]) : memref<64x32xf16> to memref<64x32xf16, strided<[4096, 1], offset: ?>>
          loom.semaphore_give %88 : memref<64x32xf16>
          loom.semaphore_give %81 : memref<64x32xf16>
        } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
        scf.reduce 
    ...
    func.func @helion_mamba2_chunk_scan_kernel__x2x2x2_y4y2__d0i1_d1i2_d2i3_d3i4_d4i0__f01234__dim_y_level0_bc4_dim_x_level0_bc2_dim_y_level0_bc4_dim_x_level0_bc2_dim_y_level0_bc4_dim_x_level0_bc2_dim_y_level0_bc4_dim_x_level0_bc2_dim_y_level0_bc4_dim_x_level0_bc2_dim_x_level1_bc4_dim_y_level1_bc8_dim_x_level0_bc2_dim_x_level0_bc2__tile_b1__tile_c4__tile_h32__tile_k64__tile_m64__tile_n32(%arg0: memref<2x8x1x256x256xf16>, %arg1: memref<2x64x8x256xf16>, %arg2: memref<2x64x8x256xf16>, %arg3: memref<2x2048x64x64xf16>, %arg4: memref<2x2048x1x64xf16>, %arg5: memref<2x8x64x64x64xf16>, %arg6: memref<64xf16>, %arg7: memref<2x2048x64x64xf16>) {
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c2, %c4, %c2, %c2) step (%c1, %c1, %c1, %c1, %c1) {
        scf.for %arg13 = %c0 to %c2 step %c1 {
          ...
          %48 = arith.addi %32, %c1 : index
          %49 = arith.addi %48, %34 : index
          loom.copy %reinterpret_cast_2, %42 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 4] region : (UL : [%47, %36], LR : [%49, %37]) : memref<64x64xf16, strided<[64, 1], offset: ?>> to memref<64x64xf16>
          %50 = arith.muli %arg10, %c32 : index
          %51 = loom.alloc [32, 64] on @L1 : memref<32x64xf16>
          %52 = loom.semaphore_take %51 : memref<32x64xf16> -> memref<32x64xf16>
          %53 = arith.muli %arg11, %c2097152 overflow<nsw> : index

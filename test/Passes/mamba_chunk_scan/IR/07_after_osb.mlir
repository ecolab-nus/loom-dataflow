      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c2, %c2, %c4, %c2) step (%c1, %c1, %c1, %c1, %c1) {
        scf.for %arg13 = %c0 to %c2 step %c1 {
          ...
          scf.for %arg14 = %c0 to %68 step %c1 {
            ...
            %reinterpret_cast_7 = memref.reinterpret_cast %arg0 to offset: [%98], sizes: [64, %88], strides: [256, 1] : memref<2x8x1x256x256xf16> to memref<64x?xf16, strided<[256, 1], offset: ?>>
            loom.copy %reinterpret_cast_7, %90 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 2] region : (UL : [%33, %36], LR : [%33, %38]) : memref<64x?xf16, strided<[256, 1], offset: ?>> to memref<?x?xf16>
            %99 = loom.alloc [%88] on @L1 : memref<?xf16>
            %100 = loom.semaphore_take %99 : memref<?xf16> -> memref<?xf16>
            %101 = arith.addi %30, %84 : index
            %reinterpret_cast_8 = memref.reinterpret_cast %arg1 to offset: [%101], sizes: [%88], strides: [1] : memref<2x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
            loom.copy %reinterpret_cast_8, %100 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 2] region : (UL : [%32, %36], LR : [%48, %38]) : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16>
            %102 = loom.alloc [%88] on @L1 : memref<?xf16>
            %103 = loom.semaphore_take %102 : memref<?xf16> -> memref<?xf16>
            %reinterpret_cast_9 = memref.reinterpret_cast %arg2 to offset: [%101], sizes: [%88], strides: [1] : memref<2x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
            loom.copy %reinterpret_cast_9, %103 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 2] region : (UL : [%32, %36], LR : [%48, %38]) : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16>
            ...
            ^bb0(%in: f16, %in_11: f16, %in_12: f16, %in_13: f16, %out: f16):
              %110 = arith.mulf %in_12, %cst_1 : f16
              %111 = arith.mulf %in_11, %cst_1 : f16
              %112 = arith.subf %111, %110 : f16
              %113 = math.powf %cst, %112 : f16
              %114 = arith.mulf %in, %113 : f16
              %115 = arith.mulf %114, %in_13 : f16
            ...
            %reinterpret_cast_10 = memref.reinterpret_cast %arg3 to offset: [%109], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
            loom.copy %reinterpret_cast_10, %72 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%32, %60], LR : [%48, %60]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
          ...
          loom.copy %reinterpret_cast_4, %74 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [8, 4] region : (UL : [%c0, %35], LR : [%c7, %75]) : memref<f16, strided<[], offset: ?>> to memref<f16>
          ...
          %reinterpret_cast_5 = memref.reinterpret_cast %arg3 to offset: [%83], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.copy %reinterpret_cast_5, %77 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%32, %60], LR : [%48, %60]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
          ...
          ^bb0(%in: f16, %in_7: f16, %in_8: f16, %out: f16):
            %84 = arith.mulf %in_7, %in_8 : f16
            %85 = arith.addf %in, %84 : f16
            linalg.yield %85 : f16
          }
          loom.semaphore_give %74 : memref<f16>
          loom.semaphore_give %65 : memref<64x32xf16>
          %reinterpret_cast_6 = memref.reinterpret_cast %arg7 to offset: [%83], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.copy %77, %reinterpret_cast_6 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%32, %60], LR : [%48, %60]) : memref<64x32xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
    ...
    func.func @helion_mamba2_chunk_scan_kernel__x4x2_y2y2y2__d0i1_d1i2_d2i3_d3i4_d4i0__f01234__dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_y_level0_bc2_dim_x_level0_bc4_dim_x_level1_bc8_dim_y_level1_bc4_dim_x_level0_bc4_dim_x_level0_bc4__tile_b1__tile_c4__tile_h8__tile_k64__tile_m64__tile_n32(%arg0: memref<2x8x1x256x256xf16>, %arg1: memref<2x16x8x256xf16>, %arg2: memref<2x16x8x256xf16>, %arg3: memref<2x2048x16x64xf16>, %arg4: memref<2x2048x1x16xf16>, %arg5: memref<2x8x16x64x16xf16>, %arg6: memref<16xf16>, %arg7: memref<2x2048x16x64xf16>) {
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c4, %c2, %c2, %c2) step (%c1, %c1, %c1, %c1, %c1) {
        ...
        scf.for %arg13 = %c0 to %66 step %c1 {
          ...
          %reinterpret_cast_7 = memref.reinterpret_cast %arg0 to offset: [%96], sizes: [64, %86], strides: [256, 1] : memref<2x8x1x256x256xf16> to memref<64x?xf16, strided<[256, 1], offset: ?>>
          loom.copy %reinterpret_cast_7, %88 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 2] region : (UL : [%31, %34], LR : [%31, %36]) : memref<64x?xf16, strided<[256, 1], offset: ?>> to memref<?x?xf16>
          %97 = loom.alloc [%86] on @L1 : memref<?xf16>
          %98 = loom.semaphore_take %97 : memref<?xf16> -> memref<?xf16>
          %99 = arith.addi %28, %82 : index
          %reinterpret_cast_8 = memref.reinterpret_cast %arg1 to offset: [%99], sizes: [%86], strides: [1] : memref<2x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
          loom.copy %reinterpret_cast_8, %98 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 2] region : (UL : [%30, %34], LR : [%46, %36]) : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16>
          %100 = loom.alloc [%86] on @L1 : memref<?xf16>
          %101 = loom.semaphore_take %100 : memref<?xf16> -> memref<?xf16>
          %reinterpret_cast_9 = memref.reinterpret_cast %arg2 to offset: [%99], sizes: [%86], strides: [1] : memref<2x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
          loom.copy %reinterpret_cast_9, %101 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 2] region : (UL : [%30, %34], LR : [%46, %36]) : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16>
          ...
          ^bb0(%in: f16, %in_11: f16, %in_12: f16, %in_13: f16, %out: f16):
            %108 = arith.mulf %in_12, %cst_1 : f16
            %109 = arith.mulf %in_11, %cst_1 : f16
            %110 = arith.subf %109, %108 : f16
            %111 = math.powf %cst, %110 : f16
            %112 = arith.mulf %in, %111 : f16
            %113 = arith.mulf %112, %in_13 : f16
          ...
          %reinterpret_cast_10 = memref.reinterpret_cast %arg3 to offset: [%107], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.copy %reinterpret_cast_10, %70 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%30, %58], LR : [%46, %58]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
        ...
        loom.copy %reinterpret_cast_4, %72 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [8, 4] region : (UL : [%c0, %33], LR : [%c7, %73]) : memref<f16, strided<[], offset: ?>> to memref<f16>
        ...
        %reinterpret_cast_5 = memref.reinterpret_cast %arg3 to offset: [%81], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
        loom.copy %reinterpret_cast_5, %75 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 1] region : (UL : [%30, %58], LR : [%46, %58]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
        ...
        ^bb0(%in: f16, %in_7: f16, %in_8: f16, %out: f16):
          %82 = arith.mulf %in_7, %in_8 : f16
          %83 = arith.addf %in, %82 : f16
          linalg.yield %83 : f16
        }
        loom.semaphore_give %72 : memref<f16>
        loom.semaphore_give %63 : memref<64x32xf16>
        %reinterpret_cast_6 = memref.reinterpret_cast %arg7 to offset: [%81], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
        loom.copy %75, %reinterpret_cast_6 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [4, 1] region : (UL : [%30, %58], LR : [%46, %58]) : memref<64x32xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c2, %c2, %c2, %c4) step (%c1, %c1, %c1, %c1, %c1) {
        scf.for %arg13 = %c0 to %c2 step %c1 {
          ...
          scf.for %arg14 = %c0 to %68 step %c1 {
            ...
            %98 = arith.addi %97, %84 : index
            %reinterpret_cast_7 = memref.reinterpret_cast %arg0 to offset: [%98], sizes: [64, %88], strides: [256, 1] : memref<2x8x1x256x256xf16> to memref<64x?xf16, strided<[256, 1], offset: ?>>
            loom.copy %reinterpret_cast_7, %90 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 2] region : (UL : [%35, %36], LR : [%35, %37]) : memref<64x?xf16, strided<[256, 1], offset: ?>> to memref<?x?xf16>
            %99 = loom.alloc [%88] on @L1 : memref<?xf16>
            %100 = loom.semaphore_take %99 : memref<?xf16> -> memref<?xf16>
            %101 = arith.addi %30, %84 : index
            %reinterpret_cast_8 = memref.reinterpret_cast %arg1 to offset: [%101], sizes: [%88], strides: [1] : memref<2x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
            loom.copy %reinterpret_cast_8, %100 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 2] region : (UL : [%47, %36], LR : [%49, %37]) : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16>
            %102 = loom.alloc [%88] on @L1 : memref<?xf16>
            %103 = loom.semaphore_take %102 : memref<?xf16> -> memref<?xf16>
            %reinterpret_cast_9 = memref.reinterpret_cast %arg2 to offset: [%101], sizes: [%88], strides: [1] : memref<2x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
            loom.copy %reinterpret_cast_9, %103 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 2] region : (UL : [%47, %36], LR : [%49, %37]) : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16>
            linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0)>, affine_map<(d0, d1) -> (d1)>, affine_map<(d0, d1) -> (d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%90, %25, %100, %103 : memref<?x?xf16>, memref<64xf16>, memref<?xf16>, memref<?xf16>) outs(%70 : memref<64x64xf16>) {
            ^bb0(%in: f16, %in_11: f16, %in_12: f16, %in_13: f16, %out: f16):
              %110 = arith.mulf %in_12, %cst_1 : f16
              %111 = arith.mulf %in_11, %cst_1 : f16
            ...
            %reinterpret_cast_10 = memref.reinterpret_cast %arg3 to offset: [%109], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
            loom.copy %reinterpret_cast_10, %72 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%47, %60], LR : [%49, %60]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
            linalg.matmul ins(%70, %72 : memref<64x64xf16>, memref<64x32xf16>) outs(%65 : memref<64x32xf16>)
            loom.semaphore_give %72 : memref<64x32xf16>
            loom.semaphore_give %70 : memref<64x64xf16>
          } {loom.iter_type = #loom.iter_type<sequential>}
          ...
          loom.copy %reinterpret_cast_4, %74 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [4, 8] region : (UL : [%34, %c0], LR : [%75, %c7]) : memref<f16, strided<[], offset: ?>> to memref<f16>
          %76 = loom.alloc [64, 32] on @L1 : memref<64x32xf16>
          %77 = loom.semaphore_take %76 : memref<64x32xf16> -> memref<64x32xf16>
          %78 = arith.muli %arg11, %c2097152 overflow<nsw> : index
          %79 = arith.muli %arg12, %c1048576 : index
          ...
          %reinterpret_cast_5 = memref.reinterpret_cast %arg3 to offset: [%83], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.copy %reinterpret_cast_5, %77 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 1] region : (UL : [%47, %60], LR : [%49, %60]) : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<64x32xf16>
          linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> ()>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%65, %77, %74 : memref<64x32xf16>, memref<64x32xf16>, memref<f16>) outs(%77 : memref<64x32xf16>) {
          ^bb0(%in: f16, %in_7: f16, %in_8: f16, %out: f16):
            %84 = arith.mulf %in_7, %in_8 : f16
            %85 = arith.addf %in, %84 : f16
          ...
          loom.semaphore_give %65 : memref<64x32xf16>
          %reinterpret_cast_6 = memref.reinterpret_cast %arg7 to offset: [%83], sizes: [64, 32], strides: [1024, 1] : memref<2x2048x16x64xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.copy %77, %reinterpret_cast_6 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, broadcast : [2, 1] region : (UL : [%47, %60], LR : [%49, %60]) : memref<64x32xf16> to memref<64x32xf16, strided<[1024, 1], offset: ?>>
          loom.semaphore_give %77 : memref<64x32xf16>
        } {loom.block_sym = @tile_m, loom.iter_type = #loom.iter_type<temporal>}
        scf.reduce 
      ...
      scf.parallel (%arg8, %arg9, %arg10, %arg11, %arg12) = (%c0, %c0, %c0, %c0, %c0) to (%c2, %c2, %c4, %c2, %c2) step (%c1, %c1, %c1, %c1, %c1) {
        scf.for %arg13 = %c0 to %c2 step %c1 {
          ...
          scf.for %arg14 = %c0 to %68 step %c1 {
            ...
            %98 = arith.addi %97, %84 : index
            %reinterpret_cast_7 = memref.reinterpret_cast %arg0 to offset: [%98], sizes: [64, %88], strides: [256, 1] : memref<2x8x1x256x256xf16> to memref<64x?xf16, strided<[256, 1], offset: ?>>
            loom.copy %reinterpret_cast_7, %90 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [1, 4] region : (UL : [%35, %36], LR : [%35, %37]) : memref<64x?xf16, strided<[256, 1], offset: ?>> to memref<?x?xf16>
            %99 = loom.alloc [%88] on @L1 : memref<?xf16>
            %100 = loom.semaphore_take %99 : memref<?xf16> -> memref<?xf16>
            %101 = arith.addi %30, %84 : index
            %reinterpret_cast_8 = memref.reinterpret_cast %arg1 to offset: [%101], sizes: [%88], strides: [1] : memref<2x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
            loom.copy %reinterpret_cast_8, %100 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 4] region : (UL : [%47, %36], LR : [%49, %37]) : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16>
            %102 = loom.alloc [%88] on @L1 : memref<?xf16>
            %103 = loom.semaphore_take %102 : memref<?xf16> -> memref<?xf16>
            %reinterpret_cast_9 = memref.reinterpret_cast %arg2 to offset: [%101], sizes: [%88], strides: [1] : memref<2x16x8x256xf16> to memref<?xf16, strided<[1], offset: ?>>
            loom.copy %reinterpret_cast_9, %103 src_mem_space @mem_DRAM dst_mem_space @mem_L1, broadcast : [2, 4] region : (UL : [%47, %36], LR : [%49, %37]) : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16>
            linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0)>, affine_map<(d0, d1) -> (d1)>, affine_map<(d0, d1) -> (d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%90, %25, %100, %103 : memref<?x?xf16>, memref<64xf16>, memref<?xf16>, memref<?xf16>) outs(%70 : memref<64x64xf16>) {
            ^bb0(%in: f16, %in_11: f16, %in_12: f16, %in_13: f16, %out: f16):
              %110 = arith.mulf %in_12, %cst_1 : f16
              %111 = arith.mulf %in_11, %cst_1 : f16

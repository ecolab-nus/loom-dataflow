      ...
      scf.parallel (%arg4, %arg5) = (%c0, %c0) to (%c8, %c8) step (%c1, %c1) {
        scf.for %arg6 = %c0 to %c2 step %c1 {
          ...
          scf.for %arg7 = %c0 to %c16 step %c1 {
            ...
            loom.batch_matmul ins(%24, %44 : memref<1x32x128xf16>, memref<1x128x64xf16>) outs(%46 : memref<1x32x64xf16>)
            ...
            loom.batch_matmul ins(%46, %48 : memref<1x32x64xf16>, memref<1x64x128xf16>) outs(%36 : memref<1x32x128xf16>)

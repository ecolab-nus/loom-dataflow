      ...
      affine.for %arg10 = 0 to affine_map<(d0, d1) -> (d1)>(%arg6, %arg7) {
        affine.parallel (%arg11) = (0) to (8) {
          ...
          affine.parallel (%arg12) = (0) to (8) {
            ...
            %8 = affine.apply affine_map<()[s0] -> ((s0 + 31) floordiv 32)>()[%arg5]
            ...
            %9 = scf.for %arg13 = %c0 to %8 step %c1 iter_args(%arg14 = %7) -> (tensor<64x64xf32>) {
              ...
              %13 = affine.apply affine_map<(d0, d1) -> (d1 * 16384 + d0 * 64)>(%arg10, %arg13)
              ...
              %16 = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%arg14, %15 : tensor<64x64xf32>, tensor<64x64xf32>) outs(%arg14 : tensor<64x64xf32>) {
        ...
        affine.parallel (%arg11) = (0) to (8) {
          ...
          affine.parallel (%arg12) = (0) to (8) {
            ...
            %9 = scf.for %arg13 = %c0 to %8 step %c1 iter_args(%arg14 = %7) -> (tensor<64x64xf32>) {
              ...
              memref.copy %reinterpret_cast_0, %alloc : memref<64x32xf32, strided<[512, 1], offset: ?>> to memref<64x32xf32>
              %12 = bufferization.to_tensor %alloc restrict writable : memref<64x32xf32> to tensor<64x32xf32>
              %13 = affine.apply affine_map<(d0, d1) -> (d1 * 16384 + d0 * 64)>(%arg9, %arg13)
              %reinterpret_cast_1 = memref.reinterpret_cast %arg1 to offset: [%13], sizes: [32, 64], strides: [512, 1] : memref<*xf32> to memref<32x64xf32, strided<[512, 1], offset: ?>>
              %alloc_2 = memref.alloc() : memref<32x64xf32>
              memref.copy %reinterpret_cast_1, %alloc_2 : memref<32x64xf32, strided<[512, 1], offset: ?>> to memref<32x64xf32>
              %14 = bufferization.to_tensor %alloc_2 restrict writable : memref<32x64xf32> to tensor<32x64xf32>
    ...
    affine.for %arg9 = 0 to affine_map<(d0, d1) -> (d0 ceildiv 8)>(%arg6, %arg7) {
      affine.for %arg10 = 0 to affine_map<(d0, d1) -> (d1 ceildiv 8)>(%arg6, %arg7) {
        affine.parallel (%arg11) = (0) to (8) {
          %4 = affine.apply affine_map<(d0, d1) -> (d0 * 8 + d1)>(%arg10, %arg11)
          affine.parallel (%arg12) = (0) to (8) {
            %5 = affine.apply affine_map<(d0, d1) -> (d0 * 8 + d1)>(%arg9, %arg12)
            %cst = arith.constant 0.000000e+00 : f32
            %6 = tensor.empty() : tensor<64x64xf32>
            %7 = linalg.fill ins(%cst : f32) outs(%6 : tensor<64x64xf32>) -> tensor<64x64xf32>
            %8 = affine.apply affine_map<()[s0] -> ((s0 + 31) floordiv 32)>()[%arg5]
    ...
    affine.for %arg9 = 0 to affine_map<(d0, d1) -> (d1 ceildiv 8)>(%arg6, %arg7) {
      affine.for %arg10 = 0 to affine_map<(d0, d1) -> (d0 ceildiv 8)>(%arg6, %arg7) {
        affine.parallel (%arg11) = (0) to (8) {
          %4 = affine.apply affine_map<(d0, d1) -> (d0 * 8 + d1)>(%arg9, %arg11)
          affine.parallel (%arg12) = (0) to (8) {
            %5 = affine.apply affine_map<(d0, d1) -> (d0 * 8 + d1)>(%arg10, %arg12)
            %cst = arith.constant 0.000000e+00 : f32
            %6 = tensor.empty() : tensor<64x64xf32>
            %7 = linalg.fill ins(%cst : f32) outs(%6 : tensor<64x64xf32>) -> tensor<64x64xf32>
            %8 = affine.apply affine_map<()[s0] -> ((s0 + 31) floordiv 32)>()[%arg5]
      ...
      affine.for %arg10 = 0 to affine_map<(d0, d1) -> ((d1 ceildiv 8) ceildiv 8)>(%arg6, %arg7) {
        affine.parallel (%arg11) = (0) to (8) {
          ...
          affine.parallel (%arg12) = (0) to (8) {
            ...
            %c1 = arith.constant 1 : index
            %9 = scf.for %arg13 = %c0 to %8 step %c1 iter_args(%arg14 = %7) -> (tensor<64x64xf32>) {
              %11 = affine.apply affine_map<(d0, d1) -> (d1 * 32768 + d0 * 32)>(%arg13, %arg9)
              %reinterpret_cast_0 = memref.reinterpret_cast %arg0 to offset: [%11], sizes: [64, 32], strides: [512, 1] : memref<*xf32> to memref<64x32xf32, strided<[512, 1], offset: ?>>
              %alloc = memref.alloc() : memref<64x32xf32>
              memref.copy %reinterpret_cast_0, %alloc : memref<64x32xf32, strided<[512, 1], offset: ?>> to memref<64x32xf32>
              %12 = bufferization.to_tensor %alloc restrict writable : memref<64x32xf32> to tensor<64x32xf32>
      ...
      affine.for %arg10 = 0 to affine_map<(d0, d1) -> (d0)>(%arg6, %arg7) {
        affine.parallel (%arg11) = (0) to (8) {
          ...
          affine.parallel (%arg12) = (0) to (8) {
            ...
            %c1 = arith.constant 1 : index
            %9 = scf.for %arg13 = %c0 to %8 step %c1 iter_args(%arg14 = %7) -> (tensor<64x64xf32>) {
              %11 = affine.apply affine_map<(d0, d1) -> (d1 * 32768 + d0 * 32)>(%arg13, %arg10)
              %reinterpret_cast_0 = memref.reinterpret_cast %arg0 to offset: [%11], sizes: [64, 32], strides: [512, 1] : memref<*xf32> to memref<64x32xf32, strided<[512, 1], offset: ?>>
              %alloc = memref.alloc() : memref<64x32xf32>
              memref.copy %reinterpret_cast_0, %alloc : memref<64x32xf32, strided<[512, 1], offset: ?>> to memref<64x32xf32>
              %12 = bufferization.to_tensor %alloc restrict writable : memref<64x32xf32> to tensor<64x32xf32>

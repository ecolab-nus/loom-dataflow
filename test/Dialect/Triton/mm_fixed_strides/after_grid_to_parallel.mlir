#map = affine_map<(d0) -> ((d0 + 31) floordiv 32)>
#map1 = affine_map<(d0, d1, d2, d3) -> (d0 * 32768 + d3 * 32)>
#map2 = affine_map<(d0, d1, d2, d3) -> (d3 * 16384 + d1 * 64)>
#map3 = affine_map<(d0, d1) -> (d0, d1)>
#map4 = affine_map<(d0, d1, d2) -> (d0 * 32768 + d1 * 64)>
module {
  func.func @matmul_kernel(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: memref<*xf32> {tt.divisibility = 16 : i32}, %arg2: memref<*xf32> {tt.divisibility = 16 : i32}, %arg3: index {tt.divisibility = 16 : i32}, %arg4: index {tt.divisibility = 16 : i32}, %arg5: index {tt.divisibility = 16 : i32}, %arg6: index, %arg7: index, %arg8: index) {
    affine.parallel (%arg9, %arg10, %arg11) = (0, 0, 0) to (%arg6, %arg7, %arg8) {
      ...
      %3 = scf.for %arg12 = %c0 to %2 step %c1 iter_args(%arg13 = %1) -> (tensor<64x64xf32>) {
        %5 = affine.apply #map1(%arg9, %arg10, %arg11, %arg12)
        ...
        %7 = affine.apply #map2(%arg9, %arg10, %arg11, %arg12)
      ...
      %4 = affine.apply #map4(%arg9, %arg10, %arg11)

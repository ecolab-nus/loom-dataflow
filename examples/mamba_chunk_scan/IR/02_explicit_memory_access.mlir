    ...
    affine.parallel (%arg8, %arg9, %arg10) = (0, 0, 0) to (symbol(%6), symbol(%7), symbol(%8)) {
      ...
      scf.for %arg11 = %c0 to %9 step %c1 {
        ...
        scf.for %arg12 = %c0 to %10 step %c1 {
          ...
          %12 = arith.muli %arg12, %5 : index
          %13 = arith.muli %arg10, %3 : index
          %14 = arith.muli %arg8, %0 : index
          %15 = loom.alloc [%0] on @L1 : memref<?xf16>
          %16 = loom.semaphore_take %15 : memref<?xf16> -> memref<?xf16>
          %17 = loom.subview %arg3[%11, %12, %13, %14] [1, 1, 1, %0] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x32x8x192xf16> to memref<?xf16, strided<[1], offset: ?>>
          ...
          %28 = arith.divui %12, %c8 : index
          %29 = arith.muli %13, %c192 : index
          %30 = arith.addi %14, %29 : index
          %31 = loom.alloc [%0, 128] on @L1 : memref<?x128xf16>
          %32 = loom.semaphore_take %31 : memref<?x128xf16> -> memref<?x128xf16>
          %33 = loom.subview %arg4[%11, %28, %30, 0] [1, 1, %0, 128] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x4x1536x128xf16> to memref<?x128xf16, strided<[128, 1], offset: ?>>
          loom.copy %33, %32 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] : memref<?x128xf16, strided<[128, 1], offset: ?>> to memref<?x128xf16>
          %34 = loom.bufferize_to_tensor %32[%0, 128] : memref<?x128xf16> -> tensor<?x128xf16>
          %35 = arith.muli %arg9, %1 : index
          %36 = loom.alloc [128, %1] on @L1 : memref<128x?xf16>
          %37 = loom.semaphore_take %36 : memref<128x?xf16> -> memref<128x?xf16>
          %38 = loom.subview %arg6[%11, %13, %12, 0, %35] [1, 1, 1, 128, %1] [1, 1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x8x32x128x160xf16> to memref<128x?xf16, strided<[160, 1], offset: ?>>
          loom.copy %38, %37 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] : memref<128x?xf16, strided<[160, 1], offset: ?>> to memref<128x?xf16>
          %39 = loom.bufferize_to_tensor %37[128, %1] : memref<128x?xf16> -> tensor<128x?xf16>
          ...
          %46 = linalg.matmul ins(%34, %39 : tensor<?x128xf16>, tensor<128x?xf16>) outs(%45 : tensor<?x?xf16>) -> tensor<?x?xf16>
          loom.semaphore_give %37 : memref<128x?xf16>
          loom.semaphore_give %32 : memref<?x128xf16>
          ...
          %71 = scf.for %arg13 = %c0 to %50 step %c1 iter_args(%arg14 = %47) -> (tensor<?x?xf16>) {
            ...
            %87 = loom.subview %arg0[%11, %13, %28, %14, %86] [1, 1, 1, %0, %2] [1, 1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x8x4x192x192xf16> to memref<?x?xf16, strided<[192, 1], offset: ?>>
            loom.copy %87, %52 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] : memref<?x?xf16, strided<[192, 1], offset: ?>> to memref<?x?xf16>
            %88 = loom.bufferize_to_tensor %52[%0, %2] : memref<?x?xf16> -> tensor<?x?xf16>
            %89 = loom.subview %arg3[%11, %12, %13, %86] [1, 1, 1, %2] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x32x8x192xf16> to memref<?xf16, strided<[1], offset: ?>>
            ...
            %92 = loom.subview %arg2[%11, %12, %13, %86] [1, 1, 1, %2] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x32x8x192xf16> to memref<?xf16, strided<[1], offset: ?>>
            ...
            %98 = loom.subview %arg1[%11, %12, %97, %35] [1, 1, %2, %1] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x32x1536x160xf16> to memref<?x?xf16, strided<[160, 1], offset: ?>>
            loom.copy %98, %70 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] : memref<?x?xf16, strided<[160, 1], offset: ?>> to memref<?x?xf16>
          ...
          %74 = loom.subview %arg5[%12] [1] [1], reuse : [seq = false, spat = false, temp = false] : memref<32xf16> to memref<f16, strided<[], offset: ?>>
          ...
          %78 = loom.subview %arg1[%11, %12, %30, %35] [1, 1, %0, %1] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x32x1536x160xf16> to memref<?x?xf16, strided<[160, 1], offset: ?>>
          loom.copy %78, %77 src_mem_space @mem_DRAM dst_mem_space @mem_L1, area : [1, 1] : memref<?x?xf16, strided<[160, 1], offset: ?>> to memref<?x?xf16>
          ...
          %84 = loom.subview %arg7[%11, %12, %30, %35] [1, 1, %0, %1] [1, 1, 1, 1], reuse : [seq = false, spat = false, temp = false] : memref<2x32x1536x160xf16> to memref<?x?xf16, strided<[160, 1], offset: ?>>
          %85 = loom.bufferize_to_memref %83 : tensor<?x?xf16> -> memref<?x?xf16>
          loom.copy %85, %84 src_mem_space @mem_L1 dst_mem_space @mem_DRAM, area : [1, 1] : memref<?x?xf16> to memref<?x?xf16, strided<[160, 1], offset: ?>>

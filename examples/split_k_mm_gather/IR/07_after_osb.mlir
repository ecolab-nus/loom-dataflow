      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c2, %c4, %c8) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c4 step %c1 {
          scf.for %arg7 = %c0 to %c4 step %c1 {
            ...
            linalg.fill ins(%cst : f16) outs(%43 : memref<64x32xf16>)
            linalg.matmul ins(%26, %34 : memref<64x512xf16>, memref<512x32xf16>) outs(%43 : memref<64x32xf16>)
      ...
      scf.parallel (%arg3, %arg4, %arg5) = (%c0, %c0, %c0) to (%c8, %c4, %c2) step (%c1, %c1, %c1) {
        scf.for %arg6 = %c0 to %c4 step %c1 {
          scf.for %arg7 = %c0 to %c4 step %c1 {
            ...
            linalg.matmul ins(%26, %34 : memref<64x512xf16>, memref<512x32xf16>) outs(%42 : memref<64x32xf16>)
            loom.semaphore_give %34 : memref<512x32xf16>
            loom.semaphore_give %26 : memref<64x512xf16>
        ...
        scf.for %arg6 = %c0 to %c2 step %c1 {
          scf.for %arg7 = %c0 to %c2 step %c1 {
            scf.for %arg8 = %c0 to %c4 step %c1 {
              ...
              linalg.matmul ins(%28, %36 : memref<64x512xf16>, memref<512x32xf16>) outs(%44 : memref<64x32xf16>)
      ...
      scf.parallel (%arg3, %arg4, %arg5, %arg6) = (%c0, %c0, %c0, %c0) to (%c2, %c2, %c8, %c2) step (%c1, %c1, %c1, %c1) {
        scf.for %arg7 = %c0 to %c4 step %c1 {
          scf.for %arg8 = %c0 to %c8 step %c1 {
            ...
            linalg.matmul ins(%28, %38 : memref<64x512xf16>, memref<512x32xf16>) outs(%46 : memref<64x32xf16>)
        ...
        scf.for %arg7 = %c0 to %c2 step %c1 {
          scf.for %arg8 = %c0 to %c4 step %c1 {
            scf.for %arg9 = %c0 to %c2 step %c1 {
              ...
              linalg.fill ins(%cst : f16) outs(%48 : memref<64x32xf16>)
              linalg.matmul ins(%30, %40 : memref<64x512xf16>, memref<512x32xf16>) outs(%48 : memref<64x32xf16>)

...
- `passes/` – MLIR transformations/analyses targeting affine IR and Triton-shared kernels. Shared driver helpers, IR utilities, and analyses live here as well.
...
4. **Passes** bridge high-level kernels to the dialect and modules by normalizing IR and preparing pipeline annotations for downstream analysis.

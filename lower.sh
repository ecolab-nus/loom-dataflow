...
/root/loom-dataflow/build/tool/tileloom-to-ttkernel/tileloom_to_ttkernel_opt "${TILELOOM_PASS_ARG}" $1 -o kernel_ttkernel.mlir
...
#/root/loom-dataflow/build/tool/tileloom-to-ttkernel/tileloom_to_ttkernel_opt "${TILELOOM_PASS_ARG}" /root/loom-monorepo/test/$1/IRs/p03_bufferized.mlir -o kernel_ttkernel.mlir
...
#python3 split_kernel.py kernel.cpp -o /root/tt-metal/ttnn/cpp/ttnn/operations/transformer/mlir_sdpa/device/kernels/
